...
public:
    ...
    bool guided_set_posvelaccel(const Vector3f& destination, const Vector3f& velocity, const Vector3f& accel);
    bool guided_set_posvelaccel(const Vector3f& destination, const Vector3f& velocity, const Vector3f& accel, bool use_yaw, float yaw_cd, bool use_yaw_rate, float yaw_rate_cds, bool relative_yaw);
