...
void Sub::Log_Write_GuidedTarget(uint8_t target_type, const Vector3f& pos_target, const Vector3f& vel_target, const Vector3f& acc_target)
{
    struct log_GuidedTarget pkt = {
        ...
        pos_target_z    : pos_target.z * 0.01f,
        vel_target_x    : vel_target.x * 0.01f,
        vel_target_y    : vel_target.y * 0.01f,
        vel_target_z    : vel_target.z * 0.01f,
        acc_target_x    : acc_target.x * 0.01f,
        acc_target_y    : acc_target.y * 0.01f,
        acc_target_z    : acc_target.z * 0.01f
    };
    logger.WriteBlock(&pkt, sizeof(pkt));
}
