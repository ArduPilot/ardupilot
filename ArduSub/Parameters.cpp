...
const AP_Param::Info Sub::var_info[] = {
    ...
    // @Description: The depth the external pressure sensor will read when the
    // vehicle is considered at the surface (in centimeters)
    // @Units: cm
    // @Range: -100 0
    // @User: Standard
    ...
    // @Description: Throttle filter cutoff (Hz) - active whenever altitude
    // control is inactive - 0 to disable
    // @User: Advanced
    // @Units: Hz
    // @Range: 0 10
    // @Increment: 0.5
    ...
    // @Values: 0:Disabled,1:Warn only,2:Disarm,3:Enter depth hold mode,4:Enter
    // surface mode
    // @User: Standard
    ...
    // @Description: Controls what action to take if internal pressure exceeds
    // FS_PRESS_MAX parameter.
    ...
    // @Description: Controls what action to take if internal temperature
    // exceeds FS_TEMP_MAX parameter.
    // @Values: 0:Disabled,1:Warn only
    // @User: Standard
    ...
    // @Description: The throttle failsafe allows you to configure a software RC
    // failsafe activated by a setting on the throttle input channel. It also
    // enables RC failsafe on absence of RC signals being recieved.
    // @Values:  0:Disabled,1: Force effective control inputs to trim positions
    // and prevent arming,2:Surface and hold on surface on failsafe
    // @User: Standard
    ...
    // @Description: Flight mode when pwm of Flightmode channel(FLTMODE_CH) is
    // <= 1230
    // @Values:
    // 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,7:Circle,9:Surface,16:PosHold,19:Manual,20:Motor
    // Detect,21:SurfTrak
    // @User: Standard
    ...
    // @Values:
    // 0:Disabled,5:Channel5,6:Channel6,7:Channel7,8:Channel8,9:Channel9,10:Channel
    // 10,11:Channel 11,12:Channel 12,13:Channel 13,14:Channel 14,15:Channel 15
    // @User: Advanced
    GSCALAR(flight_mode_chan, "FLTMODE_CH", 0),

    // @Param: THR_ARM_POS
    // @DisplayName: Throttle arming position
    // @Description: Determines if throttle must be at min or within trim value
    // to arm, if RC checks and RC_OPTION for "0" throttle are enabled.
    // @User: Standard
    // @Bitmask: 0:Throttle at or below min, 1: Throttle within a dead zone of
    // RC trim value
    GSCALAR(thr_arming_position, "THR_ARM_POS", 1),
#endif
    // @Param: FS_PRESS_MAX
    // @DisplayName: Internal Pressure Failsafe Threshold
    // @Description: The maximum internal pressure allowed before triggering
    // failsafe. Failsafe action is determined by FS_PRESS_ENABLE parameter
    // @Units: Pa
    // @User: Standard
    ...
    // failsafe. Failsafe action is determined by FS_TEMP_ENABLE parameter.
    // @Units: degC
    // @User: Standard
    GSCALAR(failsafe_temperature_max, "FS_TEMP_MAX", FS_TEMP_MAX_DEFAULT),

    // @Param: FS_PRESS_EXT_EN
    // @DisplayName: External Pressure Failsafe Enable
    // @Description: Controls what action to take if external pressure exceeds
    // FS_PRESS_EXT_MAX parameter.
    // @Values: 0:Disabled,1:Warn only,2:Enter surface mode,3:Enter depth hold
    // mode
    // @User: Standard
    GSCALAR(failsafe_pressure_ext, "FS_PRESS_EXT_EN", FS_PRESS_EXT_DISABLED),

    // @Param: FS_PRESS_EXT_MAX
    // @DisplayName: External Pressure Failsafe Threshold
    // @Description: The maximum external pressure allowed before triggering
    // failsafe. Failsafe action is determined by FS_PRESS_EXT_EN parameter.
    // @Units: Pa
    // @User: Standard
    ...
    // This value is used to scale throttle linearly from 1. (full) to min as
    // the vehicle approaches the surface. The attenuation starts at 1 meter
    // from surface.  Only upwards throttle is limited.
    // @Range: 0.0 1.0
    // @User: Standard
    // @Increment: 0.01
    ...
    // @Description: Controls what action to take if terrain information is lost
    // during AUTO mode
    ...
    // @Description: Controls what action to take if no pilot input has been
    // received after the timeout period specified by the FS_PILOT_TIMEOUT
    // parameter
    ...
    // @Description: Controls the maximum interval between received pilot inputs
    ...
    // @Description: Maximum allowed angle (in degrees) between current track
    // and desired heading during waypoint navigation
    // @Range: 10 90
    // @User: Standard
    ...
    // @Description: Determines how the autopilot controls the yaw during
    // missions and RTL
    // @Values: 0:Never change yaw, 1:Face next waypoint, 2:Face next waypoint
    // except RTL, 3:Face along GPS course, 4:Correct crosstrack error
    // @User: Standard
    GSCALAR(wp_yaw_behavior, "WP_YAW_BEHAVIOR", WP_YAW_BEHAVIOR_DEFAULT),

    // @Param: PILOT_SPEED_UP
    // @DisplayName: Pilot maximum vertical ascending speed
    // @Description: The maximum vertical ascending velocity the pilot may
    // request in cm/s
    // @Units: cm/s
    // @Range: 20 500
    // @Increment: 10
    ...
    // @Description: The maximum vertical descending velocity the pilot may
    // request in cm/s
    // @Units: cm/s
    // @Range: 20 500
    // @Increment: 10
    ...
    // @Description: The maximum horizontal velocity the pilot may request in
    // cm/s
    // @Units: cm/s
    // @Range: 10 500
    // @Increment: 10
    ...
    // @Description: The vertical acceleration used when pilot is controlling
    // the altitude
    // @Units: cm/s/s
    // @Range: 50 500
    // @Increment: 10
    ...
    // @Description: The PWM deadzone in microseconds above and below mid
    // throttle. Used in AltHold, Loiter, PosHold flight modes
    // @User: Standard
    // @Range: 0 300
    // @Units: PWM
    // @Increment: 1
    ...
    // @Description: This enables automatic crash checking. When enabled the
    // motors will disarm if a crash is detected.
    // @Values: 0:Disabled,1:Warn only,2:Disarm
    // @User: Advanced
    ...
    // @Description: Default gain at boot, must be in range [JS_GAIN_MIN ,
    // JS_GAIN_MAX]. Current gain value is accessible via NAMED_VALUE_FLOAT
    // MAVLink message with name 'PilotGain'.
    // @User: Standard
    // @Range: 0.1 1.0
    ...
    // @Description: Controls the number of steps between minimum and maximum
    // joystick gain when the gain is adjusted using buttons. Set to 1 to always
    // use JS_GAIN_DEFAULT.
    // @User: Standard
    // @Range: 1 10
    ...
    // @Description: Number of steps in brightness between minimum and maximum
    // brightness
    // @User: Standard
    // @Range: 1 10
    // @Units: PWM
    ...
    // @Description: Scalar for gain on the throttle channel. Gets scaled with
    // the current JS gain
    // @User: Standard
    // @Range: 0.5 4.0
    ...
    // @Description: Set this parameter according to your vehicle/motor
    // configuration
    // @User: Standard
    // @RebootRequired: True
    // @Values: 0:BlueROV1, 1:Vectored, 2:Vectored_6DOF, 3:Vectored_6DOF_90,
    // 4:SimpleROV-3, 5:SimpleROV-4, 6:SimpleROV-5, 7:Custom
    GSCALAR(frame_configuration, "FRAME_CONFIG",
            AP_Motors6DOF::SUB_FRAME_VECTORED),
    ...
    // @Description: This is the speed in Hertz that your ESCs will receive
    // updates
    // @Units: Hz
    // @Range: 50 490
    // @Increment: 1
    ...
    // @Description: Converts pilot roll and pitch into a desired rate of
    // rotation in ACRO and SPORT mode.  Higher values mean faster rate of
    // rotation.
    // @Range: 1 10
    // @User: Standard
    ...
    // @Description: Converts pilot yaw input into a desired rate of rotation.
    ...
    // @Description: rate at which roll angle returns to level in acro mode.  A
    // higher value causes the vehicle to return to level faster.
    // @Range: 0 3
    // @Increment: 0.1
    // @User: Advanced
    ...
    // @Description: rate at which pitch angle returns to level in acro mode.  A
    // higher value causes the vehicle to return to level faster.
    // @Range: 0 3
    // @Increment: 0.1
    // @User: Advanced
    ...
    // @Description: Acro roll/pitch Expo to allow faster rotation when stick at
    // edges
...
// variables not in the g class which contain EEPROM saved variables
    ...
    // @Group: ATC_
    // @Path:
    // ../libraries/AC_AttitudeControl/AC_AttitudeControl.cpp,../libraries/AC_AttitudeControl/AC_AttitudeControl_Sub.cpp
    ...
    // @Group: MOT_
    // @Path:
    // ../libraries/AP_Motors/AP_Motors6DOF.cpp,../libraries/AP_Motors/AP_MotorsMulticopter.cpp
    ...
    // @Range: 0 100
    // @User: Advanced
    GSCALAR(rangefinder_signal_min, "RNGFND_SQ_MIN",
            RANGEFINDER_SIGNAL_MIN_DEFAULT),
...
// 1 was AP_Stats
    ...
    // @Description:  Backup EKF origin latitude used when not using a
    // positioning system.
    // @Units: deg
    // @User: Standard
    ...
    // @Description:  Backup EKF origin longitude used when not using a
    // positioning system.
    // @Units: deg
    // @User: Standard
    ...
    // @Description:  Backup EKF origin altitude (MSL) used when not using a
    // positioning system.
    // @Units: m
    // @User: Standard
    ...
    // @Description: Surface mode throttle output when no borometer is
    // available. 100% is full throttle. -100% is maximum throttle downwards
    // @Units: %
    // @User: Standard
    // @Range: -100 100
    AP_GROUPINFO("SFC_NOBARO_THST", 22, ParametersG2, surface_nobaro_thrust,
                 10),
...
const AP_Param::ConversionInfo conversion_table[] = {
    ...
    {Parameters::k_param_failsafe_battery_enabled, 0, AP_PARAM_INT8,
     "BATT_FS_LOW_ACT"},
...
void Sub::convert_old_parameters() {
  ...
  const AP_Param::ConversionInfo filt_conversion_info[] = {
      ...
      {Parameters::k_param_attitude_control, 385, AP_PARAM_FLOAT,
       "ATC_RAT_RLL_FLTE"},
      {Parameters::k_param_attitude_control, 386, AP_PARAM_FLOAT,
       "ATC_RAT_PIT_FLTE"},
      {Parameters::k_param_attitude_control, 387, AP_PARAM_FLOAT,
       "ATC_RAT_YAW_FLTE"},
  };
  AP_Param::convert_old_parameters(&filt_conversion_info[0],
                                   ARRAY_SIZE(filt_conversion_info));
...
void Sub::update_leak_pins() {
  for (uint8_t instance = 0; instance < LEAKDETECTOR_MAX_INSTANCES;
       instance++) {
    ...
    if (!hal.gpio->pin_to_servo_channel(leak_detector.get_pin(instance),
                                        servo_channel)) {
    ...
    if (SRV_Channels::channel_function(servo_channel) !=
        SRV_Channel::Function::k_none) {
      // servo channel is already set to a function
      gcs().send_text(
          MAV_SEVERITY_WARNING,
          "Leak detector %u error. Please set SERVO%u_FUNCTION to GPIO",
          instance + 1, servo_channel + 1);
      continue;
    }
    // servo channel is disabled, let's set it to GPIO for the user
    gcs().send_text(MAV_SEVERITY_INFO,
                    "Leak detector %u pin (servo %u) auto-set to GPIO",
                    instance + 1, servo_channel + 1);
    char param_name[20];
    snprintf(param_name, sizeof(param_name), "SERVO%u_FUNCTION",
             servo_channel + 1);
    AP_Param::set_and_save_by_name(
        param_name, static_cast<int>(SRV_Channel::Function::k_GPIO));
  }
}
#endif
...
void Sub::update_relay_pins() {
  for (uint8_t instance = 0; instance < AP_RELAY_NUM_RELAYS; instance++) {
    uint8_t servo_channel;
    uint8_t pin;
    if (!relay.get_pin_by_instance(instance, pin) ||
        !hal.gpio->pin_to_servo_channel(pin, servo_channel)) {
    ...
    if (SRV_Channels::channel_function(servo_channel) !=
      ...
      gcs().send_text(MAV_SEVERITY_WARNING,
                      "Relay %u error. Please set SERVO%u_FUNCTION to GPIO",
                      instance + 1, servo_channel + 1);
      continue;
    }
    // servo channel is disabled, let's set it to GPIO for the user
    gcs().send_text(MAV_SEVERITY_INFO,
                    "Relay %u pin (servo %u) auto-set to GPIO", instance + 1,
                    servo_channel + 1);
    char param_name[20];
    snprintf(param_name, sizeof(param_name), "SERVO%u_FUNCTION",
             servo_channel + 1);
