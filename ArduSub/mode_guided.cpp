...
void ModeGuided::set_vel_NED_ms(const Vector3f& vel_ned_ms) {
    guided_angle_state.speed_forward_cms = vel_ned_ms.x * 100.0f;
    guided_angle_state.speed_lateral_cms = vel_ned_ms.y * 100.0f;
    guided_angle_state.climb_rate_cms = -vel_ned_ms.z * 100.0f;
    guided_angle_state.update_time_ms = AP_HAL::millis();
}
