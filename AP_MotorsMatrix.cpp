...
bool AP_MotorsMatrix::setup_quad_matrix(motor_frame_type frame_type)
{
    ...
    case MOTOR_FRAME_TYPE_X: {
        ...
        static const AP_MotorsMatrix::MotorDef motors[] {//@yu
            {   41.987, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  1 },
            { -138.013, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  3 },
            {  -41.987, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   4 },
            {  138.013, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   2 },
        };
        add_motors(motors, ARRAY_SIZE(motors));
        break;
    }
