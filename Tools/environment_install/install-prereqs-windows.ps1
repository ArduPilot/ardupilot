...
Start-Process -wait -FilePath $PSScriptRoot\setup-x86_64.exe -ArgumentList "--root=C:\cygwin64 --no-startmenu --local-package-dir=$env:USERPROFILE\Downloads --site=http://cygwin.mirror.constant.com --packages gcc-g++=13.4.0-1,git,make,libexpat-devel,libxml2-devel,python39,python39-lxml,python39-pip,libxslt-devel,python39-devel,procps-ng,zip,gdb,tmux --quiet-mode"
