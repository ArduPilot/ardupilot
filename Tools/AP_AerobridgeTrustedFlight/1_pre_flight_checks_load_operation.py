...
### READ FIRST ####
# The trusted flights module works independently of Aerobridge. However, Aerobridge provides digital infrastructure 

# This script downloads operation details, permission JWT and the public key credentials of the auth server signing the permission to be sent to the vehicle.
