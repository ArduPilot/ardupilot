...
class AutoTestSub(vehicle_test_suite.TestSuite):
    ...
    def TerrainSurftrak(self):
        ...
        self.wait_altitude(altitude_min=end_altitude-validation_delta/2, altitude_max=end_altitude+validation_delta/2, relative=False, timeout=1)
