...
def drive_brake(mavproxy, mav):
    ...
    delta = distance_with_brakes - distance_without_brakes
    print("with=%0.2f without=%0.2f delta=%0.2f\n" % (distance_with_brakes, distance_without_brakes, delta),)
    if delta > 0 or abs(delta) < distance_without_brakes*0.05: # 5% isn't asking for much
