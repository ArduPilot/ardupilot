...
""" %
    ...
    def MANUAL_CONTROL(self):
        ...
        self.wait_ready_to_arm()
        self.arm_vehicle()
        self.progress("start moving forward a little, in an arc")
        normal_rc_throttle = 1700
        normal_rc_yaw = 1200
        self.set_rc(3, normal_rc_throttle)
        self.set_rc(1, normal_rc_yaw)
        self.wait_groundspeed(7, 100)
        ...
        while True:
            ...
            # Yaw input not reported, hence not checked
