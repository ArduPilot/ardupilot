...
#            raise NotAchievedException("Expected non-zero runtime for math")
    ...
    def ScriptedArmingChecksApplet(self):
        ...
        self.set_parameter("ZAR_SYSID", -1)
        ...
        self.set_parameter("ZAR_FOLL_SYSID", -1)
        self.set_parameter("ZAR_FOLL_SYSID_X", -1)
        self.set_parameter("ZAR_FOLL_OFS_DEF", -1)

        self.start_subsubtest("ArmCk: RTL_ALTITUDE must be legal")
        self.progress("Currently ZAR_RTL_ALT is %f" % self.get_parameter('ZAR_RTL_ALT'))
        ...
        self.wait_text("ArmCk: warn: Min Speed not", check_context=True)
        ...
        self.start_subsubtest("ArmCk: Mount Cannot arm while motors estopped")
