...
class AutoTestTracker(vehicle_test_suite.TestSuite):
    ...
    def LoggerMsgChunks(self):
        ...
        long_message_text = "This is undubitably a ridiculously verbose and needlessly wordy missive, unavoidably designed to exceed disappointingly miniscule log buffers"  # noqa:E501
