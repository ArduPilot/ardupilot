        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                if self._token_file is not None:
                    ...
                    shutil.copy(f'{self.test_artifacts_directory()}/{self._token_file}', token_path)
                func(*args, **kwargs)
            finally:
...
class AutoTestTrustedFlight(AutoTestCopter):
    ...
    def TokenSwapUpdatesValidationResult(self):
        ...
        shutil.copy(f'{TrustedFlightTestsWrapper.test_artifacts_directory()}/{TokenNameMappings.invalid_token}',
