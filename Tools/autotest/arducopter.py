...
#        self.delay_sim_time(1)
    ...
    def DualTuningChannels(self):
        ...
        self.delay_sim_time(1)
        self.assert_parameter_value("PSC_VELNE_I", TUNE2_MIN)

        self.set_rc(7, RC7_MAX)
        self.delay_sim_time(1)
        self.assert_parameter_value("PSC_VELNE_I", TUNE2_MAX)
        ...
        self.delay_sim_time(1)
        self.assert_parameter_value("PSC_VELNE_I", int((TUNE2_MIN+TUNE2_MAX)/2), epsilon=1)
