...
#        self.delay_sim_time(1, "let data in log accrue")
    ...
    def tests2a(self):
        ...
        ret = ([
            ...
            # SITLCompassCalibration must run immediately after
            #   FixedYawCalibration or it fails to calibrate; do
            #   not add tests between or before this pair:
    ...
    def HomeCircleInclusionFence(self, target_system=1, target_component=1):
        ...
        ./Tools/autotest/autotest.py test.CopterTests2a.HomeCircleInclusionFence  --map --speedup 1
        """
