...
#        self.wait_statustext("SIM Hit ground", timeout=timeout)
    ...
    def change_alt(self, alt_min, *, threshold_below_m = 5.0, threshold_above_m = 0.0, climb_throttle=1920, descend_throttle=1080):
        """Change altitude."""
...
#        self.takeoffAndMoveAway()
    ...
    def ModeFlip(self):
        ...
        pre_flip_altitude_m: Final = 20.0
        ...
        acceptable_altitude_loss_during_flip_m: Final = 10.0
