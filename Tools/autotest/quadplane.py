...
#        )
    ...
    def TerrainAvoidApplet(self):
        ...
        self.wait_altitude(1150, 1190, timeout=60, relative=False, minimum_duration=10)
        ...
        self.wait_altitude(1070, 1180, timeout=60, relative=False, minimum_duration=10)
        ...
        # 1020 +- 20
        self.wait_altitude(1000, 1040, timeout=120, relative=False, minimum_duration=10)
        ...
        # After Pitching CMTC to 1160m +- 20
        self.wait_altitude(1140, 1180, timeout=120, relative=False, minimum_duration=10)
        ...
        self.wait_text("TerrAvoid: Obstacle down", check_context=True, regex=True)
        self.progress("Quading alt #1 is %f" % self.get_altitude(relative=False, timeout=2))
        self.wait_text("TerrAvoid: Quading started", check_context=True, regex=True, timeout=60)
        self.wait_text("TerrAvoid: Quading DONE", check_context=True, regex=True)
        self.progress("Quading alt #2 is %f" % self.get_altitude(relative=False, timeout=2))
