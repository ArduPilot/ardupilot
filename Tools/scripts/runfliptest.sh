...
wait_time(mav, 1)
mavproxy.send('repeat add 2 rc 1 2000\n')
wait_time(mav, 1)
mavproxy.send('repeat add 2 rc 1 1000\n')
wait_time(mav, 1)
mavproxy.send('repeat add 2 rc 1 1500\n')
wait_time(mav, 1)
mavproxy.send('repeat add 2 rc 2 2000\n')
wait_time(mav, 1)
mavproxy.send('repeat add 2 rc 2 1000\n')
wait_time(mav, 1)
mavproxy.send('repeat add 2 rc 2 1500\n')
