...
BUILD_OPTIONS = [
    ...
    Feature('Other', 'LOGGING_REPLAY_SEPARATE_LOG', 'AP_LOGGER_REPLAY_SEPARATE_LOG_ENABLED', 'Enable writing replay data to a separate log (LOG_REPLAY=2)', 0, 'Logging'),  # NOQA: E501
