...
BUILD_OPTIONS = [
    ...
    Feature('MAVLink', 'MAVLINK_MSG_GNSS_INTEGRITY', 'AP_MAVLINK_MSG_GNSS_INTEGRITY_ENABLED', 'Enable GNSS_INTEGRITY MAVLink message (Septentrio receivers only)', 0, 'SBF'), # noqa
