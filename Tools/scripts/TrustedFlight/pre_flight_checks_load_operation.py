...
async def run(operation_id):
    ...
    try:
        ...
        vehicle.ftp.upload(pem_file.name, trusted_flight_directory)
    ...
    if full_chain_download_query.status_code == 200:
        try:
            ...
            # send file to drone
            vehicle.ftp.upload(full_chain_file.name, trusted_flight_directory)
        finally:
    ...
    try:
        ...
        # send file to drone
        vehicle.ftp.upload(auth_token_file.name, trusted_flight_directory)
    finally:
