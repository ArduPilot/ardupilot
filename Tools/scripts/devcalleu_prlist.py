...
pr_search = requests.get(
    "https://api.github.com/search/issues?q=is:pr%20is:open%20label:DevCallEU%20repo:ArduPilot/ardupilot%20sort:updated-desc"
).json()
issue_search = requests.get(
    "https://api.github.com/search/issues?q=is:issue%20label:DevCallEU%20repo:ArduPilot/ardupilot"
).json()
