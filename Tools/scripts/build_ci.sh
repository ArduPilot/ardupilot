...
if [ -z "$CI_BUILD_TARGET" ]; then
    CI_BUILD_TARGET="sitl linux erlebrain2 navio2 raspilot minlure bebop px4-v2 px4-v4"
fi
...
build_platforms=(  ["ArduPlane"]="erlebrain2 navio2 raspilot minlure bebop sitl linux px4-v2"
                   ["ArduCopter"]="erlebrain2 navio2 raspilot minlure bebop sitl linux px4-v2 px4-v4"
                   ["APMrover2"]="erlebrain2 navio2 raspilot minlure bebop sitl linux px4-v2"
                   ["AntennaTracker"]="erlebrain2 navio2 raspilot minlure bebop sitl linux px4-v2"
                   ["Tools/Replay"]="linux")

build_concurrency=(["erlebrain2"]="-j2"
                   ["navio2"]="-j2"
                   ["raspilot"]="-j2"
                   ["minlure"]="-j2"
                   ["bebop"]="-j2"
