...
class embox(Board):
    ...
    def configure_env(self, cfg, env):
        ...
        env.DEFINES.update(
            ...
            EK3_FEATURE_BODY_ODOM = 0,
            EK3_FEATURE_EXTERNAL_NAV = 0,
            EK3_FEATURE_DRAG_FUSION = 0,
            HAL_ADSB_ENABLED = 0,
            HAL_PROXIMITY_ENABLED = 0,
            ...
            HAL_EFI_ENABLED = 0,
            HAL_LOGGING_ENABLED = 0,
            HAL_CRSF_TELEM_ENABLED = 0,
            MODE_AUTOROTATE_ENABLED =0,
            AP_EXTERNAL_CONTROL_ENABLED =0,
            AP_BEACON_ENABLED = 0,
            AP_AVOIDANCE_ENABLED = 0,
            AC_PRECLAND_ENABLED = 0,
            AP_CAMERA_ENABLED = 0,
            AP_RPM_ENABLED = 0,
            AP_RANGEFINDER_ENABLED = 0,
            OSD_ENABLED = 0,
            OSD_PARAM_ENABLED = 0,
            HAL_WITH_MSP_DISPLAYPORT = 0,
            AP_MOTORS_FRAME_DEFAULT_ENABLED = 0,
            AP_LANDINGGEAR_ENABLED = 0,
            HAL_MSP_OPTICALFLOW_ENABLED = 0,
            HAL_SUPPORT_RCOUT_SERIAL = 0,
            HAL_HOTT_TELEM_ENABLED = 0,
            HAL_GYROFFT_ENABLED = 0,
            AP_SIM_INS_FILE_ENABLED = 0,
            AP_AIRSPEED_AUTOCAL_ENABLE = 0,
            AP_CAN_SLCAN_ENABLED = 0,
            AP_ICENGINE_ENABLED = 0,
            # AP_MISSION_ENABLED = 0,
            ...
            HAL_INS_ACCELCAL_ENABLED = 0,
            AP_ADVANCEDFAILSAFE_ENABLED = 0,
            # AP_AHRS_ENABLED = 0,
            AP_AHRS_DCM_ENABLED = 0,
            # AP_AHRS_EXTERNAL_ENABLED = 0,
            # HAL_EXTERNAL_AHRS_ENABLED = 0,
            AP_FOLLOW_ENABLED = 0,

            # AP_BARO_ENABLED = 0,
            AP_BARO_SPL06_ENABLED = 0,
            AP_BARO_SPL06_BACKGROUND_ENABLE = 0,
            AP_BARO_MSP_ENABLED = 0,
            AP_BARO_FBM320_ENABLED = 0,
            AP_BARO_1976_STANDARD_ATMOSPHERE_ENABLED = 0,
            AP_BARO_ICM20789_ENABLED = 0,
            # AP_BARO_DRONECAN_ENABLED = 0,
            AP_BARO_MS56XX_ENABLED = 0,
            AP_BARO_BMP280_ENABLED = 0,
            AP_BARO_BMP581_ENABLED = 0,
            AP_BARO_EXTERNALAHRS_ENABLED = 0,
            AP_BARO_ICP201XX_ENABLED = 0,
            # AP_BARO_DUMMY_ENABLED = 0,
            AP_BARO_KELLERLD_ENABLED = 0,
            AP_BARO_PROBE_EXT_PARAMETER_ENABLED = 0,
            AP_BARO_DPS280_ENABLED = 0,
            AP_BARO_LPS2XH_ENABLED = 0,
            AP_BARO_BMP085_ENABLED = 0,

            # AP_BATTERY_ENABLED = 0,
            # AP_BATTERY_TORQEEDO_ENABLED = 0,
            AP_BATTERY_AD7091R5_ENABLED = 0,
            AP_BATTERY_FUELLEVEL_ANALOG_ENABLED = 0,
            AP_BATTERY_SMBUS_SUI_ENABLED = 0,
            AP_BATTERY_SMBUS_ROTOYE_ENABLED = 0,
            AP_BATTERY_SUM_ENABLED = 0,
            AP_BATTERY_INA2XX_ENABLED = 0,
            AP_BATTERY_ANALOG_ENABLED = 0,
            AP_BATTERY_FUELFLOW_ENABLED = 0,
            AP_BATTERY_SMBUS_ENABLED = 0,
            AP_BATTERY_SMBUS_GENERIC_ENABLED = 0,
            AP_BATTERY_SYNTHETIC_CURRENT_ENABLED = 0,
            AP_BATTERY_FUELLEVEL_PWM_ENABLED = 0,

  
            #COMPASS_MOT_ENABLED = 0,
            AP_COMPASS_DIAGONALS_ENABLED = 0,

            # AP_COMPASS_ENABLED =0,
            # AP_COMPASS_AK8963_ENABLED = 0,
            # AP_COMPASS_AK09916_ENABLED = 0,
            # AP_COMPASS_BMM150_ENABLED = 0,
            # AP_COMPASS_BMM350_ENABLED = 0,
            COMPASS_CAL_ENABLED = 0,
            # AP_COMPASS_DRONECAN_ENABLED = 0,
            # AP_COMPASS_EXTERNALAHRS_ENABLED = 0,
            # AP_COMPASS_HMC5843_ENABLED = 0,
            # AP_COMPASS_IIS2MDC_ENABLED = 0,
            # AP_COMPASS_IST8308_ENABLED = 0,
            # AP_COMPASS_IST8310_ENABLED = 0,
            # AP_COMPASS_LIS3MDL_ENABLED = 0,
            # AP_COMPASS_LSM9DS1_ENABLED = 0,
            # AP_COMPASS_LSM303D_ENABLED = 0,
            # AP_COMPASS_MAG3110_ENABLED = 0,
            # AP_COMPASS_MMC5XX3_ENABLED = 0,
            # AP_COMPASS_MMC3416_ENABLED = 0,
            # AP_COMPASS_MSP_ENABLED = 0,
            # AP_COMPASS_QMC5883L_ENABLED = 0,
            # AP_COMPASS_QMC5883P_ENABLED = 0,
            # AP_COMPASS_RM3100_ENABLED = 0,
            # AP_COMPASS_SITL_ENABLED = 0,
            COMPASS_LEARN_ENABLED = 0,
            ...
            AP_GRIPPER_EPM_ENABLED = 0,
            AP_GRIPPER_SERVO_ENABLED = 0,

            
            # AP_SMARTAUDIO_ENABLED = 0,
            # AP_RELAY_ENABLED = 0,
            # AP_VIDEOTX_ENABLED = 0,
            # HAL_RUNCAM_ENABLED = 0,
            # HAL_HAVE_AP_ROMFS_EMBEDDED_H = 0,
            # AP_ROMFS = 0,
