...
class cyphalgen(Task.Task):
    ...
    def run(self):
        ...
        zubax_dir = self.env.get_flat("ZUBAX_PATH")
        ...
        commands = (
            ...
            "nnvg {} {} --lookup-dir {} --outdir {}".format(params, zubax_dir, uavcan_dir, out),
        )
...
def configure(cfg):
    ...
    env.ZUBAX_PATH = cfg.srcnode.make_node('modules/cyphal/zubax_dsdl').abspath() + '/zubax'