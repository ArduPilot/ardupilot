...
#endif
#if AP_KDECAN_ENABLED && !defined(HAL_PERIPH_ENABLE_RC_OUT)
#error "KDECAN requires HAL_PERIPH_ENABLE_RC_OUT"
#endif

#ifdef HAL_PERIPH_ENABLE_NOTIFY
    #if !defined(HAL_PERIPH_ENABLE_RC_OUT) && !defined(HAL_PERIPH_NOTIFY_WITHOUT_RCOUT)
        #error "HAL_PERIPH_ENABLE_NOTIFY requires either HAL_PERIPH_ENABLE_RC_OUT or HAL_PERIPH_NOTIFY_WITHOUT_RCOUT"
    #endif
