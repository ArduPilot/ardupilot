...
потрібно
1. вирішити питання з бутлоадером прошивки так як він не прошиває а просто зависає. Влад цим займеться

По основному коду
2. Добавити мавлінк і реалізувати його функціонал
    2.0 налаштування переферії
    2.1 відправлення
    2.2 отримання а в платі UAVCAN HUB ще й передача на серіал  зі збереженням номеру вхідниго каналу (якому NODE ID який Mav COMP id & SYS id)
3. UAVCAN реалізувати функціонал для передачі mavlink 
    3.1 передача
    3.2 приймання     
4. добавити sbus і реалізувати його функціонал для роботи серво приводу
    4.0 налаштування переферії
5. добавити синхонізований PWM для запалення снаряду - всі характеристики має надати шиму  Кіріл. 
    5.0 налаштування переферії - це бляха буде складно
6. АЦП для діагности несправноті сервоприводів.
    6.0 налаштування переферії
7. Описати логіку роботи (тут великий об?єм роботи)
