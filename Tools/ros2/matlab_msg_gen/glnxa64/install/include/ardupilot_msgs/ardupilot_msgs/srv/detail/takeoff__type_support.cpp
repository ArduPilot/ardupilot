...
{
  new (message_memory) ardupilot_msgs::srv::Takeoff_Request(_init);
}

void Takeoff_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ardupilot_msgs::srv::Takeoff_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Takeoff_Request_message_member_array[1] = {
  {
    ...
    offsetof(ardupilot_msgs::srv::Takeoff_Request, alt),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Takeoff_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(ardupilot_msgs::srv::Takeoff_Request),
...
get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Request>()
{
  return &::ardupilot_msgs::srv::rosidl_typesupport_introspection_cpp::Takeoff_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, srv, Takeoff_Request)() {
  return &::ardupilot_msgs::srv::rosidl_typesupport_introspection_cpp::Takeoff_Request_message_type_support_handle;
}
...
void Takeoff_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) ardupilot_msgs::srv::Takeoff_Response(_init);
}

void Takeoff_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ardupilot_msgs::srv::Takeoff_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Takeoff_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ardupilot_msgs::srv::Takeoff_Response, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Takeoff_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(ardupilot_msgs::srv::Takeoff_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Response>()
{
  return &::ardupilot_msgs::srv::rosidl_typesupport_introspection_cpp::Takeoff_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, srv, Takeoff_Response)() {
  return &::ardupilot_msgs::srv::rosidl_typesupport_introspection_cpp::Takeoff_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Takeoff_service_members = {
  ...
  // see get_service_type_support_handle<ardupilot_msgs::srv::Takeoff>()
...
get_service_type_support_handle<ardupilot_msgs::srv::Takeoff>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::ardupilot_msgs::srv::rosidl_typesupport_introspection_cpp::Takeoff_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::ardupilot_msgs::srv::Takeoff_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::ardupilot_msgs::srv::Takeoff_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, srv, Takeoff)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<ardupilot_msgs::srv::Takeoff>();
}
