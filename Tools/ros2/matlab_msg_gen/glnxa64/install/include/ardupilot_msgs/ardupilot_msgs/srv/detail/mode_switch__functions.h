...
#ifndef ARDUPILOT_MSGS__SRV__DETAIL__MODE_SWITCH__FUNCTIONS_H_
#define ARDUPILOT_MSGS__SRV__DETAIL__MODE_SWITCH__FUNCTIONS_H_
...
/// Initialize srv/ModeSwitch message.
/**
...
/// Finalize srv/ModeSwitch message.
/**
...
/// Create srv/ModeSwitch message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ardupilot_msgs__srv__ModeSwitch_Request__init().
...
/// Destroy srv/ModeSwitch message.
/**
 * It calls
 * ardupilot_msgs__srv__ModeSwitch_Request__fini()
...
/// Check for srv/ModeSwitch message equality.
/**
...
/// Initialize array of srv/ModeSwitch messages.
/**
...
/// Finalize array of srv/ModeSwitch messages.
/**
 * It calls
 * ardupilot_msgs__srv__ModeSwitch_Request__fini()
...
/// Create array of srv/ModeSwitch messages.
/**
 * It allocates the memory for the array and calls
 * ardupilot_msgs__srv__ModeSwitch_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ModeSwitch messages.
/**
 * It calls
 * ardupilot_msgs__srv__ModeSwitch_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ModeSwitch message array equality.
/**
...
/// Copy an array of srv/ModeSwitch messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ardupilot_msgs__srv__ModeSwitch_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ardupilot_msgs
...
/**
 * It calls
 * ardupilot_msgs__srv__ModeSwitch_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ardupilot_msgs
...
/**
 * It allocates the memory for the array and calls
 * ardupilot_msgs__srv__ModeSwitch_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ardupilot_msgs
...
/**
 * It calls
 * ardupilot_msgs__srv__ModeSwitch_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ARDUPILOT_MSGS__SRV__DETAIL__MODE_SWITCH__FUNCTIONS_H_
