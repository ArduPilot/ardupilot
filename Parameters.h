...
public:
    ...
    enum {
        ...
        k_param_ti_hold_thr2long = 265,
        k_param_ti_arspd2up_min,
        k_param_ti_max_safe_arspd,
        k_param_ti_auto_fix_alt,
        k_param_ti_wp_roll_rate_ff,
        k_param_ti_gps_fs,
        k_param_ti_gps_fs_overtime,
        k_param_ti_gps_fs_option,
        k_param_ti_rtl_spd_dn,
        k_param_ti_group_tri_v,
        k_param_ti_group_tri_h,
        k_param_ti_group_spd_m,
        k_param_ti_group_spd_p,
        k_param_ti_group_spd_i,
        k_param_ti_group_spd_d,
        k_param_ti_group_spd_gain,
        k_param_ti_group_type,
        //k_param_ti_group_ff_pid_gain,
        //k_param_ti_group_ff_pid_p,
        //k_param_ti_group_ff_pid_d,
        k_param_ti_status_report,
        k_param_ti_status_report_cycle,
        k_param_ti_status_report_batt_index,
        k_param_ti_group_status_report,
        k_param_ti_group_error_alt_max,
        k_param_ti_group_speed_rate,
        k_param_ti_group_speed_update_cycle,
        k_param_ti_group_throttle_type,
        k_param_ti_group_target_link_test,
        k_param_ti_group_target_lost_distance,
        k_param_ti_group_speed_range_limit,
        k_param_ti_group_wait_long_time,
        k_param_ti_group_enable,
        k_param_ti_q_transition_decel_in_mission,
        k_param_ti_group_min_safe_altitude,
        k_param_ti_calculate_voyage_in_auto,
        k_param_ti_ship_vel_match,
        k_param_ti_ship_vel_match_min_alt,
        k_param_ti_ship_vel_descend_per_second,
        k_param_ti_ship_vel_side_shift_dist,
        k_param_ti_ship_vel_side_shift_position,
        k_param_ti_ship_vel_side_shift_min_alt,
        k_param_ti_ship_vel_match_low_speed,
    ...
    // ti params //@yu
    //
    AP_Int8 ti_hold_thr2long;
    AP_Float ti_arspd2up_min;
    AP_Float ti_max_safe_arspd;
    AP_Int8 ti_auto_fix_alt;
    AP_Float ti_wp_roll_rate_ff;
    AP_Int8 ti_gps_fs;
    AP_Int8 ti_gps_fs_overtime;
    AP_Int8 ti_gps_fs_option;
    AP_Int8 ti_rtl_spd_dn;
    AP_Float ti_group_tri_v;
    AP_Float ti_group_tri_h;
    AP_Float ti_group_spd_m;
    AP_Float ti_group_spd_p;
    AP_Float ti_group_spd_i;
    AP_Float ti_group_spd_d;
    AP_Float ti_group_spd_gain;
    AP_Int8 ti_group_type;
    //AP_Float ti_group_ff_pid_gain;
    //AP_Float ti_group_ff_pid_p;
    //AP_Float ti_group_ff_pid_d;
    AP_Int8 ti_status_report;
    AP_Int8 ti_status_report_cycle;
    AP_Int8 ti_status_report_batt_index;
    AP_Int8 ti_group_status_report;
    AP_Int16 ti_group_error_alt_max;
    AP_Float ti_group_speed_rate;
    AP_Int8 ti_group_speed_update_cycle;
    AP_Int8 ti_group_throttle_type;
    AP_Int8 ti_group_target_link_test;
    AP_Float ti_group_target_lost_distance;
    AP_Int8 ti_group_speed_range_limit;
    AP_Int16 ti_group_wait_long_time;
    AP_Int8 ti_group_enable;
    AP_Float ti_q_transition_decel_in_mission;
    AP_Int32 ti_group_min_safe_altitude;
    AP_Int8 ti_calculate_voyage_in_auto;
    AP_Int8 ti_ship_vel_match;
    AP_Int32 ti_ship_vel_match_min_alt;
    AP_Float ti_ship_vel_descend_per_second;
    AP_Float ti_ship_vel_side_shift_dist;
    AP_Int8 ti_ship_vel_side_shift_position;
    AP_Int32 ti_ship_vel_side_shift_min_alt;
    AP_Float ti_ship_vel_match_low_speed;
