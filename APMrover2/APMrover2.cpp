...
const AP_Scheduler::Task Rover::scheduler_tasks[] = {
    ...
    AP_Task<Rover>::create(&Rover::update_beacon,          50,     50),
    AP_Task<Rover>::create(&Rover::update_visual_odom,     50,     50),
    ...
    AP_Task<Rover>::create(&Rover::stats_update,            1,    100),
    AP_Task<Rover>::create(&Rover::crash_check,            10,   1000),
#if ADVANCED_FAILSAFE == ENABLED
    AP_Task<Rover>::create(&Rover::afs_fs_check,           10,    100),
#endif
};
