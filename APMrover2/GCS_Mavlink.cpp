...
void GCS_MAVLINK_Rover::handleMessage(const mavlink_message_t &msg)
{
    ...
    case MAVLINK_MSG_ID_MANUAL_CONTROL: {
        handle_manual_control_message(msg);
        break;
    }
    ...
    case MAVLINK_MSG_ID_SET_ATTITUDE_TARGET: { // MAV ID: 82
        handle_set_attitude_target_message(msg);
        break;
    }

    case MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED: {   // MAV ID: 84
        handle_set_position_target_local_ned_message(msg);
        break;
    }
...
void GCS_MAVLINK_Rover::handle_manual_control_message(const mavlink_message_t &msg) // handle manual control message
{
...
void GCS_MAVLINK_Rover::handle_heartbeat_message(const mavlink_message_t &msg) // handle heartbeat message
{
...
void GCS_MAVLINK_Rover::handle_set_attitude_target_message(const mavlink_message_t &msg) //handle MAV ID: 82
{
    // decode packet
...
void GCS_MAVLINK_Rover::handle_set_position_target_local_ned_message(const mavlink_message_t &msg) //handle MAV ID: 84
{
    // decode packet
...
void GCS_MAVLINK_Rover::handle_set_position_target_global_int(const mavlink_message_t &msg) //handle MAV ID: 86
{
    // decode packet
...
#if HIL_MODE != HIL_MODE_DISABLED
void GCS_MAVLINK_Rover::handle_hil_state_message(const mavlink_message_t &msg)
{
