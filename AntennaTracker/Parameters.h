...
public:
	...
	*/
	...
	enum {
		...
		k_param_yaw_servo_type,		// Yaw Servo type 0-Position, 1-ON/OFF, 2-CR
		k_param_pitch_servo_type,	// Pitch Servo Type 0-Position, 1-ON/OFF, 2-CR
		k_param_cr_pitch_max,		// Max CR angle up
		k_param_cr_pitch_min,		// Min CR angle down
		//
		// 180: tracker modes
		//
	...
	AP_Float scan_speed;
	AP_Float cr_pitch_max;
	AP_Float cr_pitch_min;
