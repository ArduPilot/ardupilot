...
const AP_Param::Info Tracker::var_info[] = {
	...
	// @Param: SCAN_PITCH_MAX
	// @DisplayName: Maximum pitch angle for CR Pitch Servos
	// @Description: is controls how low the tracker will pitch up with CR Pitch Servos to prevent lock.
	// @Units: degrees
	// @Increment: 1
	// @Range: 0 90
	// @User: Standard
	GSCALAR(cr_pitch_max,             "CR_PITCH_MAX",      90),

	// @Param: SCAN_PITCH_MIN
	// @DisplayName: Minimum pitch angle for CR Pitch Servos
	// @Description: This controls how low the tracker will pitch down with CR Pitch Servos to prevent lock.
	// @Units: degrees
	// @Increment: 1
	// @Range: -90 0
	// @User: Standard
	GSCALAR(cr_pitch_min,             "CR_PITCH_MIN",      -90),
	...
	// @Description: This allows selection of position servos, on/off servos, or ContinuousRotation
	// @Values: 0:Position,1:OnOff,2:ContinuousRotation
	// @User: Standard
	GSCALAR(yaw_servo_type,          "YAW_SERVO_TYPE",   YAW_SERVO_TYPE_POSITION),
	...
	// @Values: 0:Position,1:OnOff,2:ContinuousRotation
	// @User: Standard
	GSCALAR(pitch_servo_type,        "PITCH_SERVO_TYPE",   PITCH_SERVO_TYPE_POSITION),
