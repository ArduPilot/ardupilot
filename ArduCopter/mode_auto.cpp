...
bool ModeAuto::set_speed_xy_ms(float speed_xy_cms)
{
...
bool ModeAuto::set_speed_up_ms(float speed_up_ms)
{
    ...
    desired_speed_override_ms.up = speed_up_ms * 0.01;
    return true;
}

bool ModeAuto::set_speed_down_ms(float speed_down_cms)
{
    copter.wp_nav->set_speed_down_ms(speed_down_ms);
    desired_speed_override_ms.down = speed_down_ms * 0.01;
    return true;
}
