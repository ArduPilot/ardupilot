...
bool ModeAuto::start_command(const AP_Mission::Mission_Command& cmd)
{
    ...
    case MAV_CMD_DO_SET_ROI_LOCATION:       // 195
        auto_yaw.set_roi_for_mavlink_device_id(cmd.p1, cmd.content.location);
        break;
    ...
    case MAV_CMD_DO_SET_ROI:                // 201
        // Because the protocol (Mission, which uses MAVLink) does not specify which sensor(s) is contolled by this
        // command, the decision is made here.
