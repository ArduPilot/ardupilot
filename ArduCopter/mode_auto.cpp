...
void ModeAuto::takeoff_start(const Location& dest_loc)
{
    ...
    if ((dest.get_alt_frame() == Location::AltFrame::ABOVE_TERRAIN) && wp_nav->get_terrain_offset(terrain_offset)) {
    ...
    dest.set_alt_cm(alt_target_cm , dest.get_alt_frame());
