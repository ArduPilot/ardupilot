...
// FRAME_CONFIG
//
//BEV changed frame type
#define FRAME_CONFIG_STRING "FireFLY6"
...
//BEV increased from 30 to 50 to make landing trigger more likelty to hit if bad accel cal
# define LAND_DETECTOR_CLIMBRATE_MAX    50  // vehicle climb rate must be between -50 and +50 cm/s
#endif
