...
#define CONTROL_SWITCH_COUNTER  g.fltmode_swcgspd  // iterations param at 100hz (i.e. 2/10th of a second) at a new switch position will cause flight mode change
