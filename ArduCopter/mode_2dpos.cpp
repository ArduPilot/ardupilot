...
bool Mode2DPos::init(bool ignore_checks)
{
...
#if PRECISION_LANDING == ENABLED
bool Mode2DPos::do_precision_loiter()
{
...
void Mode2DPos::precision_loiter_xy()
{
    loiter_nav->clear_pilot_desired_acceleration();
...
void Mode2DPos::run()
{
    ...
    case AltHold_Flying:
        ...
        if (copter.rccar_flow_hold){
            pos_control->update_throttle(0);
        } else {
...
uint32_t Mode2DPos::wp_distance() const
{
    return loiter_nav->get_distance_to_target();
}

int32_t Mode2DPos::wp_bearing() const
{
