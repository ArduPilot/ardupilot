...
void Copter::althold_run()
{
    ...
    get_pilot_desired_lean_angles(channel_roll->get_control_in(), channel_pitch->get_control_in(), target_roll, target_pitch, aparm.angle_max, attitude_control->get_althold_lean_angle_max());
