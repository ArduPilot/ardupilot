...
// #define CLI_ENABLED           DISABLED            // disable the CLI (command-line-interface) to save 8.28K of flash space
//#endif
...
//#define SPLINE                ENABLED             // enable spline waypoint at a cost of 3.55K of flash (must be enabled in ~ AC_WPNav.h, to enable)
