...
void Copter::parachute_check()
{
    ...
    bool baro_climbrate_up = is_positive(barometer.get_climb_rate());
    bool ahrs_climbrate_up = is_positive(inertial_nav.get_velocity_z());

    if (baro_climbrate_up || ahrs_climbrate_up) {
