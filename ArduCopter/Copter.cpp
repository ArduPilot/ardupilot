...
Copter::Copter(void) :
    ...
    simple_cos_yaw(1.0f),
    simple_sin_yaw(0.0f),
    super_simple_last_bearing_rad(0.0f),
    super_simple_cos_yaw(1.0),
    super_simple_sin_yaw(0.0f),
    initial_armed_bearing_rad(0.0f),
    ...
    yaw_look_at_WP_bearing_rad(0.0f),
    yaw_look_at_heading_rad(0.0f),
    yaw_look_at_heading_slew_rads(0.0f),
    yaw_look_ahead_bearing_rad(0.0f),
    condition_value(0),
    condition_start(0),
