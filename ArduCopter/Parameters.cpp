...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Bitmask: 0:Allow Arming,1:Allow Takeoff Without Raising Throttle,2:Ignore pilot yaw,4:Allow weathervaning
    // @User: Advanced
    ...
    // @Bitmask: 0:Allow Arming from Transmitter,2:Ignore pilot yaw,3:SetAttitudeTarget_ThrustAsThrust,4:Allow weathervaning
    // @User: Advanced
