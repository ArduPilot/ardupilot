...
const AP_Param::Info Copter::var_info[] = {
    ...
    //NOTE:a user can setup the new flight mode to be activated from the transmitter’s 
    //flight mode switch by directly setting the FLTMODE1 (or FLTMODE2, etc) parameters
    // to the number of the new mode
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:ZigZag,25:SystemID,26:Heli_Autorotate,27:Backstepping
    // @User: Advanced
