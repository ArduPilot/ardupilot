...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Values: 0:None, 1:Continue if in Auto on RC failsafe, 2:Continue if in Auto on GCS failsafe, 4:Continue if in Guided on RC failsafe, 8:Continue if landing on any failsafe, 16:Continue if in pilot controlled modes on GCS failsafe, 32:Release Gripper
    // @User: Advanced
