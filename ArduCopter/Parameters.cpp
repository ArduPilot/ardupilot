...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Description: Bitmask containing various throttle stick options. Add up the values for options that you want. (TX with sprung throttle can set PILOT_THR_BHV to "1" so motor feedback when landed starts from mid-stick instead of bottom of stick).
    // @User: Standard
