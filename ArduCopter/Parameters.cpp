...
const AP_Param::GroupInfo ParametersG2::var_info2[] = {
    ...
    // @User: Standard
    AP_GROUPINFO("TUNE2_MIN", 11, ParametersG2, tuning2_min, 0),
    ...
    // @User: Standard
    AP_GROUPINFO("TUNE2_MAX", 12, ParametersG2, tuning2_max, 0),
    ...
    AP_GROUPINFO("TUNE2", 13, ParametersG2, tuning2_param, 0),
#endif  // AP_RC_TRANSMITTER_TUNING_ENABLED
