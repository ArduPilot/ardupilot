...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Description: Target altitude to descend during a drop, (must be positive)
    // @Units: m
    // @User: Advanced
    GSCALAR(throw_altitude_descent, "THROW_ALT_DCSND", 1.0),

    // @Param: THROW_ALT_ACSND
    // @DisplayName: Throw mode target altitude to ascsend
    // @Description: Target altitude to ascend during a throw upwards (must be positive)
    // @Units: m
    // @User: Advanced
    GSCALAR(throw_altitude_ascent, "THROW_ALT_ACSND", 3.0),
#endif
