...
void AutoTune::init_z_limits()
{
    ...
    copter.pos_control->set_max_speed_accel_D_m(copter.flightmode->get_pilot_speed_dn_ms(), copter.flightmode->get_pilot_speed_up_ms(), copter.flightmode->get_pilot_accel_D_mss());
    copter.pos_control->set_correction_speed_accel_D_m(copter.flightmode->get_pilot_speed_dn_ms(), copter.flightmode->get_pilot_speed_up_ms(), copter.flightmode->get_pilot_accel_D_mss());
}
