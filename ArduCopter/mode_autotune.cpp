 ...
 */
void AutoTune::get_pilot_desired_rp_yrate_rad(float &des_roll_rad, float &des_pitch_rad, float &yaw_rate_rads)
{
    ...
    yaw_rate_rads = copter.mode_autotune.get_pilot_desired_yaw_rate_rads();
}
