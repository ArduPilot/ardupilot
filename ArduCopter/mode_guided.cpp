...
void ModeGuided::velaccel_control_run()
{
    ...
    copter.avoid.adjust_velocity_m(guided_vel_target_ned_ms, pos_control->NE_get_pos_p().kP(), pos_control->NE_get_max_accel_mss(), pos_control->D_get_pos_p().kP(), pos_control->D_get_max_accel_mss(), G_Dt);
