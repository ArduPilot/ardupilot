...
public:
    ...
    enum class Number : uint8_t {
        ...
        GUIDED =        4,  // fully mode_autoautomatic fly to coordinate or fly at velocity/direction using GCS immediate commands
		...
		FOURDAUTO =    27,  // 4D Avionic System's autopilot
    };
