...
void Copter::guided_pos_control_run()
{
    ...
    if (rangefinder_alt_ok()) {
        ...
        float temp_surface_tracking_climbrate = get_surface_tracking_climb_rate(0, pos_control->get_alt_target(), G_Dt);
    }
...
void Copter::guided_posvel_control_run()
{
	...
	// get avoidance adjusted climb rate
        posvel_vel_target_cms.z = get_avoidance_adjusted_climbrate((int)posvel_vel_target_cms.z);
