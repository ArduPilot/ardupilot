...
void Copter::guided_angle_control_start()
{
    ...
    guided_angle_state.yaw_rate_cdps = 0.0f;
...
void Copter::guided_set_angle(const Quaternion &q, float yaw_rate_rad_s, bool use_yaw_rate, float climb_rate_cms)
{
    // check we are in velocity control mode
    ...
    guided_angle_state.yaw_rate_cdps = ToDeg(yaw_rate_rad_s) * 100.0f;
...
void Copter::guided_angle_control_run()
{
    ...
    float yaw_rate_in = wrap_180_cd(guided_angle_state.yaw_rate_cdps);
