...
public:
    ...
    public:
        ...
        void set_roi(const uint8_t instance, const Location &roi_location);
        void set_roi_for_mavlink_device_id(const uint8_t mavlink_gimbal_device_id, const Location &roi_location);
