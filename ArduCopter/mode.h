...
public:
    ...
    void set_angle(const Quaternion &attitude_quat, const Vector3f &ang_vel, float climb_rate_cms_or_thrust, bool use_thrust, bool use_yaw_rate = false, float yaw_rate_degs = 0.0);
