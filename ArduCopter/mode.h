...
public:
    ...
    private:
        ...
        enum class PldRetryStrictness: uint8_t {
        ...
        RetryLanding retry_state;   // Current action being done in the Landing retry state machine
