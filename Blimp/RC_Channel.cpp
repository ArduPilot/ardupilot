...
void RC_Channels_Blimp::save_trim()
{
    ...
    const float roll_trim = ToRad((float)blimp.channel_right->get_control_in()/100.0f);
    const float pitch_trim = ToRad((float)blimp.channel_front->get_control_in()/100.0f);
