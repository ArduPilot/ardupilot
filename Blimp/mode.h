...
protected:
    ...
    const char *name4() const override { return "VEL"; }
...
public:
    ...
    Vector3p vec_from_loc(const Location& loc);
    Vector3p vec_from_cmd(const AP_Mission::Mission_Command& cmd, const Location& default_loc);
