...
#define THISFIRMWARE "ArduBoat v2.48beta1"
/*
...
/* 
   This is the ArduBoat firmware. It was originally derived from
   ArduPlane by Jean-Louis Naudin (JLN), and then rewritten after the
   AP_HAL merge by Andrew Tridgell, then forked for boat by Hector Hind
   ...
   APMBoat alpha version tester: Hector Hind
...
// Waypoint distances
////////////////////////////////////////////////////////////////////////////////
// Distance between Boat and next waypoint.  Meters
...
void setup() {
    ...
    // Boat does not use arming nor pre-arm checks
...
static void update_navigation()
{
    ...
    case RTL:
    case GUIDED:
        // no loitering around the wp with the Boat, goes direct to the wp position
        calc_lateral_acceleration();
        calc_nav_steer();
        if (verify_RTL()) {  
