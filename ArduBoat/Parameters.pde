...
/*
  ArduBoat parameter definitions
*/
...
const AP_Param::Info var_info[] PROGMEM = {
    ...
    // @Description: The distance to the next turn at which the Boat reduces its target speed by the SPEED_TURN_GAIN
    // @Units: meters
    // @Range: 0 100
    // @Increment: 0.1
    // @User: Standard
    ...
    // @Description: The minimum throttle setting to which the autopilot will apply. This is mostly useful for Boats with internal combustion motors, to prevent the motor from cutting out in auto mode.
    // @Units: Percent
    // @Range: 0 100
    // @Increment: 1
    // @User: Standard
    ...
    // @Description: The maximum throttle setting to which the autopilot will apply. This can be used to prevent overheating a ESC or motor on an electric Boat.
    // @Units: Percent
    // @Range: 0 100
    // @Increment: 1
    // @User: Standard
    ...
    // @Description: Set this to 1 for skid steering controlled Boats (tank track style). When enabled, servo1 is used for the left track control, servo3 is used for right track control
    ...
    // @Description: Set this to 1 for skid steering input Boats (tank track style in RC controller). When enabled, servo1 is used for the left track control, servo3 is used for right track control
    ...
    // @Description: The distance in meters from a waypoint when we consider the waypoint has been reached. This determines when the Boat will turn along the next waypoint path.
    // @Units: meters
    // @Range: 0 1000
    // @Increment: 0.1
    // @User: Standard
    ...
    // @Description: The maximum turning acceleration (in units of gravities) that the Boat can handle while remaining stable. The navigation code will keep the lateral acceleration below this level to avoid rolling over or slipping in turns
    // @Units: gravities
    // @Range: 0.2 10
    // @Increment: 0.1
    // @User: Standard
...
static void load_parameters(void)
{
    ...
    // set a lower default filter frequency for Boats, due to very
    // high vibration levels on rough surfaces
    ins.set_default_filter(5);

    // set a more reasonable default NAVL1_PERIOD for Boats
