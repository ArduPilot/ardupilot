...
#define ROLL_PITCH_STABLE_OF	2
#define ROLL_PITCH_FBW			3
...
#define POSITION 21			// AUTO control
#define LAND 22			// AUTO control
#define ACRO 23			// AUTO control
#define ALT_HOLD 24			// AUTO control
#define OF_LOITER 25			// AUTO control

// CH_6 Tuning
// -----------
#define CH6_NONE 0
// Rate
#define CH6_RATE_KP 1
#define CH6_RATE_KI 2
#define CH6_RATE_KD 3
#define CH6_YAW_RATE_KP 4
#define CH6_YAW_RATE_KI 5
#define CH6_YAW_RATE_KD 6
#define CH6_NAV_RATE_KP 7
#define CH6_PITCH 8
