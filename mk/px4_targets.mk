...
WARNFLAGS = -Wno-psabi -Wno-packed -Wno-error=double-promotion -Wno-error=unused-variable -Wno-error=unused-but-set-variable -Wno-error=reorder -Wno-error=float-equal -Wno-error=frame-larger-than=1024 -Wno-error=pmf-conversions -Wno-error=missing-declarations
