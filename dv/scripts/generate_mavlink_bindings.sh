...
mkdir -p ${OUTPUT}/Python3/mavlink/v2.0
mkdir -p ${OUTPUT}/wlua
...
python3 ./modules/mavlink/pymavlink/tools/mavgen.py --lang=Python3 --wire-protocol=2.0 --output="${OUTPUT}/Python3/mavlink/v2.0" "${DIALECT_PATH}"
