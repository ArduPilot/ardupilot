...
void AP_MotorsSingle::output_to_motors()
{
    ...
    switch (_spool_state) {
        ...
        case SpoolState::GROUND_IDLE:
            ...
            set_actuator_with_slew(_actuator[P_MOTORS_MOT_5], actuator_spin_up_to_ground_idle());
            set_actuator_with_slew(_actuator[P_MOTORS_MOT_6], actuator_spin_up_to_ground_idle());
            rc_write(AP_MOTORS_MOT_5, output_to_pwm(_actuator[P_MOTORS_MOT_5]));
            rc_write(AP_MOTORS_MOT_6, output_to_pwm(_actuator[P_MOTORS_MOT_6]));
            break;
        ...
        case SpoolState::SPOOLING_DOWN:
            ...
            set_actuator_with_slew(_actuator[P_MOTORS_MOT_5], thrust_to_actuator(_thrust_out));
            set_actuator_with_slew(_actuator[P_MOTORS_MOT_6], thrust_to_actuator(_thrust_out));
            rc_write(AP_MOTORS_MOT_5, output_to_pwm(_actuator[P_MOTORS_MOT_5]));
            rc_write(AP_MOTORS_MOT_6, output_to_pwm(_actuator[P_MOTORS_MOT_6]));
            break;
    }
