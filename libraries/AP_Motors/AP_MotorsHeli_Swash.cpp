...
void AP_MotorsHeli_Swash::calculate_roll_pitch_collective_factors()
{
    ...
    switch (_swash_type) {
        ...
        case SWASHPLATE_TYPE_H1:
            ...
            add_servo_angle(CH_1, -90.0 - _phase_angle, 0.0);
            add_servo_angle(CH_2,  0.0 - _phase_angle, 0.0);
        ...
        case SWASHPLATE_TYPE_H3_140:
            ...
            float ch1_angle = 45.0 - _phase_angle;
            float ch2_angle = -45.0 - _phase_angle;
            add_servo_raw(CH_1, sq(2)*cosf(radians(ch1_angle+90.0)), sq(2)*cosf(radians(ch1_angle)), 1.0);
            add_servo_raw(CH_2, sq(2)*cosf(radians(ch2_angle+90.0)), sq(2)*cosf(radians(ch2_angle)), 1.0);
            add_servo_angle(CH_3, 180.0 - _phase_angle, 1.0);
            break;
            }
        ...
        case SWASHPLATE_TYPE_H3_120:
            ...
            add_servo_angle(CH_1, -60.0 - _phase_angle, 1.0);
            add_servo_angle(CH_2,  60.0 - _phase_angle, 1.0);
            add_servo_angle(CH_3, 180.0 - _phase_angle, 1.0);
            break;
            }
        ...
        case SWASHPLATE_TYPE_H4_90:
            ...
            add_servo_angle(CH_1, -90.0 - _phase_angle, 1.0);
            add_servo_angle(CH_2,  90.0 - _phase_angle, 1.0);
            add_servo_angle(CH_3, 180.0 - _phase_angle, 1.0);
            add_servo_angle(CH_4,   0.0 - _phase_angle, 1.0);
            break;
            }
        ...
        case SWASHPLATE_TYPE_H4_45:
            ...
            add_servo_angle(CH_1,  -45.0 - _phase_angle, 1.0);
            add_servo_angle(CH_2,   45.0 - _phase_angle, 1.0);
            add_servo_angle(CH_3, -135.0 - _phase_angle, 1.0);
            add_servo_angle(CH_4,  135.0 - _phase_angle, 1.0);
            break;
            }
    }
