...
// servo output rates
#define AP_MOTORS_HELI_TANDEM_SPEED_DEFAULT            125     // default servo update rate for helicopters
#define AP_MOTORS_HELI_TANDEM_SPEED_DIGITAL_SERVOS     125     // update rate for digital servos
#define AP_MOTORS_HELI_TANDEM_SPEED_ANALOG_SERVOS      125     // update rate for analog servos

// TradHeli Aux Function Output Channels
#define AP_MOTORS_HELI_TANDEM_RSC                      CH_8
...
#define AP_MOTORS_HELI_TANDEM_SWASH_ROLL_MAX           2500
#define AP_MOTORS_HELI_TANDEM_SWASH_PITCH_MAX          2500
#define AP_MOTORS_HELI_TANDEM_SWASH_YAW_MAX            2500
#define AP_MOTORS_HELI_TANDEM_COLLECTIVE_MIN           1250
#define AP_MOTORS_HELI_TANDEM_COLLECTIVE_MAX           1750
#define AP_MOTORS_HELI_TANDEM_COLLECTIVE_MID           1500

// swash min and max position while in stabilize mode (as a number from 0 ~ 100)
#define AP_MOTORS_HELI_TANDEM_MANUAL_COLLECTIVE_MIN    0
#define AP_MOTORS_HELI_TANDEM_MANUAL_COLLECTIVE_MAX    100

// swash min while landed or landing (as a number from 0 ~ 1000
#define AP_MOTORS_HELI_TANDEM_LAND_COLLECTIVE_MIN      0
...
#define AP_MOTORS_HELI_TANDEM_RSC_MODE_NONE            0       // main rotor ESC is directly connected to receiver, pilot controls ESC speed through transmitter directly
#define AP_MOTORS_HELI_TANDEM_RSC_MODE_CH8_PASSTHROUGH 1       // main rotor ESC is connected to RC8 (out), pilot desired rotor speed provided by CH8 input
#define AP_MOTORS_HELI_TANDEM_RSC_MODE_SETPOINT        2       // main rotor ESC is connected to RC8 (out), desired speed is held in RSC_SETPOINT parameter

// default main rotor speed (ch8 out) as a number from 0 ~ 1000
#define AP_MOTORS_HELI_TANDEM_RSC_SETPOINT             500

// default main rotor ramp up time in seconds
#define AP_MOTORS_HELI_TANDEM_RSC_RAMP_TIME            1       // 1 second to ramp output to main rotor ESC to full power (most people use exterrnal govenors so we can ramp up quickly)
#define AP_MOTORS_HELI_TANDEM_RSC_RUNUP_TIME           10      // 10 seconds for rotor to reach full speed
#define AP_MOTORS_HELI_TANDEM_TAIL_RAMP_INCREMENT      5       // 5 is 2 seconds for direct drive tail rotor to reach to full speed (5 = (2sec*100hz)/1000)

// motor run-up time default in 100th of seconds
#define AP_MOTORS_HELI_TANDEM_MOTOR_RUNUP_TIME         500     // 500 = 5 seconds
...
class AP_MotorsHeliTandem : public AP_Motors {
public:
    ...
    AP_MotorsHeliTandem( RC_Channel&      rc_roll,
                   ...
                   uint16_t         speed_hz = AP_MOTORS_HELI_TANDEM_SPEED_DEFAULT) :
    ...
    // get_rsc_mode - gets the rotor speed control method (AP_MOTORS_HELI_TANDEM_RSC_MODE_NONE, AP_MOTORS_HELI_TANDEM_RSC_MODE_CH8_PASSTHROUGH or AP_MOTORS_HELI_TANDEM_RSC_MODE_SETPOINT)
...
private:
    ...
    AP_Int16        _yaw_max;                   // Maximum pitch angle of the swash plate in centi-degrees
    ...
    float           _pitchFactor[AP_MOTORS_HELI_TANDEM_NUM_SWASHPLATE_SERVOS];
    float           _yawFactor[AP_MOTORS_HELI_TANDEM_NUM_SWASHPLATE_SERVOS];
    float           _collectiveFactor[AP_MOTORS_HELI_TANDEM_NUM_SWASHPLATE_SERVOS];
