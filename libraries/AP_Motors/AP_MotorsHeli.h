...
#define AP_MOTORS_HELI_MAX_NUM_SWASHPLATE_SERVOS    6
...
protected:
    ...
    // internal variables
    float           _roll_factors[AP_MOTORS_HELI_MAX_NUM_SWASHPLATE_SERVOS];
    float           _pitch_factors[AP_MOTORS_HELI_MAX_NUM_SWASHPLATE_SERVOS];
    float           _collective_factors[AP_MOTORS_HELI_MAX_NUM_SWASHPLATE_SERVOS];
