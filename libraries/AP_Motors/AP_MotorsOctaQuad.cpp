...
void AP_MotorsOctaQuad::setup_motors()
{
    ...
    if( _flags.frame_orientation == AP_MOTORS_PLUS_FRAME ) {
        ...
        // V frame set-up
        add_motor_coax(AP_MOTORS_MOT_1,   45,  0.7981, 1, AP_MOTORS_MATRIX_COAX_UPPER);
        add_motor_coax(AP_MOTORS_MOT_2,  -45, -0.7981, 7, AP_MOTORS_MATRIX_COAX_UPPER);
        add_motor_coax(AP_MOTORS_MOT_3, -135,  1.0000, 5, AP_MOTORS_MATRIX_COAX_UPPER);
        add_motor_coax(AP_MOTORS_MOT_4,  135, -1.0000, 3, AP_MOTORS_MATRIX_COAX_UPPER);
        add_motor_coax(AP_MOTORS_MOT_5,  -45,  0.7981, 8, AP_MOTORS_MATRIX_COAX_LOWER);
        add_motor_coax(AP_MOTORS_MOT_6,   45, -0.7981, 2, AP_MOTORS_MATRIX_COAX_LOWER);
        add_motor_coax(AP_MOTORS_MOT_7,  135,  1.0000, 4, AP_MOTORS_MATRIX_COAX_LOWER);
        add_motor_coax(AP_MOTORS_MOT_8, -135, -1.0000, 6, AP_MOTORS_MATRIX_COAX_LOWER);
