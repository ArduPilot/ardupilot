...
{
    // tandem heli uses channels 1,2,3,4,5,6 and 8
    return (1U << 0 | 1U << 1 | 1U << 2 | 1U << 3 | 1U << 4 | 1U << 5 | 1U << 6 | 1U << AP_MOTORS_HELI_RSC);
}
...
// reset_servos
void AP_MotorsHeliTandem::reset_servos()
{
...
void AP_MotorsHeliTandem::calculate_swash_factors()
{    
...
//                       yaw:   -4500 ~ 4500
//
void AP_MotorsHeliTandem::move_swash(int16_t roll_out, int16_t pitch_out, int16_t collective_in, int16_t yaw_out)
{
