...
#if AP_DDS_GIMBAL_CTRL_ENABLED
    {
        .topic_id = to_underlying(TopicIndex::GIMBAL_CONTROL_SUB),
        .pub_id = to_underlying(TopicIndex::GIMBAL_CONTROL_SUB),
        .sub_id = to_underlying(TopicIndex::GIMBAL_CONTROL_SUB),
        .dw_id = uxrObjectId{.id=to_underlying(TopicIndex::GIMBAL_CONTROL_SUB), .type=UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id=to_underlying(TopicIndex::GIMBAL_CONTROL_SUB), .type=UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataReader,
        .topic_name = "rt/ap/experimental/cmd_gimbal_angles",
