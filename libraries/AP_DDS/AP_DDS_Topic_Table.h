...
#if AP_DDS_SERVO_CTRL_ENABLED
    {
        .topic_id = to_underlying(TopicIndex::SERVO_CONTROL_SUB),
        .pub_id = to_underlying(TopicIndex::SERVO_CONTROL_SUB),
        .sub_id = to_underlying(TopicIndex::SERVO_CONTROL_SUB),
        .dw_id = uxrObjectId{.id=to_underlying(TopicIndex::SERVO_CONTROL_SUB), .type=UXR_DATAWRITER_ID},
        .dr_id = uxrObjectId{.id=to_underlying(TopicIndex::SERVO_CONTROL_SUB), .type=UXR_DATAREADER_ID},
        .topic_rw = Topic_rw::DataReader,
        .topic_name = "rt/ap/experimental/cmd_servo",
        .type_name = "ardupilot_msgs::msg::dds_::ServoControl_",
        .qos = {
            .durability = UXR_DURABILITY_VOLATILE,
            .reliability = UXR_RELIABILITY_BEST_EFFORT,
            .history = UXR_HISTORY_KEEP_LAST,
