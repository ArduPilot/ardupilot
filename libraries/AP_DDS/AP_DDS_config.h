...
#ifndef AP_DDS_GIMBAL_CTRL_ENABLED
#define AP_DDS_GIMBAL_CTRL_ENABLED AP_DDS_EXPERIMENTAL_ENABLED
#endif
...
// Whether to include Vector3 support
#define AP_DDS_NEEDS_VECTOR3 AP_DDS_GIMBAL_CTRL_ENABLED
