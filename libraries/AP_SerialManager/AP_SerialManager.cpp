        ...
        if (uart != nullptr) {
            ...
            switch (state[i].protocol) {
                ...
                case SerialProtocol_Gimbal:
                    ...
                    break;
                case SerialProtocol_Doppler:
                    // begin is handled by the AP_Doppler_Telem library
                    break;
