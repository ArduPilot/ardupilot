...
void AP_DroneCAN::init(uint8_t driver_index, bool enable_filters)
{
    ...
    subscribed = subscribed && AP_GPS_DroneCAN::subscribe_msgs(this, driver_index);
#endif
#if AP_COMPASS_DRONECAN_ENABLED
    subscribed = subscribed && AP_Compass_DroneCAN::subscribe_msgs(this, driver_index);
#endif
#if AP_BARO_DRONECAN_ENABLED
    subscribed = subscribed && AP_Baro_DroneCAN::subscribe_msgs(this, driver_index);
#endif
    subscribed = subscribed && AP_BattMonitor_DroneCAN::subscribe_msgs(this, driver_index);
#if AP_AIRSPEED_DRONECAN_ENABLED
    subscribed = subscribed && AP_Airspeed_DroneCAN::subscribe_msgs(this, driver_index);
#endif
#if AP_OPTICALFLOW_HEREFLOW_ENABLED
    subscribed = subscribed && AP_OpticalFlow_HereFlow::subscribe_msgs(this, driver_index);
#endif
#if AP_RANGEFINDER_DRONECAN_ENABLED
    subscribed = subscribed && AP_RangeFinder_DroneCAN::subscribe_msgs(this, driver_index);
#endif
#if AP_RCPROTOCOL_DRONECAN_ENABLED
    subscribed = subscribed && AP_RCProtocol_DroneCAN::subscribe_msgs(this, driver_index);
#endif
#if AP_EFI_DRONECAN_ENABLED
    subscribed = subscribed && AP_EFI_DroneCAN::subscribe_msgs(this, driver_index);
#endif

#if AP_PROXIMITY_DRONECAN_ENABLED
    subscribed = subscribed && AP_Proximity_DroneCAN::subscribe_msgs(this, driver_index);
#endif
#if HAL_MOUNT_XACTI_ENABLED
    subscribed = subscribed && AP_Mount_Xacti::subscribe_msgs(this, driver_index);
#endif
#if AP_TEMPERATURE_SENSOR_DRONECAN_ENABLED
    subscribed = subscribed && AP_TemperatureSensor_DroneCAN::subscribe_msgs(this, driver_index);
#endif
#if AP_RPM_DRONECAN_ENABLED
    subscribed = subscribed && AP_RPM_DroneCAN::subscribe_msgs(this, driver_index);
#endif
