...
void AP_InertialSensor_ZeroOne_FPGA_SCH16T::start()
{
    ...
    if (!_imu.register_accel(accel_instance, backend_rate_hz, dev->get_bus_id_devtype(DEVTYPE_INS_SCH16T_K10)) ||
        !_imu.register_gyro(gyro_instance, backend_rate_hz,   dev->get_bus_id_devtype(DEVTYPE_INS_SCH16T_K10))) {
        return;
    }
