...
const AP_Param::GroupInfo AP_InertialSensor::var_info[] = {
    ...
    // @Description: Filter cutoff frequency for gyroscopes. This can be set to a lower value to try to cope with very high vibration levels in aircraft. A value of zero means track the value of GYRO_FILTER
    // @Units: Hz
    // @Range: 0 256
    // @User: Advanced
