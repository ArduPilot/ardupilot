...
#include "AP_InertialSensor_L3G4200D_2.h"
...
#define ADXL345_ACCELEROMETER_BW_RATE_100HZ                        0x0A # (default)
...
// constructor
AP_InertialSensor_L3G4200D_2::AP_InertialSensor_L3G4200D_2(AP_InertialSensor &imu,
...
AP_InertialSensor_L3G4200D_2::~AP_InertialSensor_L3G4200D_2()
{
}
...
/*
  detect the sensor
 */
AP_InertialSensor_Backend *AP_InertialSensor_L3G4200D_2::probe(AP_InertialSensor &imu,
                                                            AP_HAL::OwnPtr<AP_HAL::I2CDevice> dev_gyro,
                                                            AP_HAL::OwnPtr<AP_HAL::I2CDevice> dev_accel)
{
    ...
    AP_InertialSensor_L3G4200D_2 *sensor
        = new AP_InertialSensor_L3G4200D_2(imu, std::move(dev_gyro), std::move(dev_accel));
                                                            ...
                                                            enum Rotation rotation)
{
    ...
    AP_InertialSensor_L3G4200D_2 *sensor
        = new AP_InertialSensor_L3G4200D_2(imu, std::move(dev_gyro), std::move(dev_accel), rotation);
...
bool AP_InertialSensor_L3G4200D_2::_accel_init()
{
    ...
    if (data != ADXL345_ACCELEROMETER_XL345_DEVID) {
        AP_HAL::panic("AP_InertialSensor_L3G4200D_2: could not find ADXL345 accelerometer sensor");
    }
    // Full resolution, 8g:
...
bool AP_InertialSensor_L3G4200D_2::_gyro_init()
{
    uint8_t data = 0;
    // Init the Gyro
    ...
    if (data != L3G4200D_REG_WHO_AM_I_VALUE) {
        AP_HAL::panic("AP_InertialSensor_L3G4200D_2: could not find L3G4200D gyro sensor");
    }
...
/*
  startup the sensor
 */
void AP_InertialSensor_L3G4200D_2::start(void)
{
    //timing_printf("AP_InertialSensor_L3G4200D_2 MHEFNY: STARTED");
    ...
    _dev_accel->register_periodic_callback(1250, FUNCTOR_BIND_MEMBER(&AP_InertialSensor_L3G4200D_2::_accumulate_accel, void));
    _dev_gyro->register_periodic_callback(1250, FUNCTOR_BIND_MEMBER(&AP_InertialSensor_L3G4200D_2::_accumulate_gyro, void));
}
 ...
 */
void AP_InertialSensor_L3G4200D_2::_set_filter_frequency(uint8_t filter_hz)
{
 ...
 */
bool AP_InertialSensor_L3G4200D_2::update(void)
{
...
void AP_InertialSensor_L3G4200D_2::_accumulate_gyro (void)
{
...
void AP_InertialSensor_L3G4200D_2::_accumulate_accel (void)
{
    uint8_t num_samples_available;
    uint8_t fifo_status = 0;
