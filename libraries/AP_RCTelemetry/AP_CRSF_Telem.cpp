...
bool AP_CRSF_Telem::should_enter_scheduler_params_mode() const
{
    ...
    if (_pending_request.frame_type > 0 && _pending_request.frame_type != FrameType::CRSF_FRAMETYPE_PARAM_DEVICE_INFO) {
        return true;
    }
...
bool AP_CRSF_Telem::calc_scripted_parameter()
{
    ...
    if (spw.type == ScriptedParameterEvents::PARAMETER_WRITE &&
        ...
        _telem_type = FrameType::CRSF_FRAMETYPE_PARAMETER_WRITE;
