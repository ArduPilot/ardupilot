...
// constructor
Display_SH1106_I2C::Display_SH1106_I2C(AP_HAL::Device* dev) :
    _dev(dev)
{
}
...
Display_SH1106_I2C *Display_SH1106_I2C::probe(AP_HAL::Device* dev)
{
    Display_SH1106_I2C *driver = new Display_SH1106_I2C(dev);
