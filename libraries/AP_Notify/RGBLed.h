...
#define WHITE (RED|GREEN|BLUE)
    ...
    const uint32_t sequence_no_RC_in_GPS = DEFINE_COLOUR_SEQUENCE_ALTERNATE_SLOW(OFF,YELLOW); //DEFINE_COLOUR_SEQUENCE(GREEN,GREEN,YELLOW,YELLOW,GREEN,GREEN,YELLOW,YELLOW,YELLOW,OFF);
    const uint32_t sequence_no_RC_in_no_GPS = DEFINE_COLOUR_SEQUENCE_ALTERNATE_SLOW(OFF,YELLOW); //DEFINE_COLOUR_SEQUENCE(BLUE,BLUE,OFF,YELLOW,OFF,BLUE,BLUE,OFF,YELLOW,OFF);
