...
const AP_Param::GroupInfo AC_ForceTorque_Params::var_info[] = {
    ...
    // @Values: 0:LOCATION_NONE, 1:Up, 2:Down
    // @User: Advanced
    AP_GROUPINFO("LOCATION", 2, AC_ForceTorque_Params, location, Up),
    ...
    // @Increment: 0.01
    // @User: Standard
    AP_GROUPINFO("MIN_TORQ",  5, AC_ForceTorque_Params, min_torque_Nm, -2),
    ...
    // @Increment: 0.01
    // @User: Standard
    AP_GROUPINFO("MAX_TORQ",  6, AC_ForceTorque_Params, max_torque_Nm, 2),
