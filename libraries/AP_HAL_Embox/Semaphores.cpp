...
Semaphore::Semaphore() {
    ...
    // pthread_mutexattr_setprotocol(&attr, PTHREAD_PRIO_INHERIT); Not supported in Embox
...
BinarySemaphore::BinarySemaphore(bool initial_state) : AP_HAL::BinarySemaphore(initial_state) {
