...
#define EMBOX_SCHEDULER_MAX_TIMER_PROCS 10
#define EMBOX_SCHEDULER_MAX_TIMESLICED_PROCS 10
#define EMBOX_SCHEDULER_MAX_IO_PROCS 10

#define AP_EMBOX_SENSORS_STACK_SIZE 256 * 1024
#define AP_EMBOX_SENSORS_SCHED_POLICY SCHED_FIFO
#define AP_EMBOX_SENSORS_SCHED_PRIO 12
...
namespace Embox {
    ...
    private:
        ...
        AP_HAL::MemberProc _timer_proc[EMBOX_SCHEDULER_MAX_TIMER_PROCS];
        uint8_t _num_timer_procs;
        volatile bool _in_timer_proc;

        AP_HAL::MemberProc _io_proc[EMBOX_SCHEDULER_MAX_IO_PROCS];
