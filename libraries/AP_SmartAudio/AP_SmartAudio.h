...
#define SMARTAUDIO_ENABLED !HAL_MINIMIZE_FEATURES && (APM_BUILD_TYPE(APM_BUILD_ArduCopter) || APM_BUILD_TYPE(APM_BUILD_ArduPlane) || APM_BUILD_TYPE(APM_BUILD_ArduSub))
#endif
