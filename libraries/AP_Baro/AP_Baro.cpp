...
void AP_Baro::init(void)
{
    ...
    {
        drivers[0] = new AP_Baro_MS5611(*this, new AP_SerialBus_I2C(hal.i2c0, HAL_BARO_MS5611_I2C_ADDR), false);
        _num_drivers = 1;
    }
    ...
    {
        drivers[0] = new AP_Baro_MS5607(*this, new AP_SerialBus_I2C(hal.i2c1, HAL_BARO_MS5607_I2C_ADDR), false);
        _num_drivers = 1;
    }
#endif    
