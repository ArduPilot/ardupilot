...
public:
    ...
    //BEV added struct for VTOL
    struct VTOL {
    	//from plane (some renamed plane_x to avoid confilic w/ AC param names
        //AP_Int8 plane_throttle_min;
        //AP_Int8 plane_throttle_max;
        AP_Int8 throttle_slewrate;
        //AP_Int8 plane_throttle_cruise;
        //AP_Int16 airspeed_min;
        //AP_Int16 airspeed_max;
        AP_Int16 pitch_limit_max_cd;
        AP_Int16 pitch_limit_min_cd;
        //BEV this is kept so I don't have to re-write the ap_autotine libraries to accept a new aparm object
        AP_Int8  autotune_level;
        //from copter
        AP_Int16 angle_max;
    };//*/
