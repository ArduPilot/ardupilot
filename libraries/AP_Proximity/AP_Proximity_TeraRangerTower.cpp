...
{
    uart = serial_manager.find_serial(AP_SerialManager::SerialProtocol_TRTower, 0);
    if (uart != nullptr) {
        uart->begin(serial_manager.find_baudrate(AP_SerialManager::SerialProtocol_TRTower, 0));
    }
}
