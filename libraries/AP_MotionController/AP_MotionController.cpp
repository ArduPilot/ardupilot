...
const AP_Param::GroupInfo AP_MotionController::var_info[] = {
    // @Param: MASK
    // @DisplayName: Board Bitmask
    // @Description: One of four boards enabling mask
    // @Bitmask: 0:Disable, 1:One Board, 2:Two Boards, 3:Three Boards, 4:Four Boards
    // @User: Standard
    AP_GROUPINFO("MASK", 1, AP_MotionController, bitmask, 0),
