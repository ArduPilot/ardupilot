...
// Juan A Luna, North Europe
// The AP_GPS_NORTH class is a copy of AP_GPS_NMEA class with these changes:
// a) removes the _initialisation_blob sent in ctor. and related init messages
// b) add support for proper reporting of 3D Fixed
