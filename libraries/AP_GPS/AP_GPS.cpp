...
const AP_Param::GroupInfo AP_GPS::var_info[] PROGMEM = {
    ...
    // @User: Advanced
    AP_GROUPINFO("RTK_GIVE_B", 5, AP_GPS, _dgps_use_given_base, 0),
    ...
    // @Values: deg * 1e7 
    // @User: Advanced
    AP_GROUPINFO("RTK_B_LAT", 6, AP_GPS, _dgps_base_lat_wgs, 0),
    ...
    // @Values: deg * 1e7
    // @User: Advanced
    AP_GROUPINFO("RTK_B_LON", 7, AP_GPS, _dgps_base_lon_wgs, 0),
    ...
    // @Values: cm
    // @User: Advanced
    AP_GROUPINFO("RTK_B_ALT", 8, AP_GPS, _dgps_base_alt_wgs, 0),
