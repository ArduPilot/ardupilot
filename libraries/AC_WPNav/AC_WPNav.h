...
#define WPNAV_LOITER_SPEED              400.0f      // default loiter speed in cm/s
...
#define WPNAV_LOITER_JERK_MAX_DEFAULT  100.0f      // maximum jerk in cm/s/s/s in loiter mode
...
public:
    ...
    //BEV added this so plane can see what the target destination is
