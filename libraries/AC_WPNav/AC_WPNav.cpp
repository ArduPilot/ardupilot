...
{
	Vector3f origin;
	//BEV always reset the target. This is necessary to keep copter from reversing
	//direction following transition to hit the leash point set prior to transition
