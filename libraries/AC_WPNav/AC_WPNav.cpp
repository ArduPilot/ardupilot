...
void AC_WPNav::shift_wp_origin_and_destination_to_current_pos_NE()
{
    ...
    _origin_neu_cm.xy() = _pos_control.get_pos_estimate_NEU_cm().tofloat().xy();
    _destination_neu_cm.xy() = _pos_control.get_pos_estimate_NEU_cm().tofloat().xy();
}
...
{
    return get_horizontal_distance_cm(_pos_control.get_pos_estimate_NEU_cm().tofloat().xy(), _destination_neu_cm.xy());
}
...
{
    return get_bearing_cd(_pos_control.get_pos_estimate_NEU_cm().tofloat().xy(), _destination_neu_cm.xy());
}
