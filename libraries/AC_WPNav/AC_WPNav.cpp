...
{    
    ...
    _pos_control.init_D_controller_stopping_point();
    ...
    _pos_control.set_max_speed_accel_D_m(get_default_speed_down_ms(), get_default_speed_up_ms(), get_accel_D_mss());
    _pos_control.set_correction_speed_accel_D_m(get_default_speed_down_ms(), get_default_speed_up_ms(), get_accel_D_mss());
...
void AC_WPNav::set_speed_up_ms(float speed_up_ms)
{
    ...
    _pos_control.set_max_speed_accel_D_m(_pos_control.get_max_speed_down_ms(), speed_up_ms, _pos_control.get_max_accel_D_mss());
...
void AC_WPNav::set_speed_down_ms(float speed_down_ms)
{
    ...
    _pos_control.set_max_speed_accel_D_m(speed_down_ms, _pos_control.get_max_speed_up_ms(), _pos_control.get_max_accel_D_mss());
...
bool AC_WPNav::advance_wp_target_along_track(float dt)
{
    ...
    if (is_positive(curr_target_vel_ned_ms.length_squared())) {
        ...
        track_dt_scalar = constrain_float(0.05f + (track_velocity_ned_ms - _pos_control.get_pos_NE_p().kP() * track_error_ned_m) / curr_target_vel_ned_ms.length(), 0.0f, 1.0f);
    }
...
bool AC_WPNav::set_spline_destination_NED_m(const Vector3p& destination_ned_m, bool is_terrain_alt, const Vector3p& next_destination_ned_m, bool next_is_terrain_alt, bool next_is_spline)
{
    ...
    _spline_this_leg.set_speed_accel(_pos_control.get_max_speed_NE_ms(), _pos_control.get_max_speed_up_ms(), _pos_control.get_max_speed_down_ms(),
                                     _pos_control.get_max_accel_NE_mss(), _pos_control.get_max_accel_D_mss());
