...
// run the DCM backup on every Nth update while an EKF is the active estimator
#ifndef AP_AHRS_DCM_BACKUP_DECIMATION
#define AP_AHRS_DCM_BACKUP_DECIMATION 1
#endif
...
#ifndef AP_AHRS_NAVEKF2_ENABLED
#define AP_AHRS_NAVEKF2_ENABLED HAL_NAVEKF2_AVAILABLE
#endif
...
#define AP_AHRS_EKF_RESET_ENABLED 0
#endif
