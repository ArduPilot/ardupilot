...
const AP_Param::GroupInfo AP_ExternalAHRS::var_info[] = {
    ...
    // @Values: 0:None,1:VectorNav,2:MicroStrain5,5:InertialLabs,6:Trimble GSOF,7:MicroStrain7,8:SBG
    // @User: Standard
...
bool AP_ExternalAHRS::pre_arm_check(char *failure_msg, uint8_t failure_msg_len) const
{
    ...
    if (ahrs.ekf_type_parameter_value() == static_cast<int8_t>(AP_AHRS::EKFType::EXTERNAL)) {
