...
private:
    ...
    void process_ahrs_imu_packet(const uint8_t *b);
    void process_ahrs_ahrs_packet(const uint8_t *b);
    void process_ins_imu_packet(const uint8_t *b);
    void process_ins_ins_packet(const uint8_t *b);
    ...
    struct VN_INS_ins_packet const *latest_ins_ins_packet = nullptr;
