...
/*
 * I2C driver for Texas Instruments TMP119 high-accuracy digital temperature sensor.
 * The TMP119 is a variant of the TMP117 with a different device ID (0x2117).
 */
...
#ifndef AP_TEMPERATURE_SENSOR_TMP119_DEFAULT_I2C_ADDR
#define AP_TEMPERATURE_SENSOR_TMP119_DEFAULT_I2C_ADDR 0x48
#endif

class AP_TemperatureSensor_TMP119 : public AP_TemperatureSensor_Backend {
