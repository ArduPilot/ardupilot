...
enum ap_message : uint8_t {
    ...
    MSG_OPTICAL_FLOW                   =  52,
    MSG_OPTICAL_FLOW_RAD               =  53,
    MSG_MAG_CAL_PROGRESS               =  54,
    MSG_MAG_CAL_REPORT                 =  55,
    MSG_EKF_STATUS_REPORT              =  56,
    MSG_LOCAL_POSITION                 =  57,
    MSG_PID_TUNING                     =  58,
    MSG_VIBRATION                      =  59,
    MSG_RPM                            =  60,
    MSG_WHEEL_DISTANCE                 =  61,
    MSG_MISSION_ITEM_REACHED           =  62,
    MSG_POSITION_TARGET_GLOBAL_INT     =  63,
    MSG_POSITION_TARGET_LOCAL_NED      =  64,
    MSG_ADSB_VEHICLE                   =  65,
    MSG_BATTERY_STATUS                 =  66,
    MSG_AOA_SSA                        =  67,
    MSG_LANDING                        =  68,
    MSG_ESC_TELEMETRY                  =  69,
    MSG_ORIGIN                         =  70,
    MSG_HOME                           =  71,
    MSG_NAMED_FLOAT                    =  72,
    MSG_EXTENDED_SYS_STATE             =  73,
    MSG_AUTOPILOT_VERSION              =  74,
    MSG_EFI_STATUS                     =  75,
    MSG_GENERATOR_STATUS               =  76,
    MSG_WINCH_STATUS                   =  77,
    MSG_WATER_DEPTH                    =  78,
    MSG_HIGH_LATENCY2                  =  79,
    MSG_AIS_VESSEL                     =  80,
    MSG_MCU_STATUS                     =  90,
