...
#if AP_MAVLINK_MSG_ILLUMINATOR_STATUS_SENDING_ENABLED && defined(MAVLINK_MSG_ID_ILLUMINATOR_STATUS) && APM_BUILD_TYPE(APM_BUILD_ArduSub)
    MSG_ILLUMINATOR_STATUS,
#endif  // AP_MAVLINK_MSG_ILLUMINATOR_STATUS_SENDING_ENABLED && defined(MAVLINK_MSG_ID_ILLUMINATOR_STATUS) && APM_BUILD_TYPE(APM_BUILD_ArduSub)
    MSG_DISTANCE_SENSOR,
    MSG_SYSTEM_TIME,
