...
private:
    ...
    // Used by commands that carry float actuator-style values in p5/p6
    // and want fractional precision preserved across the
    // COMMAND_LONG -> COMMAND_INT canonicalisation.
