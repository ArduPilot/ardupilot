...
#include <SITL/SITL.h>
  ...
  #if ArduPilot_BUILD_TYPE(ArduPilot_BUILD_ArduCopter) || ArduPilot_BUILD_TYPE(ArduPilot_BUILD_ArduPlane) || ArduPilot_BUILD_TYPE(ArduPilot_BUILD_ArduSub)
...
// To be replaced with macro saying if KDECAN library is included
#if (ArduPilot_BUILD_TYPE(ArduPilot_BUILD_ArduCopter) || ArduPilot_BUILD_TYPE(ArduPilot_BUILD_ArduPlane) || ArduPilot_BUILD_TYPE(ArduPilot_BUILD_ArduSub)) && (HAL_MAX_CAN_PROTOCOL_DRIVERS > 1 && !HAL_MINIMIZE_FEATURES)
