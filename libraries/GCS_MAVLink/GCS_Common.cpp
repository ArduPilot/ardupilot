...
void GCS_MAVLINK::send_attitude(AP_AHRS &ahrs, mavlink_channel_t mav_chan) {
...
void GCS_MAVLINK::send_location(AP_AHRS &ahrs, AP_GPS &gps, Location &current_loc, mavlink_channel_t mav_chan) {
