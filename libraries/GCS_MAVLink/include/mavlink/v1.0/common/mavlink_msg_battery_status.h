...
typedef struct __mavlink_battery_status_t
{
 ...
 uint16_t cell_voltages[10]; ///< Battery voltage of cells, in millivolts (1 = 1 millivolt)
...
#define MAVLINK_MSG_ID_BATTERY_STATUS_CRC 121
#define MAVLINK_MSG_ID_147_CRC 121

#define MAVLINK_MSG_BATTERY_STATUS_FIELD_CELL_VOLTAGES_LEN 10
...
#define MAVLINK_MESSAGE_INFO_BATTERY_STATUS { \
	...
	{  { "current_consumed", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_battery_status_t, current_consumed) }, \
         ...
         { "battery_temperature", NULL, MAVLINK_TYPE_INT16_T, 0, 8, offsetof(mavlink_battery_status_t, battery_temperature) }, \
         { "cell_voltages", NULL, MAVLINK_TYPE_UINT16_T, 10, 10, offsetof(mavlink_battery_status_t, cell_voltages) }, \
         { "current_battery", NULL, MAVLINK_TYPE_INT16_T, 0, 30, offsetof(mavlink_battery_status_t, current_battery) }, \
         { "battery_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_battery_status_t, battery_id) }, \
         { "battery_function", NULL, MAVLINK_TYPE_UINT8_T, 0, 33, offsetof(mavlink_battery_status_t, battery_function) }, \
         { "battery_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 34, offsetof(mavlink_battery_status_t, battery_type) }, \
 ...
 * @param battery_temperature Temperature of the battery in centi-degrees celsius. INT16_MAX for unknown temperature.
 * @param cell_voltages Battery voltage of cells, in millivolts (1 = 1 millivolt)
...
static inline uint16_t mavlink_msg_battery_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t battery_id, uint8_t battery_function, uint8_t battery_type, int16_t battery_temperature, const uint16_t *cell_voltages, int16_t current_battery, int32_t current_consumed, int32_t energy_consumed, int8_t battery_remaining)
{
	...
	_mav_put_int16_t(buf, 8, battery_temperature);
	_mav_put_int16_t(buf, 30, current_battery);
	_mav_put_uint8_t(buf, 32, battery_id);
	_mav_put_uint8_t(buf, 33, battery_function);
	_mav_put_uint8_t(buf, 34, battery_type);
	_mav_put_int8_t(buf, 35, battery_remaining);
	_mav_put_uint16_t_array(buf, 10, cell_voltages, 10);
	...
	packet.battery_temperature = battery_temperature;
	packet.current_battery = current_battery;
	packet.battery_id = battery_id;
	packet.battery_function = battery_function;
	packet.battery_type = battery_type;
	packet.battery_remaining = battery_remaining;
	mav_array_memcpy(packet.cell_voltages, cell_voltages, sizeof(uint16_t)*10);
...
{
	return mavlink_msg_battery_status_pack(system_id, component_id, msg, battery_status->battery_id, battery_status->battery_function, battery_status->battery_type, battery_status->battery_temperature, battery_status->cell_voltages, battery_status->current_battery, battery_status->current_consumed, battery_status->energy_consumed, battery_status->battery_remaining);
}
...
{
	return mavlink_msg_battery_status_pack_chan(system_id, component_id, chan, msg, battery_status->battery_id, battery_status->battery_function, battery_status->battery_type, battery_status->battery_temperature, battery_status->cell_voltages, battery_status->current_battery, battery_status->current_consumed, battery_status->energy_consumed, battery_status->battery_remaining);
}
...
static inline void mavlink_msg_battery_status_send(mavlink_channel_t chan, uint8_t battery_id, uint8_t battery_function, uint8_t battery_type, int16_t battery_temperature, const uint16_t *cell_voltages, int16_t current_battery, int32_t current_consumed, int32_t energy_consumed, int8_t battery_remaining)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_BATTERY_STATUS_LEN];
	_mav_put_int32_t(buf, 0, current_consumed);
 ...
 */
static inline void mavlink_msg_battery_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t battery_id, uint8_t battery_function, uint8_t battery_type, int16_t battery_temperature, const uint16_t *cell_voltages, int16_t current_battery, int32_t current_consumed, int32_t energy_consumed, int8_t battery_remaining)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field battery_id from battery_status message
 *
 * @return Battery ID
 */
static inline uint8_t mavlink_msg_battery_status_get_battery_id(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field battery_type from battery_status message
 *
 * @return Type (chemistry) of the battery
 */
static inline uint8_t mavlink_msg_battery_status_get_battery_type(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint8_t(msg,  34);
}

/**
 * @brief Get field battery_temperature from battery_status message
 *
 * @return Temperature of the battery in centi-degrees celsius. INT16_MAX for unknown temperature.
 */
static inline int16_t mavlink_msg_battery_status_get_battery_temperature(const mavlink_message_t* msg)
{
	return _MAV_RETURN_int16_t(msg,  8);
}

/**
 * @brief Get field cell_voltages from battery_status message
 *
 * @return Battery voltage of cells, in millivolts (1 = 1 millivolt)
 */
static inline uint16_t mavlink_msg_battery_status_get_cell_voltages(const mavlink_message_t* msg, uint16_t *cell_voltages)
{
	return _MAV_RETURN_uint16_t_array(msg, cell_voltages, 10,  10);
}
...
static inline void mavlink_msg_battery_status_decode(const mavlink_message_t* msg, mavlink_battery_status_t* battery_status)
{
	...
	battery_status->battery_temperature = mavlink_msg_battery_status_get_battery_temperature(msg);
	mavlink_msg_battery_status_get_cell_voltages(msg, battery_status->cell_voltages);
	battery_status->current_battery = mavlink_msg_battery_status_get_current_battery(msg);
	battery_status->battery_id = mavlink_msg_battery_status_get_battery_id(msg);
	battery_status->battery_function = mavlink_msg_battery_status_get_battery_function(msg);
	battery_status->battery_type = mavlink_msg_battery_status_get_battery_type(msg);
