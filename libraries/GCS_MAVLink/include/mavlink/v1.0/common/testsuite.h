...
static void mavlink_test_battery_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_battery_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.battery_temperature = packet_in.battery_temperature;
        	packet1.current_battery = packet_in.current_battery;
        	...
        	mav_array_memcpy(packet1.cell_voltages, packet_in.cell_voltages, sizeof(uint16_t)*10);
	...
	mavlink_msg_battery_status_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_battery_status_pack(system_id, component_id, &msg , packet1.battery_id , packet1.battery_function , packet1.battery_type , packet1.battery_temperature , packet1.cell_voltages , packet1.current_battery , packet1.current_consumed , packet1.energy_consumed , packet1.battery_remaining );
	mavlink_msg_battery_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_battery_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.battery_id , packet1.battery_function , packet1.battery_type , packet1.battery_temperature , packet1.cell_voltages , packet1.current_battery , packet1.current_consumed , packet1.energy_consumed , packet1.battery_remaining );
	mavlink_msg_battery_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_battery_status_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_battery_status_send(MAVLINK_COMM_1 , packet1.battery_id , packet1.battery_function , packet1.battery_type , packet1.battery_temperature , packet1.cell_voltages , packet1.current_battery , packet1.current_consumed , packet1.energy_consumed , packet1.battery_remaining );
	mavlink_msg_battery_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
