...
#define MAVLINK_MSG_ID_REMOTE_LOG_DATA_BLOCK_LEN 205
#define MAVLINK_MSG_ID_141_LEN 205

#define MAVLINK_MSG_ID_REMOTE_LOG_DATA_BLOCK_CRC 142
#define MAVLINK_MSG_ID_141_CRC 142
...
#define MAVLINK_MESSAGE_INFO_REMOTE_LOG_DATA_BLOCK { \
	...
	{  { "block_cnt", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_remote_log_data_block_t, block_cnt) }, \
         { "block_size", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_remote_log_data_block_t, block_size) }, \
         { "data", NULL, MAVLINK_TYPE_UINT8_T, 200, 5, offsetof(mavlink_remote_log_data_block_t, data) }, \
         } \
}
...
static inline uint16_t mavlink_msg_remote_log_data_block_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t block_size, uint32_t block_cnt, const uint8_t *data)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_REMOTE_LOG_DATA_BLOCK_LEN];
	_mav_put_uint32_t(buf, 0, block_cnt);
	_mav_put_uint8_t(buf, 4, block_size);
	_mav_put_uint8_t_array(buf, 5, data, 200);
...
{
	return mavlink_msg_remote_log_data_block_pack(system_id, component_id, msg, remote_log_data_block->block_size, remote_log_data_block->block_cnt, remote_log_data_block->data);
}
...
{
	return mavlink_msg_remote_log_data_block_pack_chan(system_id, component_id, chan, msg, remote_log_data_block->block_size, remote_log_data_block->block_cnt, remote_log_data_block->data);
}
...
static inline void mavlink_msg_remote_log_data_block_send(mavlink_channel_t chan, uint8_t block_size, uint32_t block_cnt, const uint8_t *data)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_REMOTE_LOG_DATA_BLOCK_LEN];
	_mav_put_uint32_t(buf, 0, block_cnt);
 ...
 */
static inline void mavlink_msg_remote_log_data_block_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t block_size, uint32_t block_cnt, const uint8_t *data)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
	return _MAV_RETURN_uint8_t_array(msg, data, 200,  5);
}
