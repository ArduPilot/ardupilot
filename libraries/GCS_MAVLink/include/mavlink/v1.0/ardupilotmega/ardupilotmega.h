...
/** @brief These encode the sensors whose status is sent as part of the SAFETY_STATUS message. ArduCopter only. */
#ifndef HAVE_ENUM_PREARM_STATUS_FLAGS
#define HAVE_ENUM_PREARM_STATUS_FLAGS
typedef enum PREARM_STATUS_FLAGS
{
	PREARM_RC=1, /* PreArm: RC not calibrated | */
	PREARM_BARO=2, /* PreArm: Baro not healthy | */
	PREARM_ALT=4, /* PreArm: Alt disparity | */
	PREARM_COMPASS_HEALTH=8, /* PreArm: Compass not healthy | */
	PREARM_COMPASS_CALIBRATED=16, /* PreArm: Compass not calibrated | */
	PREARM_COMPASS_OFFSETS=32, /* PreArm: Compass offsets too high | */
	PREARM_MAG_FIELD=64, /* PreArm: Check mag field | */
	PREARM_INCOSISTENT_COMPASS=128, /* PreArm: inconsistent compasses | */
	PREARM_FENCE=256, /* PreArm: check fence | */
	PREARM_INS=512, /* PreArm: INS not calibrated | */
	PREARM_ACCELS_HEALTHY=1024, /* PreArm: Accelerometers not healthy | */
	PREARM_INCONSISTENT_ACCELS=2048, /* PreArm: inconsistent Accelerometers | */
	PREARM_GYRO_HEALTHY=4096, /* PreArm: Gyros not healthy | */
	PREARM_GYRO_CAL=8192, /* PreArm: Gyro cal failed | */
	PREARM_INCONSISTENT_GYRO=16384, /* PreArm: inconsistent Gyros | */
	PREARM_BOARD_VOLTAGE=32768, /* PreArm: Check Board Voltage | */
	PREARM_DUPLICATE_AUX=65536, /* PreArm: Duplicate Aux Switch Options | */
	PREARM_FS_THR_VALUE=131072, /* PreArm: Check FS_THR_VALUE | */
	PREARM_ANGLE_MAX=262144, /* PreArm: Check ANGLE_MAX | */
	PREARM_ACRO_BAL=524288, /* PreArm: ACRO_BAL_ROLL/PITCH | */
	PREARM_RANGE_FINDER=1048576, /* PreArm: check range finder | */
	PREARM_WAIT_NAV_CHECKS=2097152, /* PreArm: Waiting for Nav Checks | */
	PREARM_NEED_3D_FIX=4194304, /* PreArm: Need 3D Fix | */
	PREARM_EKF_HOME=8388608, /* PreArm: EKF-home variance | */
	PREARM_HIGH_GPS_HDOP=16777216, /* PreArm: High GPS HDOP | */
	PREARM_STATUS_FLAGS_ENUM_END=16777217, /*  | */
} PREARM_STATUS_FLAGS;
#endif
...
#include "./mavlink_msg_safety_status.h"
