...
#define MAVLINK_MSG_ID_CAMERA_EVENT_LEN 27
#define MAVLINK_MSG_ID_179_LEN 27

#define MAVLINK_MSG_ID_CAMERA_EVENT_CRC 230
#define MAVLINK_MSG_ID_179_CRC 230
...
#define MAVLINK_MESSAGE_INFO_CAMERA_EVENT { \
	...
	{  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_camera_event_t, time_usec) }, \
         ...
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_camera_event_t, target_system) }, \
         { "cam_idx", NULL, MAVLINK_TYPE_UINT8_T, 0, 25, offsetof(mavlink_camera_event_t, cam_idx) }, \
         { "event_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 26, offsetof(mavlink_camera_event_t, event_id) }, \
         } \
}
...
static inline uint16_t mavlink_msg_camera_event_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t time_usec, uint8_t target_system, uint8_t cam_idx, uint8_t event_id, float p1, float p2, float p3, float p4)
{
	...
	_mav_put_uint8_t(buf, 25, cam_idx);
	_mav_put_uint8_t(buf, 26, event_id);
...
{
	return mavlink_msg_camera_event_pack(system_id, component_id, msg, camera_event->time_usec, camera_event->target_system, camera_event->cam_idx, camera_event->event_id, camera_event->p1, camera_event->p2, camera_event->p3, camera_event->p4);
}
...
{
	return mavlink_msg_camera_event_pack_chan(system_id, component_id, chan, msg, camera_event->time_usec, camera_event->target_system, camera_event->cam_idx, camera_event->event_id, camera_event->p1, camera_event->p2, camera_event->p3, camera_event->p4);
}
...
static inline void mavlink_msg_camera_event_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t target_system, uint8_t cam_idx, uint8_t event_id, float p1, float p2, float p3, float p4)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_CAMERA_EVENT_LEN];
	_mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_camera_event_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint8_t target_system, uint8_t cam_idx, uint8_t event_id, float p1, float p2, float p3, float p4)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
