...
// allow removal of the PREFLIGHT_SET_SENSOR_OFFSETS command;
// tumble-calibration, in-flight EKF-based calculation, large vehicle
// calibration are all alternatives to this.
#ifndef AP_MAVLINK_MAV_CMD_PREFLIGHT_SET_SENSOR_OFFSETS_ENABLED
#define AP_MAVLINK_MAV_CMD_PREFLIGHT_SET_SENSOR_OFFSETS_ENABLED 1
#endif
