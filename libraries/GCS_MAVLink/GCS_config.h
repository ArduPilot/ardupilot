...
// ArduPilot in 4.1.x
// CODE_REMOVAL
// ArduPilot 4.8 warns if the message is received
// ArduPilot 4.9 warns if the message is received
// ArduPilot 4.10 compiles the code out
// ArduPilot 4.11 removes the code entirely
