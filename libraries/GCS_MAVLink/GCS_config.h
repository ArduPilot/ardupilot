...
// Added support for OPTICAL_FLOW_RAD, restricted to boards with > 1MB flash
    ...
    #define AP_MAVLINK_MSG_OPTICAL_FLOW_RAD_ENABLED (AP_OPTICALFLOW_ENABLED && !HAL_MINIMIZE_FEATURES && (HAL_PROGRAM_SIZE_LIMIT_KB > 1024))
#endif

#ifndef AP_MAVLINK_MSG_OPTICAL_FLOW_RAD_SENDING_ENABLED
    #define AP_MAVLINK_MSG_OPTICAL_FLOW_RAD_SENDING_ENABLED AP_MAVLINK_MSG_OPTICAL_FLOW_RAD_ENABLED
#endif

// Define the SENDING alias since some functions use this naming convention
#ifndef AP_MAVLINK_MSG_OPTICAL_FLOW_RAD_SENDING_ENABLED
#define AP_MAVLINK_MSG_OPTICAL_FLOW_RAD_SENDING_ENABLED AP_MAVLINK_MSG_OPTICAL_FLOW_RAD_ENABLED
#endif
