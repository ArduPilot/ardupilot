...
private:
    ...
    AbsAltLocation _next_destination_oabak; // backup of _next_destination so it can be restored when oa completes
    AbsAltLocation _oa_origin;            // intermediate origin during avoidance
    AbsAltLocation _oa_destination;       // intermediate destination during avoidance
    AbsAltLocation _oa_next_destination;  // intermediate next destination during avoidance
