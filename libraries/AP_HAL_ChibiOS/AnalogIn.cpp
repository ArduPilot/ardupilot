...
// div=0 -> back-to-back 500 kS/s -> 4-entry FIFO fills in 8 us -> DMA ISR re-arm gap (~2 us) causes FIFO overflow -> ADC_FCS_OVER set -> adc_lld_serve_dma_interrupt calls _adc_isr_error_code -> ADC stops permanently.
