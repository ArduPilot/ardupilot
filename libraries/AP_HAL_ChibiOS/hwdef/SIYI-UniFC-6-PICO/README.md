...
only channels 1~12 support DShot. Outputs 1-4 support BDShot.
...
- BATT_VOLT_PIN 4
- BATT_CURR_PIN 5
- BATT_VOLT_MULT 18.182 (must need adjustment depending on the connected power monitor)
- BATT_AMP_PERVLT 36.364 (must need adjustment depending on the connected power monitor)
