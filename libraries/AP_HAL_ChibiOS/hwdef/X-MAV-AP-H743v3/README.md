...
The AP-H743v3 provides two CAN bus interfaces:

- **CAN1**: PD0 (RX), PD1 (TX)
- **CAN2**: PB5 (RX), PB6 (TX)

Both CAN interfaces are available on dedicated connectors as shown in the board's bottom-port diagram. CAN is commonly used for connecting GPS/Compass modules, ESC telemetry, or other peripheral devices.
