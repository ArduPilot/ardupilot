...
![DroneerX6](DroneerX6_V1.png "DroneerX6")
...
![DroneerX6 Pinout](DroneerX6_Pinout.png "DroneerX6")
...
| SERIAL8 | OTG2     | USB/MAVLink2      | |

The TELEM2 and TELEM3 ports have RTS/CTS pins, the other UARTs do not have RTS/CTS.
...
- CRSF/ELRS would require `SERIAL6_OPTIONS` be set to "0". CRSF/ELRS needs a UART with DMA for reliable operation; UART4 (SERIAL6) has DMA.
...
| M13 | 54 | AuxOut5 |
| M14 | 55 | AuxOut6 |
| M15 | 56 | AuxOut7(TIM12_CH1) |
| M16 | 57 | AuxOut8(TIM12_CH2) |
| FMU_CAP1 | 58 | FCU CAP|
| NFC_GPIO | 60 ||

- note:M15 and M16 are on AD&IO,not together with MAIN(1-8) and AUX(1-6).
- SPI6 is disabled.
