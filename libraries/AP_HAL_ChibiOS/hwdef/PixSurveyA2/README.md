## PixSurveyA2 Flight Controller

The PixSurveyA2 flight controller is sold by a range of resellers listed on the makeflyeasy(http://www.makeflyeasy.com)

## Features

•	STM32H743VIT6 and STM32F103C8T6 microcontroller

•	Three IMUs, two IIM42652(SPI), one ICM42688-P(SPI)
...
![PixSurveyA2](PixSurveyA2.png "PixSurveyA2")
...
The PixSurveyA2 supports up to 14 PWM outputs. First first 8 outputs (labelled 1 to 8) are controlled by a dedicated STM32F103 IO controller. These 8
