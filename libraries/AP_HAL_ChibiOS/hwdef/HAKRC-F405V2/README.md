...
|SERIAL1|TX1/RX1|UART1|
|SERIAL2|TX2/RX2|UART2 (RC Input)|
|SERIAL4|TX4/RX4|UART4|
|SERIAL6|TX6/RX6|UART6 (GPS)|

## RC Input

RC input is configured on SERIAL2 (USART2), which is available on the RX2, TX2.
...
- RELAY2 (GPIO 82): VTX Power control (HIGH:off; LOW:on)
