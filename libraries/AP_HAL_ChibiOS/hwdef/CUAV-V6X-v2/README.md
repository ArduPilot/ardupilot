...
RC input is configured on the port marked DSM/SBUS RC and PPM IN.
...
The 8 main PWM outputs of CUAV-V6X-v2 flight controller support switching between 3.3V voltage and 5V voltage output. It can be switched to 5V by setting GPIO 81 high by setting up a Voltage-Level Translator to control it (set the `BRD_PWM_VOLT_SEL` parameter in ArduPilot).
