...
- After first update, users can connect through the serial port. Check [CubePilot documentation](https://docs.cubepilot.org/user-guides/here-4/here-4-manual#pinout) for breakout board pinouts.
