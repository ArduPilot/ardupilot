...
## Features
    ...
    Power
        ...
        9V, 2A BEC for powering Video Transmitter controlled by GPIO
        5V/6V/7.4V, 8A BEC for servos
...
receive pin for UARTn. The Tn pin is the transmit pin for UARTn.
 ...
 - SERIAL4 -> UART4 (TELEM) (TX DMA capable)
...
The JHEMCUF405Wing supports using its internal OSD using OSD_TYPE 1 (MAX7456 driver). External OSD support such as DJI or DisplayPort is supported using UART5 or any other free UART5. See :ref:`common-msp-osd-overview-4.2` for more info.
