...
- Processor
  ...
  - AT7456E OSD
  - ESP8685 wireless module for BLE/WiFi telemetry
- Sensors
...
The CoreWing F405 Wing Mini V2 supports using its internal OSD using OSD_TYPE 1 (MAX7456 driver). External OSD support such as DJI or MSP DisplayPort is supported using UART3 or any other free UART. See [MSP OSD](https://ardupilot.org/copter/docs/common-msp-osd-overview-4.2.html) for more information.
