...
The BROTHERHOBBYF405v3 is a flight controller produced by [Brother Hobby](https://www.brotherhobby.com/).
...
![BROTHERHOBBYF405v3 Board](BROTHERHOBBYF405v3.jpg "BROTHERHOBBYF405v3")
...
The BROTHERHOBBYF405v3 supports OSD using OSD_TYPE 1 (MAX7456 driver) or OSD_TYPE 3 if using DJI OSD

## PWM Output

The BROTHERHOBBYF405v3 supports up to 9 PWM outputs. The pads for motor output
...
The BROTHERHOBBYF405v3 does not have a builtin compass, but you can attach an external compass using I2C on the SDA and SCL pads.
