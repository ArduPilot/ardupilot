...
The Skydroid supports up to 12 PWM outputs. Outputs 1-8 support DShot also.

All 12 PWM outputs have GND on the top row, 5V on the middle row and
signal on the bottom row. Outputs are grouped based on which timer they use. All outputs in a group must be the same protocol
