...
PWM outputs are provided through the PAB connector. All outputs are capable of PWM and DShot. Outputs in the same timer group must use the same protocol:
