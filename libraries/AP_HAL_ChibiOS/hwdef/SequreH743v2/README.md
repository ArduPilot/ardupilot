...
# SequreH743v2 Flight Controller

The SequreH743v2 is a flight controller designed and produced by [Sequre](https://sequremall.coms).
...
## Features
 ...
 ![SequreH743v2 Top](SequreH743v2Top.png)
 
 ![SequreH743v2 Bottom](SequreH743v2Bottom.png)
...
The SequreH743v2 supports OSD using OSD_TYPE 1 (MAX7456 driver)
...
The SequreH743v2 supports up to 9 PWM or DShot outputs. The pads for motor output
...
The SequreH743v2 does not have a builtin compass, but you can attach an external compass using I2C on the SDA and SCL pads.

## Loading Firmware

Firmware for these boards can be found `here <https://firmware.ardupilot.org>`__ in sub-folders labeled "SequreH743v2".
