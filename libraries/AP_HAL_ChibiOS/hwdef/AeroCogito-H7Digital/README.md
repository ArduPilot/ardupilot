...
| SERIAL5     | UART3    | ESC Telemetry | RX only on T, DMA-enabled               |
| SERIAL6     | UART7    | SBUS          | RX only on R7 for DJI, DMA-enabled      |
...
Bidirectional DShot supported on motors 1, 3, 5, 7.
...
The H7-Digital also supports Betaflight as the `AEROH7DIGITAL` target.
