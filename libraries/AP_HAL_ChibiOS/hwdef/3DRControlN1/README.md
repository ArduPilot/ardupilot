...
The Control N1 is a flight controller produced by [3DR](https://store.3dr.com/control-n1/).

![3DR Control N1](control_n1.jpg)
![3DR Control N1 Bottom](control_n1_bottom.jpg)
...
![CN1 2D](control_n1_2d_drawing.png)
...
Outputs 1-12 are Bidirectional DShot capable.
...
Other Power Modules need to be adjusted accordingly.
...
For more information visit: docs.3dr.com
