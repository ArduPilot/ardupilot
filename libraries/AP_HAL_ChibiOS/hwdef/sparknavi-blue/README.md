...
First 8 outputs (labelled PWM 1 to PWM 8) are controlled by a dedicated STM32F103 IO controller. The remaining 6 outputs (labelled AUX 1 to AUX 6) are the "auxiliary" outputs. These are directly attached to the STM32H743 FMU controller.

All 14 outputs support normal PWM output formats. All outputs support DShot via IOMCU DShot firmware. Outputs 9, 11, and 13 (AUX 1, AUX 3, AUX 5) support Bi-Directional DShot.
...
The 6 FMU PWM outputs are in 3 groups:
