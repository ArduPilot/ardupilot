...
- **Ethernet**
  - 100 MBit/s
- **PWM**
  - 6 x PWM / DShot, 3 x Bidirectional-DShot capable
- **RC Input**
...
All outputs are capable of PWM and DShot. Motors 1-3 are capable of Bidirectional-DShot. All outputs in the motor groups below must be either PWM or DShot:
