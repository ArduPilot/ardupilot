...
The default RC input is configured on the UART6. And RC could be applied instead at a different UART port such as UART1, UART4 or UART5, and set the protocol to receive RC data: `SERIALn_PROTOCOL=23` and change SERIAL6 _Protocol to something other than '23'.
