...
Servo outputs (S1–S4) on PA15, PB3, PD12, and PD13 (TIM2 and TIM4 timers) are PWM only. Output 13 (LED) is in a separate group and supports PWM/DShot or serial LED operation.
