# HawkH743 Flight Controller
The HawkH743 is an STM32H743-based flight controller designed for compact drones that require high performance with a reduced connector layout.  
