...
The NarinFC-H5 is a flight controller produced by [VOLOLAND CO., LTD](https://vololand.com "VOLOLAND CO., LTD")
...
![NarinFC-H5](./images/NarinFC_Header.jpg "NarinFC")
...
The NarinFC-H5 supports up to 14 PWM outputs. Outputs are grouped and all outputs within their group must be the same protocol.
...
The NarinFC-H5 supports up to 14 PWM outputs.All outputs except M13 and M14 support DShot. Outputs 1-8 support Bi-Directional DShot.
...
Firmware for these boards can be found `here  <https://firmware.ardupilot.org>`__ in sub-folders labeled “NarinFC-H5”.
