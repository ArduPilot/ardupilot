...
Additional
==========
uk_UA: [україномовна документація та прошивки в репозиторії](#)

[Xrush4_F4V3_Manual_Rev.3.0](https://xrush4.tech/wp-content/uploads/2025/09/Xrush4_F4V3_Manual_3.0.pdf)
