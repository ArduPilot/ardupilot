...
PWM M1~M8 (IO Main PWM), A1~A8(FMU PWM). All these 16 support normal PWM output formats. FMU PWM A1~A6 can support DShot.
...
- [BATT_MONITOR = 8](https://ardupilot.org/copter/docs/parameters.html#batt-monitor)
- [CAN_P1_DRIVER = 1](https://ardupilot.org/copter/docs/parameters.html#can-p1-driver)
- [CAN_P2_DRIVER = 1](https://ardupilot.org/copter/docs/parameters.html#can-p2-driver)
- [CAN_D1_PROTOCOL = 1](https://ardupilot.org/copter/docs/parameters.html#can-d1-protocol)
- [CAN_D2_PROTOCOL = 1](https://ardupilot.org/copter/docs/parameters.html#can-d2-protocol)

For a common [I2C PM02D power monitor](https://ardupilot.org/copter/docs/common-powermodule-landingpage.html#i2c-power-monitor), you can set [BATT_MONITOR](https://ardupilot.org/copter/docs/parameters.html#batt-monitor) value to 21
...
Godwit G-A1 is identified as board id 7120, folder labeled "**AcctonGodwit_GA1**" in [Ardupilot firmware server](https://firmware.ardupilot.org/)
