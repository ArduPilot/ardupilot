...
![CUAV-X25-MEGA.png](CUAV-X25-MEGA.png)
...
![CUAV-X25-MEGA-pinout.png](CUAV-X25-MEGA-pinout_01.png)
![CUAV-X25-MEGA-pinout.png](CUAV-X25-MEGA-pinout_02.png)
...
The CUAV-X25-MEGA has 3 IMUs. one IIM42652 with an external crystal oscillator and two IIM42653. All these IMUs have heater.
...
Firmware for these boards can be found at the [ArduPilot firmware server](https://firmware.ardupilot.org) in sub-folders labeled "CUAV-X25-MEGA".
