...
# flake8: noqa
'''
these tables are generated from the STM32 datasheet RM0430 in en.DM00305666.pdf for the
STM32F413
'''
...
DMA_Map = {
	...
	# extracted from tabula-rm0430-stm32f413423-advanced-armbased-32bit-mcus-stmicroelectronics-dma.csv
	"ADC1"    	:	[(2,0,0),(2,4,0)],
	"AES_IN"  	:	[(2,6,2)],
	"AES_OUT" 	:	[(2,5,2)],
	"DAC1"    	:	[(1,5,7)],
	...
	"DFSDM2_FLT0"	:	[(2,0,8),(2,4,8)],
	"DFSDM2_FLT1"	:	[(2,1,8),(2,5,8)],
	"DFSDM2_FLT2"	:	[(2,2,8),(2,6,8)],
	"DFSDM2_FLT3"	:	[(2,3,8),(2,7,8)],
	"I2C1_RX" 	:	[(1,0,1),(1,5,1)],
	...
	"TIM8_TRIG"	:	[(2,7,7)],
	"TIM8_UP" 	:	[(2,1,7)],
	"UART10_RX"	:	[(2,0,5),(2,3,9)],
	"UART10_TX"	:	[(2,7,6),(2,5,9)],
	"UART4_RX"	:	[(1,2,4)],
	"UART4_TX"	:	[(1,4,4)],
	"UART5_RX"	:	[(1,0,4)],
	"UART5_TX"	:	[(1,7,8)],
...
AltFunction_map = {
	...
	# extracted from tabula-stm32f413cg-altfunc.csv
	"PA0:EVENTOUT"      	:	15,
	"PA0:TIM2_CH1"      	:	1,
	"PA0:TIM2_ETR"      	:	1,
	"PA0:TIM5_CH1"      	:	2,
...
ADC1_map = {
	...
	# extracted from tabula-stm32f413cg-adc.csv
	"PA0"	:	0,
	"PA1"	:	1,
	"PA2"	:	2,
	"PA3"	:	3,
