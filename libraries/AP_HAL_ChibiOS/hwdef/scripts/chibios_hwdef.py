    ...
    def write_peripheral_enable(self, f):
        ...
        for type in sorted(list(self.bytype.keys()) + list(self.alttype.keys())):
            ...
            if type.startswith('QUADSPI') or type.startswith('OCTOSPI'):
                ...
                # STM32_WSPI_USE_* lives in hwdef_internal.h;
...
''')
    ...
    # headers a definition can be routed to.  "internal" is only visible
    # to the ChibiOS system layer and AP_HAL_ChibiOS; each fragment is
...
''')
    ...
    def write_hwdef_header(self, outfilename):
        ...
        hwdef_internal.h (ChibiOS system layer and AP_HAL_ChibiOS only)
