...
// from https://stackoverflow.com/questions/3781520/how-to-test-if-preprocessor-symbol-is-defined-but-has-no-value/3782064#3782064
#define DO_EXPAND(VAL)  314789211556 ## VAL
#define EXPAND(VAL)     DO_EXPAND(VAL)

#ifdef HAL_PERIPH_ENABLE_GPS
#if !defined(HAL_PERIPH_ENABLE_GPS) || EXPAND(HAL_PERIPH_ENABLE_GPS) == 314789211556
#error HAL_PERIPH_ENABLE_GPS must be set to 0 or 1, not just "defined"
#endif
#endif
...
#define HAL_PERIPH_ENABLE_GPS 0
#endif
...
#define AP_GPS_UBLOX_ENABLED HAL_PERIPH_ENABLE_GPS
#endif
#ifndef HAL_MSP_GPS_ENABLED
#define HAL_MSP_GPS_ENABLED HAL_PERIPH_ENABLE_GPS && HAL_MSP_SENSORS_ENABLED
#endif
...
#define AP_GPS_GSOF_ENABLED HAL_PERIPH_ENABLE_GPS
#endif
...
#define AP_GPS_SBF_ENABLED HAL_PERIPH_ENABLE_GPS
#endif
...
#define AP_GPS_NOVA_ENABLED HAL_PERIPH_ENABLE_GPS
#endif

#ifndef HAL_SIM_GPS_ENABLED
#define HAL_SIM_GPS_ENABLED (AP_SIM_ENABLED && HAL_PERIPH_ENABLE_GPS)
#endif
...
#define AP_GPS_ENABLED HAL_PERIPH_ENABLE_GPS
...
#define AP_UART_MONITOR_ENABLED defined(HAL_PERIPH_ENABLE_SERIAL_OPTIONS) || (HAL_PERIPH_ENABLE_GPS && (GPS_MOVING_BASELINE || BOARD_FLASH_SIZE>=256))
#endif
