...
const AP_Param::GroupInfo AP_Arming::var_info[] = {
    ...
    // @Bitmask{Copter}: 0:Disable prearm display,1:Do not send status text on state change,2:Skip IMU consistency checks when ICE motor running,3:Set origin from AHRS params,4:Set origin at startup
    // @User: Advanced
