...
// little-endian reads; advance the read pointer. An exhausted buffer is a
// caller bug (callers must guard with sbuf_bytes_remaining), so it raises an
// internal error and returns 0
