...
int usb_periphcfg(bool state)
{
    ...
    if (state) {
	RCC_enableAHB1_clk( RCC_AHB1_bit_GPIOA); // USB on GPIO_A
	...
	RCC_enableAPB2_clk(RCC_APB2_bit_SYSCFG);
	RCC_enableAHB2_clk(RCC_AHB2_bit_OTG_FS);
