...
void AP_Mount_SoloGimbal::handle_gopro_heartbeat(mavlink_channel_t chan, const mavlink_message_t &msg)
{
...
void AP_Mount_SoloGimbal::gopro_shutter_toggle(void)
{
...
void AP_Mount_SoloGimbal::gopro_capture_mode_toggle()
{
