...
#define AP_MOUNT_RECV_GIMBAL_CMD_CATEGORIES_NUM     5           // parse the number of gimbal command types
...
private:
    ...
    static int8_t _set_yaw_pitch_angle_cmd[25];        // set gimbal yaw and pitch angle command
    ...
    static int8_t _set_gimbal_time[50];                // set the gimbal time command
