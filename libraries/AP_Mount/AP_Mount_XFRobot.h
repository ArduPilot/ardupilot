...
private:
    ...
    struct PACKED SendPacketMainAndSubFrame {
        ...
        int16_t accel_north;    // byte 18~19: North acceleration of vehicle (int16, cm/s²)
        int16_t accel_east;     // byte 20~21: East acceleration of vehicle (int16, cm/s²)
        int16_t accel_up;       // byte 22~23: Upward acceleration of vehicle (int16, cm/s²)
