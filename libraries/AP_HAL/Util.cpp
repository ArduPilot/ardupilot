...
void AP_HAL::Util::get_system_clock_utc(uint16_t &hour, uint16_t &min, uint16_t &sec, uint16_t &ms) const
{
...
uint32_t AP_HAL::Util::get_ms_until_time_utc(int16_t hour, int16_t min, int16_t sec, int16_t ms) const
{
    ...
    uint16_t curr_hour, curr_min, curr_sec, curr_ms;
