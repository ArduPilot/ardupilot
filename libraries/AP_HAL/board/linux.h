...
#define HAL_BOARD_LOG_DIRECTORY "/var/APM/logs"
#define HAL_BOARD_TERRAIN_DIRECTORY "/var/APM/terrain"
    #if HAL_SENSORHUB_ENABLED && SENSORHUB_MODE == SENSORHUB_SINK
    #define HAL_INS_DEFAULT HAL_INS_SENSORHUB
    #define HAL_INS_DEFAULT_ROTATION ROTATION_NONE
    #define HAL_BARO_DEFAULT HAL_BARO_SENSORHUB
    #define HAL_COMPASS_DEFAULT HAL_COMPASS_SENSORHUB
    #else
    #define HAL_INS_DEFAULT HAL_INS_MPU9250_SPI
    #define HAL_INS_DEFAULT_ROTATION ROTATION_NONE
    #define HAL_INS_MPU9250_NAME "mpu9250"
