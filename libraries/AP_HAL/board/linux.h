...
#define PROBE_MAG_IMU_I2C(driver, imudev, bus, addr, args ...) ADD_BACKEND(DRIVER_ ##driver, AP_Compass_ ## driver::probe_ ## imudev(GET_I2C_DEVICE(bus,addr),##args))
    ...
    #define HAL_LINUX_BOARD_NAME "None"
    ...
    #define HAL_LINUX_BOARD_NAME "PXFire Cape"
    ...
    #define HAL_LINUX_BOARD_NAME "Bebop"
    ...
    * 240x240 crop rescaled to 64x64 */
    ...
    #define HAL_LINUX_BOARD_NAME "VNav"
    ...
    #define HAL_LINUX_BOARD_NAME "Disco"
    #define HAL_BOARD_LOG_DIRECTORY "/data/ftp/internal_000/ardupilot/logs"
    #define HAL_BOARD_TERRAIN_DIRECTORY "/data/ftp/internal_000/ardupilot/terrain"
    #define HAL_BOARD_STORAGE_DIRECTORY "/data/ftp/internal_000/ardupilot"
    ...
    * 240x240 crop rescaled to 64x64 */
    ...
    #define HAL_LINUX_BOARD_NAME "NavIO"
    ...
    #define HAL_LINUX_BOARD_NAME "NavIO2"
    ...
    #define HAL_LINUX_BOARD_NAME "ErleBrain2"
    ...
    #define HAL_LINUX_BOARD_NAME "Zynq"
    #define HAL_INS_DEFAULT HAL_INS_NONE
    #define HAL_BARO_DEFAULT HAL_BARO_NONE
    // only external compasses
    #define HAL_PROBE_EXTERNAL_I2C_COMPASSES
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_LINUX_OCPOC_ZYNQ
    #define HAL_LINUX_BOARD_NAME "OCPOC-Zynq"
    #define HAL_INS_PROBE_LIST PROBE_IMU_SPI(Invensense, "mpu9250", ROTATION_NONE)
    #define HAL_BARO_PROBE_LIST PROBE_BARO_SPI(MS56XX, "ms5611")
    #define HAL_MAG_PROBE_LIST PROBE_MAG_IMU(AK8963, mpu9250, 0, ROTATION_NONE)
    #define HAL_PROBE_EXTERNAL_I2C_COMPASSES
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_LINUX_BBBMINI
    #define HAL_LINUX_BOARD_NAME "BBBMini"
    ...
    #define HAL_LINUX_BOARD_NAME "Navigator"
    ...
    #define HAL_LINUX_BOARD_NAME "BBBlue"
    ...
    #define HAL_LINUX_BOARD_NAME "PocketBeagle"
    ...
    #define HAL_LINUX_BOARD_NAME "BH Hat"
    #define HAL_BARO_PROBE_LIST PROBE_BARO_I2C(MS56XX, 1, 0x77)
    ...
    #define HAL_LINUX_BOARD_NAME "PXFMini"
    #define HAL_INS_PROBE_LIST PROBE_IMU_SPI(Invensense, "mpu9250", ROTATION_YAW_270)
    #define HAL_BARO_PROBE_LIST PROBE_BARO_SPI(MS56XX, "ms5611")
    #define HAL_MAG_PROBE_LIST PROBE_MAG_IMU(AK8963, mpu9250, 0, ROTATION_NONE)
    #define HAL_PROBE_EXTERNAL_I2C_COMPASSES
    ...
    #define HAL_LINUX_BOARD_NAME "Aero"
    ...
    #define HAL_LINUX_BOARD_NAME "Dark"
    #define HAL_INS_PROBE_LIST PROBE_IMU_SPI(Invensense, "mpu9250", ROTATION_NONE)
    #define HAL_MAG_PROBE_LIST PROBE_MAG_IMU(AK8963, mpu9250, 0, ROTATION_NONE)
    #define HAL_BARO_PROBE_LIST PROBE_BARO_I2C(MS56XX, 1, 0x77)
    #define HAL_GPIO_A_LED_PIN        24
    ...
    #define HAL_LINUX_BOARD_NAME "Edge"
    ...
    #define HAL_LINUX_BOARD_NAME "RST Zynq"
    ...
    #define HAL_LINUX_BOARD_NAME "Obal v1"
