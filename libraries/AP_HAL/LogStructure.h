...
// @Field: RxDrp: Data rate of dropped received bytes, ideally should be 0. This is the difference between the received data rate and the processed data rate.
...
#define LOG_STRUCTURE_FROM_HAL                          \
    { LOG_UART_MSG, sizeof(log_UART),                   \
      "UART","QBfff","TimeUS,I,Tx,Rx,RxDrp", "s#BBB", "F----" },
#else
#define LOG_STRUCTURE_FROM_HAL
#endif
