...
const AP_Param::GroupInfo AP_RSSI::var_info[] PROGMEM = {
    ...
    // @Description: This is the voltage value that the radio receiver will put on the RSSI_PIN when the signal strength is the strongest. Since some radio receivers put out inverted values from what you might otherwise expect, this isn't necessarily a higher value than PIN_RANGE_LOW. 
    // @Units: Volt
    // @Increment: 0.01
    // @Range: 0 5.0
    // @User: Standard
