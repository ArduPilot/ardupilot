...
public:
    ...
    int16_t read_receiver_link_quality();
    int8_t read_receiver_rfmode();
    int16_t read_receiver_tx_power();
    int8_t read_receiver_snr();
    int8_t read_receiver_active_antenna();
