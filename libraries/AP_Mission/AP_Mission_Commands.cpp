...
bool AP_Mission::start_command_do_gimbal_manager_pitchyaw(const AP_Mission::Mission_Command& cmd)
{
    ...
    // handle angle target
    const bool pitch_angle_valid = (cmd.content.gimbal_manager_pitchyaw.pitch_angle_deg != INT8_MAX) && (fabsF(cmd.content.gimbal_manager_pitchyaw.pitch_angle_deg) <= 90);
    const bool yaw_angle_valid = (cmd.content.gimbal_manager_pitchyaw.yaw_angle_deg != INT16_MAX) && (fabsF(cmd.content.gimbal_manager_pitchyaw.yaw_angle_deg) <= 360);
    ...
    // handle rate target
    if ((cmd.content.gimbal_manager_pitchyaw.pitch_rate_degs != INT8_MAX) && (cmd.content.gimbal_manager_pitchyaw.yaw_rate_degs != INT8_MAX)) {
