...
const AP_Param::GroupInfo AP_Airspeed_Params::var_info[] = {
    ...
    // @Values: 0:Disable
    // @Values: 1:Do not require offset calibration before flight. Manual calibration must be performed during initial setup
    // @Values: 2:Do not calibrate on start up. Manual calibration must be performed before flight.
    // @User: Advanced
