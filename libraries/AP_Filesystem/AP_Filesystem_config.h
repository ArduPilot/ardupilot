...
// posix backend with a simulated disk size cap (SIM_DISK_MAX)
#ifndef AP_FILESYSTEM_SITL_ENABLED
#define AP_FILESYSTEM_SITL_ENABLED (AP_FILESYSTEM_POSIX_ENABLED && AP_SIM_ENABLED)
