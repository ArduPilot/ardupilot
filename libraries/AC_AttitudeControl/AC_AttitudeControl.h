...
#define AC_ATTITUDE_CONTROL_RATE_RP_MAX_DEFAULT         6000    // maximum rotation rate in roll/pitch axis requested by angle controller used in stabilize, loiter, rtl, auto flight modes
#define AC_ATTITUDE_CONTROL_RATE_Y_MAX_DEFAULT          3000    // maximum rotation rate on yaw axis requested by angle controller used in stabilize, loiter, rtl, auto flight modes
...
#define AC_ATTITUDE_CONTROL_ACCEL_RP_MAX_DEFAULT        180000  // default maximum acceleration for roll/pitch axis in centi-degrees/sec/sec
#define AC_ATTITUDE_CONTROL_ACCEL_Y_MAX_DEFAULT         9000   // default maximum acceleration for yaw axis in centi-degrees/sec/sec
...
public:
    ...
    //BEV allows rate integral reset when transitioning from plane to copter
    void reset_rate_integrators();
