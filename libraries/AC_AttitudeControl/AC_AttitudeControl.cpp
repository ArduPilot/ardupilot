...
{
    // Convert from centidegrees on public interface to radians
    float roll_rate_step_bf_rads = radians(roll_rate_step_bf_cds * 0.01f);
    float pitch_rate_step_bf_rads = radians(pitch_rate_step_bf_cds * 0.01f);
    float yaw_rate_step_bf_rads = radians(yaw_rate_step_bf_cds * 0.01f);
...
void AC_AttitudeControl::input_rate_step_bf_roll_pitch_yaw_rads(float roll_rate_step_bf_rads, float pitch_rate_step_bf_rads, float yaw_rate_step_bf_rads)
{
    ...
    Vector3f ang_vel_body_rads {roll_rate_step_bf_rads, pitch_rate_step_bf_rads, yaw_rate_step_bf_rads};
    // finally update the attitude target
    _ang_vel_body_rads = ang_vel_body_rads;
}
