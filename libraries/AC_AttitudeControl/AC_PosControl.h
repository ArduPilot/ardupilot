...
public:
    ...
    float terrain_scaler_D_m(float pos_terrain_d_m, float pos_terrain_d_buffer_m) const;
...
// todo: remove and add ignore_descent_limit to D_set_pos_target_from_climb_rate_ms.
    ...
    void D_set_alt_target_with_slew_m(float pos_d_m);
...
protected:
    ...
    uint32_t    _last_update_ne_ticks;     // ticks of last last NE_update_controller call
