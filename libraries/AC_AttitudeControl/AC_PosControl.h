...
public:
    ...
    void set_pos_error_max_NE_m(float error_max_m) { _p_pos_ne.set_error_max(error_max_m); }
    ...
    float get_pos_error_max_NE_m() { return _p_pos_ne.get_error_max(); }
    ...
    float get_pos_error_up_m() { return _p_pos_u.get_error_max(); }
    ...
    float get_pos_error_down_m() { return _p_pos_u.get_error_min(); }
    ...
    const Vector3f get_pos_error_NEU_m() const { return Vector3f(_p_pos_ne.get_error().x, _p_pos_ne.get_error().y, _p_pos_u.get_error()); }
    ...
    float get_pos_error_NE_m() const { return _p_pos_ne.get_error().length(); }
    ...
    float get_pos_error_U_m() const { return _p_pos_u.get_error(); }
    ...
    // Used in LUA
    bool set_posvelaccel_offset(const Vector3f &pos_offset_NED_m, const Vector3f &vel_offset_NED_m, const Vector3f &accel_offset_NED_m);

    // Retrieves current scripted offsets in meters (NED frame).
    // Used in LUA
    bool get_posvelaccel_offset(Vector3f &pos_offset_NED_m, Vector3f &vel_offset_NED_m, Vector3f &accel_offset_NED_m);
