...
private:
    ...
    AC_ADRC _adrc_rate_roll { AC_ADRC::Defaults{
		...
		.td_h0_gain = AC_ATC_MULTI_ADRC_RPY_TDGH0,
		...
		.h_gain=AC_ATC_MULTI_ADRC_RPY_H_GAIN,
		...
		.filt_target_hz=AC_ATC_MULTI_ADRC_RPY_FILT_TARGET_HZ,
		.filt_measure_hz=AC_ATC_MULTI_ADRC_RPY_FILT_MEASURE_HZ,
