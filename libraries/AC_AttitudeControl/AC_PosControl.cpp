...
void AC_PosControl::accel_to_lean_angles()
{
    ...
    //BEV hard coded in roll and pitch limits
    _roll_target = constrain_float(fast_atan(accel_right*_ahrs.cos_pitch()/(GRAVITY_MSS * 100))*(18000/M_PI), -1200,1200);
    _pitch_target = constrain_float(fast_atan(-accel_forward/(GRAVITY_MSS * 100))*(18000/M_PI),-2000,1200);
}
