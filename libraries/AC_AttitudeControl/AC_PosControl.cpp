...
void AC_PosControl::input_pos_NED_m(const Vector3p& pos_ned_m, float pos_terrain_target_d_m, float terrain_buffer_m)
{
    ...
    const float offset_d_scalar = terrain_scaler_D_m(pos_terrain_target_d_m, terrain_buffer_m);
...
float AC_PosControl::terrain_scaler_D_m(float pos_terrain_d_m, float pos_terrain_d_buffer_m) const
{
