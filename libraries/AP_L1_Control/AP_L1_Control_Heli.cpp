...
#include "AP_L1_Control_Heli.h"

extern const AP_HAL::HAL& hal;

// table of user settable parameters
const AP_Param::GroupInfo AP_L1_Control_Heli::var_info[] = {
    // @Param: PERIOD
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("PERIOD",    0, AP_L1_Control_Heli, _L1_period, 20),
    ...
    // @Increment: 0.05
    // @User: Advanced
    AP_GROUPINFO("DAMPING",   1, AP_L1_Control_Heli, _L1_damping, 0.75f),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("XTRACK_I",   2, AP_L1_Control_Heli, _L1_xtrack_i_gain, 0.02),

    // @Param: TURN_SF
    // @DisplayName: Turn Rate Scale Factor
    // @Description: Turn Rate Scale Factor allow user to scale the yaw input calculated from the bank angle
    // @Range: 0.2 2.0
    // @Increment: 0.1
    // @User: Advanced
 ...
 */
float AP_L1_Control_Heli::get_yaw()
{
    if (_reverse) {
 ...
 */
float AP_L1_Control_Heli::get_yaw_sensor()
{
    if (_reverse) {
...
/*
  ...
  update_*() operation
 */
int32_t AP_L1_Control_Heli::nav_roll_cd(void) const
{
    float ret;
...
/*
  ...
  update_*() operation
 */
int32_t AP_L1_Control_Heli::turn_rate_cds(void) const
{
    float ret;
...
/*
  ...
  update_*() operation
 */
float AP_L1_Control_Heli::lateral_acceleration(void) const
{
    return _latAccDem;
}

int32_t AP_L1_Control_Heli::nav_bearing_cd(void) const
{
    return wrap_180_cd(RadiansToCentiDegrees(_nav_bearing));
}

int32_t AP_L1_Control_Heli::bearing_error_cd(void) const
{
    return RadiansToCentiDegrees(_bearing_error);
}

int32_t AP_L1_Control_Heli::target_bearing_cd(void) const
{
 ...
 */
float AP_L1_Control_Heli::turn_distance(float wp_radius) const
{
 ...
 */
float AP_L1_Control_Heli::turn_distance(float wp_radius, float turn_angle) const
{
...
float AP_L1_Control_Heli::loiter_radius(const float radius) const
{
...
bool AP_L1_Control_Heli::reached_loiter_target(void)
{
    return _WPcircle;
}
 ...
 */
void AP_L1_Control_Heli::_prevent_indecision(float &Nu)
{
...
void AP_L1_Control_Heli::update_waypoint(const struct Location &prev_WP, const struct Location &next_WP, float dist_min)
{
...
void AP_L1_Control_Heli::update_loiter(const struct Location &center_WP, float radius, int8_t loiter_direction)
{
    struct Location _current_loc;
...
void AP_L1_Control_Heli::update_heading_hold(int32_t navigation_heading_cd)
{
...
void AP_L1_Control_Heli::update_level_flight(void)
{
    // copy to _target_bearing_cd and _nav_bearing
