...
void NavEKF3_core::CovarianceInit()
{
    ...
    // velocities
    Pdiag(velocity.x)   = sq(frontend->_gpsHorizVelNoise);
    Pdiag(velocity.y)   = Pdiag(velocity.x);
    Pdiag(velocity.z)   = sq(frontend->_gpsVertVelNoise);
    // positions
    Pdiag(position.x)   = sq(frontend->_gpsHorizPosNoise);
    Pdiag(position.y)   = Pdiag(position.x);
    Pdiag(position.z)   = sq(frontend->_baroAltNoise);
    ...
    Pdiag(earth_magfield.x) = 0.0f;
    Pdiag(earth_magfield.y) = Pdiag(earth_magfield.x);
    Pdiag(earth_magfield.z) = Pdiag(earth_magfield.x);
    // body magnetic field
    Pdiag(body_magfield.x) = 0.0f;
    Pdiag(body_magfield.y) = Pdiag(body_magfield.x);
    Pdiag(body_magfield.z) = Pdiag(body_magfield.x);
    // wind velocities
    Pdiag(wind_vel.x) = 0.0f;
    Pdiag(wind_vel.y)  = Pdiag(wind_vel.x);
...
void NavEKF3_core::CovariancePrediction()
{
    ...
    nextPdiag(velocity.x) = Pdiag(velocity.x) + P[0][4]*SF[5] + P[1][4]*SF[3] - P[3][4]*SF[4] + P[2][4]*SPP[0] + P[13][4]*SPP[3] + P[14][4]*SPP[6] - P[15][4]*SPP[9] + dvyVar*sq(SG[7] - 2*q0*q3) + dvzVar*sq(SG[6] + 2*q0*q2) + SF[5]*(P[4][0] + P[0][0]*SF[5] + P[1][0]*SF[3] - P[3][0]*SF[4] + P[2][0]*SPP[0] + P[13][0]*SPP[3] + P[14][0]*SPP[6] - P[15][0]*SPP[9]) + SF[3]*(P[4][1] + P[0][1]*SF[5] + P[1][1]*SF[3] - P[3][1]*SF[4] + P[2][1]*SPP[0] + P[13][1]*SPP[3] + P[14][1]*SPP[6] - P[15][1]*SPP[9]) - SF[4]*(P[4][3] + P[0][3]*SF[5] + P[1][3]*SF[3] - P[3][3]*SF[4] + P[2][3]*SPP[0] + P[13][3]*SPP[3] + P[14][3]*SPP[6] - P[15][3]*SPP[9]) + SPP[0]*(P[4][2] + P[0][2]*SF[5] + P[1][2]*SF[3] - P[3][2]*SF[4] + P[2][2]*SPP[0] + P[13][2]*SPP[3] + P[14][2]*SPP[6] - P[15][2]*SPP[9]) + SPP[3]*(P[4][13] + P[0][13]*SF[5] + P[1][13]*SF[3] - P[3][13]*SF[4] + P[2][13]*SPP[0] + Pdiag(accel_bias.x)*SPP[3] + P[14][13]*SPP[6] - P[15][13]*SPP[9]) + SPP[6]*(P[4][14] + P[0][14]*SF[5] + P[1][14]*SF[3] - P[3][14]*SF[4] + P[2][14]*SPP[0] + P[13][14]*SPP[3] + Pdiag(accel_bias.y)*SPP[6] - P[15][14]*SPP[9]) - SPP[9]*(P[4][15] + P[0][15]*SF[5] + P[1][15]*SF[3] - P[3][15]*SF[4] + P[2][15]*SPP[0] + P[13][15]*SPP[3] + P[14][15]*SPP[6] - Pdiag(accel_bias.z)*SPP[9]) + dvxVar*sq(SG[1] + SG[2] - SG[3] - SG[4]);
    ...
    nextP[4][5] = P[4][5] + SQ[2] + P[0][5]*SF[5] + P[1][5]*SF[3] - P[3][5]*SF[4] + P[2][5]*SPP[0] + P[13][5]*SPP[3] + P[14][5]*SPP[6] - P[15][5]*SPP[9] + SF[4]*(P[4][0] + P[0][0]*SF[5] + P[1][0]*SF[3] - P[3][0]*SF[4] + P[2][0]*SPP[0] + P[13][0]*SPP[3] + P[14][0]*SPP[6] - P[15][0]*SPP[9]) + SF[3]*(P[4][2] + P[0][2]*SF[5] + P[1][2]*SF[3] - P[3][2]*SF[4] + P[2][2]*SPP[0] + P[13][2]*SPP[3] + P[14][2]*SPP[6] - P[15][2]*SPP[9]) + SF[5]*(P[4][3] + P[0][3]*SF[5] + P[1][3]*SF[3] - P[3][3]*SF[4] + P[2][3]*SPP[0] + P[13][3]*SPP[3] + P[14][3]*SPP[6] - P[15][3]*SPP[9]) - SPP[0]*(P[4][1] + P[0][1]*SF[5] + P[1][1]*SF[3] - P[3][1]*SF[4] + P[2][1]*SPP[0] + P[13][1]*SPP[3] + P[14][1]*SPP[6] - P[15][1]*SPP[9]) - SPP[8]*(P[4][13] + P[0][13]*SF[5] + P[1][13]*SF[3] - P[3][13]*SF[4] + P[2][13]*SPP[0] + Pdiag(accel_bias.x)*SPP[3] + P[14][13]*SPP[6] - P[15][13]*SPP[9]) + SPP[2]*(P[4][14] + P[0][14]*SF[5] + P[1][14]*SF[3] - P[3][14]*SF[4] + P[2][14]*SPP[0] + P[13][14]*SPP[3] + Pdiag(accel_bias.y)*SPP[6] - P[15][14]*SPP[9]) + SPP[5]*(P[4][15] + P[0][15]*SF[5] + P[1][15]*SF[3] - P[3][15]*SF[4] + P[2][15]*SPP[0] + P[13][15]*SPP[3] + P[14][15]*SPP[6] - Pdiag(accel_bias.z)*SPP[9]);
    nextPdiag(velocity.y) = Pdiag(velocity.y) + P[0][5]*SF[4] + P[2][5]*SF[3] + P[3][5]*SF[5] - P[1][5]*SPP[0] - P[13][5]*SPP[8] + P[14][5]*SPP[2] + P[15][5]*SPP[5] + dvxVar*sq(SG[7] + 2*q0*q3) + dvzVar*sq(SG[5] - 2*q0*q1) + SF[4]*(P[5][0] + P[0][0]*SF[4] + P[2][0]*SF[3] + P[3][0]*SF[5] - P[1][0]*SPP[0] - P[13][0]*SPP[8] + P[14][0]*SPP[2] + P[15][0]*SPP[5]) + SF[3]*(P[5][2] + P[0][2]*SF[4] + P[2][2]*SF[3] + P[3][2]*SF[5] - P[1][2]*SPP[0] - P[13][2]*SPP[8] + P[14][2]*SPP[2] + P[15][2]*SPP[5]) + SF[5]*(P[5][3] + P[0][3]*SF[4] + P[2][3]*SF[3] + P[3][3]*SF[5] - P[1][3]*SPP[0] - P[13][3]*SPP[8] + P[14][3]*SPP[2] + P[15][3]*SPP[5]) - SPP[0]*(P[5][1] + P[0][1]*SF[4] + P[2][1]*SF[3] + P[3][1]*SF[5] - P[1][1]*SPP[0] - P[13][1]*SPP[8] + P[14][1]*SPP[2] + P[15][1]*SPP[5]) - SPP[8]*(P[5][13] + P[0][13]*SF[4] + P[2][13]*SF[3] + P[3][13]*SF[5] - P[1][13]*SPP[0] - Pdiag(accel_bias.x)*SPP[8] + P[14][13]*SPP[2] + P[15][13]*SPP[5]) + SPP[2]*(P[5][14] + P[0][14]*SF[4] + P[2][14]*SF[3] + P[3][14]*SF[5] - P[1][14]*SPP[0] - P[13][14]*SPP[8] + Pdiag(accel_bias.y)*SPP[2] + P[15][14]*SPP[5]) + SPP[5]*(P[5][15] + P[0][15]*SF[4] + P[2][15]*SF[3] + P[3][15]*SF[5] - P[1][15]*SPP[0] - P[13][15]*SPP[8] + P[14][15]*SPP[2] + Pdiag(accel_bias.z)*SPP[5]) + dvyVar*sq(SG[1] - SG[2] + SG[3] - SG[4]);
    ...
    nextP[4][6] = P[4][6] + SQ[1] + P[0][6]*SF[5] + P[1][6]*SF[3] - P[3][6]*SF[4] + P[2][6]*SPP[0] + P[13][6]*SPP[3] + P[14][6]*SPP[6] - P[15][6]*SPP[9] + SF[4]*(P[4][1] + P[0][1]*SF[5] + P[1][1]*SF[3] - P[3][1]*SF[4] + P[2][1]*SPP[0] + P[13][1]*SPP[3] + P[14][1]*SPP[6] - P[15][1]*SPP[9]) - SF[5]*(P[4][2] + P[0][2]*SF[5] + P[1][2]*SF[3] - P[3][2]*SF[4] + P[2][2]*SPP[0] + P[13][2]*SPP[3] + P[14][2]*SPP[6] - P[15][2]*SPP[9]) + SF[3]*(P[4][3] + P[0][3]*SF[5] + P[1][3]*SF[3] - P[3][3]*SF[4] + P[2][3]*SPP[0] + P[13][3]*SPP[3] + P[14][3]*SPP[6] - P[15][3]*SPP[9]) + SPP[0]*(P[4][0] + P[0][0]*SF[5] + P[1][0]*SF[3] - P[3][0]*SF[4] + P[2][0]*SPP[0] + P[13][0]*SPP[3] + P[14][0]*SPP[6] - P[15][0]*SPP[9]) + SPP[4]*(P[4][13] + P[0][13]*SF[5] + P[1][13]*SF[3] - P[3][13]*SF[4] + P[2][13]*SPP[0] + Pdiag(accel_bias.x)*SPP[3] + P[14][13]*SPP[6] - P[15][13]*SPP[9]) - SPP[7]*(P[4][14] + P[0][14]*SF[5] + P[1][14]*SF[3] - P[3][14]*SF[4] + P[2][14]*SPP[0] + P[13][14]*SPP[3] + Pdiag(accel_bias.y)*SPP[6] - P[15][14]*SPP[9]) - SPP[1]*(P[4][15] + P[0][15]*SF[5] + P[1][15]*SF[3] - P[3][15]*SF[4] + P[2][15]*SPP[0] + P[13][15]*SPP[3] + P[14][15]*SPP[6] - Pdiag(accel_bias.z)*SPP[9]);
    nextP[5][6] = P[5][6] + SQ[0] + P[0][6]*SF[4] + P[2][6]*SF[3] + P[3][6]*SF[5] - P[1][6]*SPP[0] - P[13][6]*SPP[8] + P[14][6]*SPP[2] + P[15][6]*SPP[5] + SF[4]*(P[5][1] + P[0][1]*SF[4] + P[2][1]*SF[3] + P[3][1]*SF[5] - P[1][1]*SPP[0] - P[13][1]*SPP[8] + P[14][1]*SPP[2] + P[15][1]*SPP[5]) - SF[5]*(P[5][2] + P[0][2]*SF[4] + P[2][2]*SF[3] + P[3][2]*SF[5] - P[1][2]*SPP[0] - P[13][2]*SPP[8] + P[14][2]*SPP[2] + P[15][2]*SPP[5]) + SF[3]*(P[5][3] + P[0][3]*SF[4] + P[2][3]*SF[3] + P[3][3]*SF[5] - P[1][3]*SPP[0] - P[13][3]*SPP[8] + P[14][3]*SPP[2] + P[15][3]*SPP[5]) + SPP[0]*(P[5][0] + P[0][0]*SF[4] + P[2][0]*SF[3] + P[3][0]*SF[5] - P[1][0]*SPP[0] - P[13][0]*SPP[8] + P[14][0]*SPP[2] + P[15][0]*SPP[5]) + SPP[4]*(P[5][13] + P[0][13]*SF[4] + P[2][13]*SF[3] + P[3][13]*SF[5] - P[1][13]*SPP[0] - Pdiag(accel_bias.x)*SPP[8] + P[14][13]*SPP[2] + P[15][13]*SPP[5]) - SPP[7]*(P[5][14] + P[0][14]*SF[4] + P[2][14]*SF[3] + P[3][14]*SF[5] - P[1][14]*SPP[0] - P[13][14]*SPP[8] + Pdiag(accel_bias.y)*SPP[2] + P[15][14]*SPP[5]) - SPP[1]*(P[5][15] + P[0][15]*SF[4] + P[2][15]*SF[3] + P[3][15]*SF[5] - P[1][15]*SPP[0] - P[13][15]*SPP[8] + P[14][15]*SPP[2] + Pdiag(accel_bias.z)*SPP[5]);
    nextPdiag(velocity.z) = Pdiag(velocity.z) + P[1][6]*SF[4] - P[2][6]*SF[5] + P[3][6]*SF[3] + P[0][6]*SPP[0] + P[13][6]*SPP[4] - P[14][6]*SPP[7] - P[15][6]*SPP[1] + dvxVar*sq(SG[6] - 2*q0*q2) + dvyVar*sq(SG[5] + 2*q0*q1) + SF[4]*(P[6][1] + P[1][1]*SF[4] - P[2][1]*SF[5] + P[3][1]*SF[3] + P[0][1]*SPP[0] + P[13][1]*SPP[4] - P[14][1]*SPP[7] - P[15][1]*SPP[1]) - SF[5]*(P[6][2] + P[1][2]*SF[4] - P[2][2]*SF[5] + P[3][2]*SF[3] + P[0][2]*SPP[0] + P[13][2]*SPP[4] - P[14][2]*SPP[7] - P[15][2]*SPP[1]) + SF[3]*(P[6][3] + P[1][3]*SF[4] - P[2][3]*SF[5] + P[3][3]*SF[3] + P[0][3]*SPP[0] + P[13][3]*SPP[4] - P[14][3]*SPP[7] - P[15][3]*SPP[1]) + SPP[0]*(P[6][0] + P[1][0]*SF[4] - P[2][0]*SF[5] + P[3][0]*SF[3] + P[0][0]*SPP[0] + P[13][0]*SPP[4] - P[14][0]*SPP[7] - P[15][0]*SPP[1]) + SPP[4]*(P[6][13] + P[1][13]*SF[4] - P[2][13]*SF[5] + P[3][13]*SF[3] + P[0][13]*SPP[0] + Pdiag(accel_bias.x)*SPP[4] - P[14][13]*SPP[7] - P[15][13]*SPP[1]) - SPP[7]*(P[6][14] + P[1][14]*SF[4] - P[2][14]*SF[5] + P[3][14]*SF[3] + P[0][14]*SPP[0] + P[13][14]*SPP[4] - Pdiag(accel_bias.y)*SPP[7] - P[15][14]*SPP[1]) - SPP[1]*(P[6][15] + P[1][15]*SF[4] - P[2][15]*SF[5] + P[3][15]*SF[3] + P[0][15]*SPP[0] + P[13][15]*SPP[4] - P[14][15]*SPP[7] - Pdiag(accel_bias.z)*SPP[1]) + dvzVar*sq(SG[1] - SG[2] - SG[3] + SG[4]);
    ...
    nextP[4][7] = P[4][7] + P[0][7]*SF[5] + P[1][7]*SF[3] - P[3][7]*SF[4] + P[2][7]*SPP[0] + P[13][7]*SPP[3] + P[14][7]*SPP[6] - P[15][7]*SPP[9] + dt*(Pdiag(velocity.x) + P[0][4]*SF[5] + P[1][4]*SF[3] - P[3][4]*SF[4] + P[2][4]*SPP[0] + P[13][4]*SPP[3] + P[14][4]*SPP[6] - P[15][4]*SPP[9]);
    ...
    nextPdiag(position.x) = Pdiag(position.x) + P[4][7]*dt + dt*(P[7][4] + Pdiag(velocity.x)*dt);
    ...
    nextP[5][8] = P[5][8] + P[0][8]*SF[4] + P[2][8]*SF[3] + P[3][8]*SF[5] - P[1][8]*SPP[0] - P[13][8]*SPP[8] + P[14][8]*SPP[2] + P[15][8]*SPP[5] + dt*(Pdiag(velocity.y) + P[0][5]*SF[4] + P[2][5]*SF[3] + P[3][5]*SF[5] - P[1][5]*SPP[0] - P[13][5]*SPP[8] + P[14][5]*SPP[2] + P[15][5]*SPP[5]);
    ...
    nextPdiag(position.y) = Pdiag(position.y) + P[5][8]*dt + dt*(P[8][5] + Pdiag(velocity.y)*dt);
    ...
    nextP[6][9] = P[6][9] + P[1][9]*SF[4] - P[2][9]*SF[5] + P[3][9]*SF[3] + P[0][9]*SPP[0] + P[13][9]*SPP[4] - P[14][9]*SPP[7] - P[15][9]*SPP[1] + dt*(Pdiag(velocity.z) + P[1][6]*SF[4] - P[2][6]*SF[5] + P[3][6]*SF[3] + P[0][6]*SPP[0] + P[13][6]*SPP[4] - P[14][6]*SPP[7] - P[15][6]*SPP[1]);
    nextP[7][9] = P[7][9] + P[4][9]*dt + dt*(P[7][6] + P[4][6]*dt);
    nextP[8][9] = P[8][9] + P[5][9]*dt + dt*(P[8][6] + P[5][6]*dt);
    nextPdiag(position.z) = Pdiag(position.z) + P[6][9]*dt + dt*(P[9][6] + Pdiag(velocity.z)*dt);

    if (stateIndexLim > 9) {
        nextP[0][10] = P[0][10] + P[1][10]*SF[9] + P[2][10]*SF[11] + P[3][10]*SF[10] + Pdiag(gyro_bias.x)*SF[14] + P[11][10]*SF[15] + P[12][10]*SPP[10];
        nextP[1][10] = P[1][10] + P[0][10]*SF[8] + P[2][10]*SF[7] + P[3][10]*SF[11] - P[12][10]*SF[15] + P[11][10]*SPP[10] - (Pdiag(gyro_bias.x)*q0)/2;
        nextP[2][10] = P[2][10] + P[0][10]*SF[6] + P[1][10]*SF[10] + P[3][10]*SF[8] + P[12][10]*SF[14] - Pdiag(gyro_bias.x)*SPP[10] - (P[11][10]*q0)/2;
        nextP[3][10] = P[3][10] + P[0][10]*SF[7] + P[1][10]*SF[6] + P[2][10]*SF[9] + Pdiag(gyro_bias.x)*SF[15] - P[11][10]*SF[14] - (P[12][10]*q0)/2;
        ...
        nextPdiag(gyro_bias.x) = Pdiag(gyro_bias.x);
        nextP[0][11] = P[0][11] + P[1][11]*SF[9] + P[2][11]*SF[11] + P[3][11]*SF[10] + P[10][11]*SF[14] + Pdiag(gyro_bias.y)*SF[15] + P[12][11]*SPP[10];
        nextP[1][11] = P[1][11] + P[0][11]*SF[8] + P[2][11]*SF[7] + P[3][11]*SF[11] - P[12][11]*SF[15] + Pdiag(gyro_bias.y)*SPP[10] - (P[10][11]*q0)/2;
        nextP[2][11] = P[2][11] + P[0][11]*SF[6] + P[1][11]*SF[10] + P[3][11]*SF[8] + P[12][11]*SF[14] - P[10][11]*SPP[10] - (Pdiag(gyro_bias.y)*q0)/2;
        nextP[3][11] = P[3][11] + P[0][11]*SF[7] + P[1][11]*SF[6] + P[2][11]*SF[9] + P[10][11]*SF[15] - Pdiag(gyro_bias.y)*SF[14] - (P[12][11]*q0)/2;
        ...
        nextP[10][11] = P[10][11];
        nextPdiag(gyro_bias.y) = Pdiag(gyro_bias.y);
        nextP[0][12] = P[0][12] + P[1][12]*SF[9] + P[2][12]*SF[11] + P[3][12]*SF[10] + P[10][12]*SF[14] + P[11][12]*SF[15] + Pdiag(gyro_bias.z)*SPP[10];
        nextP[1][12] = P[1][12] + P[0][12]*SF[8] + P[2][12]*SF[7] + P[3][12]*SF[11] - Pdiag(gyro_bias.z)*SF[15] + P[11][12]*SPP[10] - (P[10][12]*q0)/2;
        nextP[2][12] = P[2][12] + P[0][12]*SF[6] + P[1][12]*SF[10] + P[3][12]*SF[8] + Pdiag(gyro_bias.z)*SF[14] - P[10][12]*SPP[10] - (P[11][12]*q0)/2;
        nextP[3][12] = P[3][12] + P[0][12]*SF[7] + P[1][12]*SF[6] + P[2][12]*SF[9] + P[10][12]*SF[15] - P[11][12]*SF[14] - (Pdiag(gyro_bias.z)*q0)/2;
        ...
        nextP[10][12] = P[10][12];
        nextP[11][12] = P[11][12];
        nextPdiag(gyro_bias.z) = Pdiag(gyro_bias.z);
        ...
        if (stateIndexLim > 12) {
            ...
            nextP[4][13] = P[4][13] + P[0][13]*SF[5] + P[1][13]*SF[3] - P[3][13]*SF[4] + P[2][13]*SPP[0] + Pdiag(accel_bias.x)*SPP[3] + P[14][13]*SPP[6] - P[15][13]*SPP[9];
            nextP[5][13] = P[5][13] + P[0][13]*SF[4] + P[2][13]*SF[3] + P[3][13]*SF[5] - P[1][13]*SPP[0] - Pdiag(accel_bias.x)*SPP[8] + P[14][13]*SPP[2] + P[15][13]*SPP[5];
            nextP[6][13] = P[6][13] + P[1][13]*SF[4] - P[2][13]*SF[5] + P[3][13]*SF[3] + P[0][13]*SPP[0] + Pdiag(accel_bias.x)*SPP[4] - P[14][13]*SPP[7] - P[15][13]*SPP[1];
            ...
            nextP[11][13] = P[11][13];
            nextP[12][13] = P[12][13];
            nextPdiag(accel_bias.x) = Pdiag(accel_bias.x);
            ...
            nextP[4][14] = P[4][14] + P[0][14]*SF[5] + P[1][14]*SF[3] - P[3][14]*SF[4] + P[2][14]*SPP[0] + P[13][14]*SPP[3] + Pdiag(accel_bias.y)*SPP[6] - P[15][14]*SPP[9];
            nextP[5][14] = P[5][14] + P[0][14]*SF[4] + P[2][14]*SF[3] + P[3][14]*SF[5] - P[1][14]*SPP[0] - P[13][14]*SPP[8] + Pdiag(accel_bias.y)*SPP[2] + P[15][14]*SPP[5];
            nextP[6][14] = P[6][14] + P[1][14]*SF[4] - P[2][14]*SF[5] + P[3][14]*SF[3] + P[0][14]*SPP[0] + P[13][14]*SPP[4] - Pdiag(accel_bias.y)*SPP[7] - P[15][14]*SPP[1];
            ...
            nextP[12][14] = P[12][14];
            nextP[13][14] = P[13][14];
            nextPdiag(accel_bias.y) = Pdiag(accel_bias.y);
            ...
            nextP[4][15] = P[4][15] + P[0][15]*SF[5] + P[1][15]*SF[3] - P[3][15]*SF[4] + P[2][15]*SPP[0] + P[13][15]*SPP[3] + P[14][15]*SPP[6] - Pdiag(accel_bias.z)*SPP[9];
            nextP[5][15] = P[5][15] + P[0][15]*SF[4] + P[2][15]*SF[3] + P[3][15]*SF[5] - P[1][15]*SPP[0] - P[13][15]*SPP[8] + P[14][15]*SPP[2] + Pdiag(accel_bias.z)*SPP[5];
            nextP[6][15] = P[6][15] + P[1][15]*SF[4] - P[2][15]*SF[5] + P[3][15]*SF[3] + P[0][15]*SPP[0] + P[13][15]*SPP[4] - P[14][15]*SPP[7] - Pdiag(accel_bias.z)*SPP[1];
            ...
            nextP[13][15] = P[13][15];
            nextP[14][15] = P[14][15];
            nextPdiag(accel_bias.z) = Pdiag(accel_bias.z);
            ...
            if (stateIndexLim > 15) {
                ...
                nextP[14][16] = P[14][16];
                nextP[15][16] = P[15][16];
                nextPdiag(earth_magfield.x) = Pdiag(earth_magfield.x);
                ...
                nextP[15][17] = P[15][17];
                nextP[16][17] = P[16][17];
                nextPdiag(earth_magfield.y) = Pdiag(earth_magfield.y);
                ...
                nextP[16][18] = P[16][18];
                nextP[17][18] = P[17][18];
                nextPdiag(earth_magfield.z) = Pdiag(earth_magfield.z);
                ...
                nextP[17][19] = P[17][19];
                nextP[18][19] = P[18][19];
                nextPdiag(body_magfield.x) = Pdiag(body_magfield.x);
                ...
                nextP[18][20] = P[18][20];
                nextP[19][20] = P[19][20];
                nextPdiag(body_magfield.y) = Pdiag(body_magfield.y);
                ...
                nextP[19][21] = P[19][21];
                nextP[20][21] = P[20][21];
                nextPdiag(body_magfield.z) = Pdiag(body_magfield.z);
                ...
                if (stateIndexLim > 21) {
                    ...
                    nextP[20][22] = P[20][22];
                    nextP[21][22] = P[21][22];
                    nextPdiag(wind_vel.x) = Pdiag(wind_vel.x);
                    ...
                    nextP[21][23] = P[21][23];
                    nextP[22][23] = P[22][23];
                    nextPdiag(wind_vel.y) = Pdiag(wind_vel.y);
                }
            }
        }
    }
    ...
    // without GPS
    if ((Pdiag(position.x) + Pdiag(position.y)) > 1e4f) {
...
void NavEKF3_core::ConstrainVariances()
{
    ...
    Pdiag(position.z) = constrain_float(Pdiag(position.z),0.0f,1.0e6f); // vertical position
...
void NavEKF3_core::resetMagFieldStates()
{
    ...
    zeroRows(P,18,21);
    zeroCols(P,18,21);
    Pdiag(earth_magfield.z) = sq(frontend->_magNoise);
    Pdiag(body_magfield.x) = Pdiag(earth_magfield.z);
    Pdiag(body_magfield.y) = Pdiag(earth_magfield.z);
    Pdiag(body_magfield.z) = Pdiag(earth_magfield.z);
