...
const AP_Param::GroupInfo NavEKF3::var_info[] = {
    ...
    // @User: Advanced
    // @Units: m/s
    AP_GROUPINFO("EAS_DEFAULT", 57, NavEKF3, _easDefault, 15.0f),
    ...
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO("GSF_DELAY", 60, NavEKF3, _gsfResetDelay, 1000),
    ...
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO("GSF_MAXCOUNT", 61, NavEKF3, _gsfResetMaxCount, 2),
