...
// Use of position set as a measurement
#ifndef EK3_FEATURE_EXTERNAL_POSITION_FUSION
#define EK3_FEATURE_EXTERNAL_POSITION_FUSION EK3_FEATURE_POSITION_RESET && HAL_PROGRAM_SIZE_LIMIT_KB > 2048
#endif // EK3_FEATURE_EXTERNAL_POSITION_FUSION

#if (EK3_FEATURE_EXTERNAL_POSITION_FUSION) && !(EK3_FEATURE_POSITION_RESET)
#error "EK3_FEATURE_EXTERNAL_POSITION_FUSION requires EK3_FEATURE_POSITION_RESET"
#endif // EK3_FEATURE_EXTERNAL_POSITION_FUSION && !EK3_FEATURE_POSITION_RESET
