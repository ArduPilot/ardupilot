...
#define EK3_FEATURE_ALL ArduPilot_BUILD_TYPE(ArduPilot_BUILD_AP_DAL_Standalone) || ArduPilot_BUILD_TYPE(ArduPilot_BUILD_Replay)

// body odomotry (which includes wheel encoding) on rover or 2M boards
#ifndef EK3_FEATURE_BODY_ODOM
#define EK3_FEATURE_BODY_ODOM EK3_FEATURE_ALL || ArduPilot_BUILD_TYPE(ArduPilot_BUILD_Rover) || BOARD_FLASH_SIZE > 1024
#endif
