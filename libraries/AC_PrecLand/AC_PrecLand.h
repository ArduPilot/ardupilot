...
public:
    ...
    */
    ...
    void set_active(bool active) { _plnd_active = active; }
    bool active() { return _plnd_active; }
...
private:
    ...
    bool                       _plnd_active;            // user can use aux function to turn Copter PrecLand on/off
