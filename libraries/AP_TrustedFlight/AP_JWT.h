...
public:
    ...
    static constexpr uint16_t ed25519_signature_length = 64;
    static constexpr uint32_t ed25519_public_key_length = 32;
...
private:
    ...
    static bool claim_equals(const char *value, const void *expected, size_t expected_length);
