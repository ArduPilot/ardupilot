...
(function ()
    ...
    function pitching.stop()
        ...
        if pre_pitch_target_altitude ~= nil then
            ...
            airspeed_desired = airspeed_cruise
            -- gcs:send_text(MAV_SEVERITY.ERROR, "pitching.stop new airspeed:" .. airspeed_desired)
...
(function ()
    ...
    function quading.quad_obstacle_down()
        -- gcs:send_text(MAV_SEVERITY.INFO, SCRIPT_NAME_SHORT .. ": Quading " .. rangefinder_down_value .. " above: " .. altitude_max)
