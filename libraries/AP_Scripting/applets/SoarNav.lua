...
local MSG = {
    ...
    [MSG_ID.AREA_INFO_RADIUS] = "SNav:Radius A=%.2fkm2;RD=%.0fm",
    [MSG_ID.SCRIPT_INITIALIZED] = "Script V1.0.0 initialized.",
    ...
    [MSG_ID.RTL_OVERRIDE_RESUME] = "RTL Override: In home area. Resuming RTL.",
...
local SoarNavGlobals = {
    ...
    ---------------------------------------------------------------------------
    rc_roll_channel = rc:get_channel(P.rcmap_roll:get() or 1),
            ...
            if chosen_cell_index and SoarNavGlobals.grid_cell_centers[chosen_cell_index] then
                ...
                if success then
                    ...
                    if in_flight_area(precalculated_center) and current_loc and current_loc:get_distance(precalculated_center) > (pget(P.wp_radius, 50)) then
                        SoarNavGlobals.target_loc = precalculated_center
                        new_wp_found = true
                    end
                end
            end
...
handle_navigating = function(current_time_ms, loc, can_navigate, is_in_thermal_mode, cached_params, autotune_active, dt_s)
    ...
    elseif wp_status == "REROUTE" then
        ...
        SoarNavGlobals.target_loc = new_target
        SoarNavGlobals.g_waypoint_source_info = "Re-route"
        _finalize_waypoint_selection()
        return
    end
