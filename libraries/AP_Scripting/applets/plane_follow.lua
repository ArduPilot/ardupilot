...
--[[
    ...
    // @Description: Setting an RC channels _OPTION to this value will use it for Plane Follow enable/disable
    // @Range: 300 307
--]]
...
-- start running update loop - waiting 30s for the AP to initialize
