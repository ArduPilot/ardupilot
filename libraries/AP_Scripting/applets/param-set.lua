...
local function update()
    ...
    while true do
        ...
        local param_value, target_system, target_component, param_id, param_type, _ = string.unpack("<fBBc16B", string.sub(msg, 13, 36))
        param_id = string.gsub(param_id, string.char(0), "")

        handle_param_set(target_system, target_component, param_id, param_value)
    end
end
