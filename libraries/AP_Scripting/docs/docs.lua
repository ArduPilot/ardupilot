...
function get_rally_point_with_index(index, rally_location) end

-- Returns a specic rally by index as a Location
---@param index integer
---@param rally_location Location_ud
---@return number -- count of rally points
