...
local RCMAP_THROTTLE_  = bind_param("RCMAP_THROTTLE")
local THROT_CHANNEL_ = rc:get_channel(RCMAP_THROTTLE_:get())
local REV_THRUST_AUX_SW_ = rc:find_channel_for_option(64)
