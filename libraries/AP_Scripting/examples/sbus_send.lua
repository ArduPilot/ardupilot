--[[
Reads RCIN channels (CH1–16), converts PWM values to SBUS format
(16 channels, 11-bit), and sends SBUS frames via a serial port.

SBUS FAILSAFE flag is set when RC input is invalid.
]]
