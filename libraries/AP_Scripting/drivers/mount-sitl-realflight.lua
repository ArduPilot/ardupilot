...
--[[
  ...
  // @User: Advanced
--]]
local RFG_DEBUG = Parameter("RFG_DEBUG")
...
--[[
  ...
  // @User: Standard
--]]
local RFG_FOV_MIN = Parameter("RFG_FOV_MIN")
...
--[[
  ...
  // @User: Standard
--]]
local RFG_FOV_MAX = Parameter("RFG_FOV_MAX")
...
--[[
  ...
  // @User: Standard
--]]
local RFG_ASPECT = Parameter("RFG_ASPECT")
...
--[[
  ...
  // @User: Standard
--]]
local RFG_ZOOM_SPEED = Parameter("RFG_ZOOM_SPEED")
...
--[[
  ...
  // @User: Standard
--]]
local RFG_ZOOM_SERVO = Parameter("RFG_ZOOM_SERVO")
