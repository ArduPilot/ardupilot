...
CLCoreUrusTimers_Android::CLCoreUrusTimers_Android() :
...
void CLCoreUrusTimers_Android::_micro_sleep(uint32_t usec)
{
    struct timespec ts;
    ts.tv_sec = 0;
...
uint64_t CLCoreUrusTimers_Android::_micros64ts ()
{
    struct timespec ts;
...
uint64_t CLCoreUrusTimers_Android::_micros64tv ()
{
    struct timeval tp;
...
void CLCoreUrusTimers_Android::_measure_time_proccess()
{
    uint64_t clk;
    clk = 0;
...
uint64_t CLCoreUrusTimers_Android::get_core_hrdtime ()
{
    return _micros64tv();
}
