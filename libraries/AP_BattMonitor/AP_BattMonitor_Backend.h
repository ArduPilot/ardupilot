...
public:
    ...
    // has_capacity_remaining_pct - returns true if the battery info have capability to show battery % remaining
    virtual bool has_capacity_remaining_pct() const { return false; }
