...
const AP_BattMonitor_TIBQ76952::ConfigurationSettings AP_BattMonitor_TIBQ76952::config_settings[] = {
...
// read safety status (e.g. check for faults)
void AP_BattMonitor_TIBQ76952::read_safety_state()
{
    const uint16_t safetyA_status = direct_command_read_2bytes(TIBQ769x2_SafetyStatusA);
    if (safetyA_status > 0) {
