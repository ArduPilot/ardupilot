...
static uint8_t smbus_cell_ids[] = { 0x3f,  // cell 1
                             0x3e,  // cell 2
                             0x3d,  // cell 3
                             0x3c,  // cell 4
                             0x3b,  // cell 5
...
// Constructor
AP_BattMonitor_Astra::AP_BattMonitor_Astra(AP_BattMonitor &mon,
                                                   AP_BattMonitor::BattMonitor_State &mon_state,
                                                   AP_BattMonitor_Params &params)
    : AP_BattMonitor_SMBus(mon, mon_state, params, AP_BATTMONITOR_SMBUS_BUS_EXTERNAL)
{}

void AP_BattMonitor_Astra::timer()
{
...
bool AP_BattMonitor_Astra::check_pec_support()
{
...
#endif  //AP_BATTERY_SMBUS_ENABLED && AP_BATTERY_ASTRA_ENABLED
