...
class AP_BattMonitor_MAVLink_Battery;
...
class AP_BattMonitor
{
    ...
    friend class AP_BattMonitor_MAVLink_Battery;
...
public:
    ...
    // handle mavlink msg 
    void handle_mavlink_battery_message(const mavlink_message_t &msg);
    void select_battery_driver(const mavlink_message_t &msg, uint8_t instance);
