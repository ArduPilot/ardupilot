...
// pixhawk
#define AP_BATT_VOLT_PIN                  (2)       //BEV set default
#define AP_BATT_CURR_PIN                  (3)       //BEV set default
#define AP_BATT_VOLTDIVIDER_DEFAULT       (10.16)   //BEV set default
#define AP_BATT_CURR_AMP_PERVOLT_DEFAULT  (22.87)   //BEV set default

#define AP_BATT_CAPACITY_DEFAULT            (5200)  //BEV set default
