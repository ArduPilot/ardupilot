...
public:
    ...
    const char* get_custom_log_directory() const override { return custom_log_directory; }
    const char* get_custom_terrain_directory() const override { return custom_terrain_directory; }
