...
// write replay data to its own log (LOG_REPLAY=2); compiled in by default
// only on SITL
#ifndef AP_LOGGER_REPLAY_SEPARATE_LOG_ENABLED
#define AP_LOGGER_REPLAY_SEPARATE_LOG_ENABLED (HAL_LOGGING_FILESYSTEM_ENABLED && CONFIG_HAL_BOARD == HAL_BOARD_SITL)
#endif

#if AP_LOGGER_REPLAY_SEPARATE_LOG_ENABLED

#if !HAL_LOGGING_FILESYSTEM_ENABLED
#error separate replay log support requires the filesystem backend
#endif

#ifndef HAL_BOARD_REPLAY_DIRECTORY
#define HAL_BOARD_REPLAY_DIRECTORY HAL_BOARD_LOG_DIRECTORY "/REPLAY"
#endif
