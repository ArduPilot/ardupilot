...
private:
    ...
    // after a low-space trim finds nothing to remove, don't rescan
    // for this long
    uint32_t _low_space_trim_backoff_ms;
    static constexpr uint32_t _low_space_trim_backoff_interval_ms = 60000UL;
#if AP_FILESYSTEM_LITTLEFS_ENABLED
