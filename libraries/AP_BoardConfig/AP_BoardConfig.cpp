...
#if HAL_HAVE_IMU_HEATER2
            ,{{HAL_IMUHEAT2_P_DEFAULT, HAL_IMUHEAT2_I_DEFAULT, 70},}
#endif
    }
#endif
{
...
const AP_Param::GroupInfo AP_BoardConfig::var_info[] = {
    ...
    // @Units: degC
    // @User: Advanced
    AP_GROUPINFO("HEAT_TARG", 8, AP_BoardConfig, heater[0].imu_target_temperature, HAL_IMU_TEMP_DEFAULT),
#endif
    ...
    // @Increment: 1
    // @User: Advanced
    AP_SUBGROUPINFO(heater[0].pi_controller, "HEAT_",  21, AP_BoardConfig, AC_PI),
#endif
    ...
    // @Units: degC
    // @User: Advanced
    AP_GROUPINFO("HEAT2_TARG", 33, AP_BoardConfig, heater[1].imu_target_temperature, HAL_IMU_TEMP2_DEFAULT),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_SUBGROUPINFO(heater[1].pi_controller, "HEAT2_",  34, AP_BoardConfig, AC_PI),
#endif
