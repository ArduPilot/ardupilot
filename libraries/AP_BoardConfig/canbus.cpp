...
#include <AP_UAVCAN/AP_UAVCAN.h>
  ...
  # define CAN_DRIVER_DEFAULT 1
#else
  # define CAN_DRIVER_DEFAULT 0
#endif
...
const AP_Param::GroupInfo AP_BoardConfig_CAN::CAN_if_var_info::var_info[] = {
    ...
    // @User: Standard
    // @RebootRequired: True
    AP_GROUPINFO_FLAGS("DRIVER", 1, AP_BoardConfig_CAN::CAN_if_var_info, _driver_number, CAN_DRIVER_DEFAULT, AP_PARAM_FLAG_ENABLE),
