...
public:
    ...
    */
    ...
    AC_PID_OscillationDetector oscillationDetector{_pid_info, gains.P, gains.I, gains.D, gains.FF, 2.0f, 2.0f, 0.01f, 1.0f}; // 2 cdeg/s magnitude threshold, 2 oscillation threshold, 0.01 filter value
