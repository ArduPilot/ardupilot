...
const AP_Param::GroupInfo AP_TekerDumenKontrolcu::var_info[] = {
	// @Param: TCONST
	...
	// @Increment: 0.1
	// @User: Advanced
	AP_GROUPINFO("TCONST",      0, AP_TekerDumenKontrolcu, _tau,       0.75f),
	...
	// @Increment: 0.1
	// @User: Standard
	AP_GROUPINFO("P",      1, AP_TekerDumenKontrolcu, _K_P,        1.8f),
	...
	// @Increment: 0.05
	// @User: Standard
	AP_GROUPINFO("I",        3, AP_TekerDumenKontrolcu, _K_I,        0.2f),
	...
	// @Increment: 0.01
	// @User: Standard
	AP_GROUPINFO("D",        4, AP_TekerDumenKontrolcu, _K_D,        0.005f),
	...
	// @Units: cdeg
	// @User: Advanced
	AP_GROUPINFO("IMAX",     5, AP_TekerDumenKontrolcu, _imax,        1500),
	...
	// @Units: m/s
	// @User: Standard
	AP_GROUPINFO("MINSPD",   6, AP_TekerDumenKontrolcu, _minspeed,    1.0f),
	...
	// @Increment: 0.1
	// @User: Standard
	AP_GROUPINFO("FF",      7, AP_TekerDumenKontrolcu, _K_FF,        0),
    ...
    // @Units: m/s
    // @User: Advanced
    AP_GROUPINFO("DRTSPD",  8, AP_TekerDumenKontrolcu, _deratespeed,        0),
    ...
    // @Units: deg/m/s
    // @User: Advanced
    AP_GROUPINFO("DRTFCT", 9, AP_TekerDumenKontrolcu, _deratefactor,        10),
    ...
    // @Units: cdeg
    // @User: Advanced
    AP_GROUPINFO("DRTMIN", 10, AP_TekerDumenKontrolcu, _mindegree,        4500),
...
*/
int32_t AP_TekerDumenKontrolcu::get_steering_out_rate(float desired_rate)
{
...
*/
int32_t AP_TekerDumenKontrolcu::get_steering_out_lat_accel(float desired_accel)
{
...
*/
int32_t AP_TekerDumenKontrolcu::get_steering_out_angle_error(int32_t angle_err)
{
    if (_tau < 0.1f) {
        _tau.set(0.1f);
    }
...
void AP_TekerDumenKontrolcu::reset_I()
{
	_pid_info.I = 0;
}

// Returns true if controller has been run recently
bool AP_TekerDumenKontrolcu::active() const
{
