...
#define GRF_I2C_POLL_HZ                  50

const AP_Param::GroupInfo AP_RangeFinder_LightWare_GRF_I2C::var_info[] = {
    // @Group: GRF_
    // @Path: AP_RangeFinder_LightWare_GRF_Common.cpp
    AP_SUBGROUPINFO(return_selection, "GRF_", 12, AP_RangeFinder_LightWare_GRF_I2C, AP_RangeFinder_LightWare_GRF_Common),
...
void AP_RangeFinder_LightWare_GRF_I2C::timer()
{
    ...
    float dist_m;
    if (!parse_distance_cm_payload(rx, sizeof(rx), dist_m)) {
        return;
    }
