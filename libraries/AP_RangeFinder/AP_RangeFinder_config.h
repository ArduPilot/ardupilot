...
#ifndef AP_RANGEFINDER_MZBH301_CAN_ENABLED
#define AP_RANGEFINDER_MZBH301_CAN_ENABLED (HAL_MAX_CAN_PROTOCOL_DRIVERS && AP_RANGEFINDER_BACKEND_DEFAULT_ENABLED)
#endif
