...
public:
    ...
    static AP_RangeFinder_Backend *detect(RangeFinder::RangeFinder_State &_state, AP_RangeFinder_Params &_params, AP_HAL::I2CDevice* _dev, DistanceMode mode);
...
private:
    ...
    // constructor
    AP_RangeFinder_VL53L1X(RangeFinder::RangeFinder_State &_state, AP_RangeFinder_Params &_params, AP_HAL::I2CDevice* dev);
