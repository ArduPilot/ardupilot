...
// the GRF_* params and common logic live in exactly one place. Each backend
// pulls in this var_info[] table via a single AP_SUBGROUPINFO entry that
// uses return_selection (Common's first member) as the offset anchor.
