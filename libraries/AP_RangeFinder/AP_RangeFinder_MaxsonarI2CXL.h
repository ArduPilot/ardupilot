...
// Maximum vdistance is depends on the device and operating voltage.
#define AP_RANGE_FINDER_MAXSONARI2CXL_MAX_DISTANCE  765
#define AP_RANGE_FINDER_MAXSONARI2CXL_MAX_DISTANCE_EZ2_3V3 720
#define AP_RANGE_FINDER_MAXSONARI2CXL_MAX_DISTANCE_EZ3_3V3 625
#define AP_RANGE_FINDER_MAXSONARI2CXL_MAX_DISTANCE_EZ4_3V3 500
#define AP_RANGE_FINDER_MAXSONARI2CXL_MAX_DISTANCE_EZ4_5V  640
