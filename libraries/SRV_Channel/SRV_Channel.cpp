...
const AP_Param::GroupInfo SRV_Channel::var_info[] = {
    ...
    // @Values: 190:Trifin1,191:Trifin2,192:Trifin3
    // @Values{Plane}: 190:Trifin1,191:Trifin2,192:Trifin3
    // @User: Standard
    // @RebootRequired: True
...
bool SRV_Channel::is_control_surface(SRV_Channel::Function function)
{
    ...
    case Function::k_trifin1:
    case Function::k_trifin2:
    case Function::k_trifin3:
        return true;
