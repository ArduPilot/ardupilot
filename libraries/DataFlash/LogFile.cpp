...
void DataFlash_Class::Log_Write_RCOUT(void)
{
    struct log_RCOUT pkt = {
        ...
        chan19        : hal.rcout->read(18),
        chan20        : hal.rcout->read(19),
        chan21        : hal.rcout->read(20),
        chan22        : hal.rcout->read(21),
        chan23        : hal.rcout->read(22),
        chan24        : hal.rcout->read(23),
        chan25        : hal.rcout->read(24),
        chan26        : hal.rcout->read(25),
        chan27        : hal.rcout->read(26),
        chan28        : hal.rcout->read(27),
        chan29        : hal.rcout->read(28),
        chan30        : hal.rcout->read(29),
        chan31        : hal.rcout->read(30),
        chan32        : hal.rcout->read(31),
        chan33        : hal.rcout->read(32),
        chan34        : hal.rcout->read(33),
        chan35        : hal.rcout->read(34),
        chan36        : hal.rcout->read(35),
        chan37        : hal.rcout->read(36),
        chan38        : hal.rcout->read(37),
        chan39        : hal.rcout->read(38),
        chan40        : hal.rcout->read(39),
        chan41        : hal.rcout->read(40),
        chan42        : hal.rcout->read(41),
        chan43        : hal.rcout->read(42),
        chan44        : hal.rcout->read(43),
        chan45        : hal.rcout->read(44),
        chan46        : hal.rcout->read(45),
        chan47        : hal.rcout->read(46),
        chan48        : hal.rcout->read(47),
        chan49        : hal.rcout->read(48),
        chan50        : hal.rcout->read(49),
        chan51        : hal.rcout->read(50),
        chan52        : hal.rcout->read(51),
        chan53        : hal.rcout->read(52),
        chan54        : hal.rcout->read(53),
        chan55        : hal.rcout->read(54),
        chan56        : hal.rcout->read(55),
        chan57        : hal.rcout->read(56),
        chan58        : hal.rcout->read(57),
        chan59        : hal.rcout->read(58),
        chan60        : hal.rcout->read(59),
        chan61        : hal.rcout->read(60),
        chan62        : hal.rcout->read(61),
        chan63        : hal.rcout->read(62),
        chan64        : hal.rcout->read(63)
    };
    WriteBlock(&pkt, sizeof(pkt));
    Log_Write_ESC();
}
