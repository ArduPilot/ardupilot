...
void DataFlash_Class::Log_Write_Mission_Cmd(const AP_Mission::Mission_Command &cmd)
{
...
void DataFlash_Class::Log_Write_EntireMission(AP_Mission &mission)
{
