...
#ifndef AP_COMPASS_AF9838_ENABLED
#define AP_COMPASS_AF9838_ENABLED AP_COMPASS_I2C_BACKEND_DEFAULT_ENABLED && (HAL_PROGRAM_SIZE_LIMIT_KB > 1024)
#endif
...
#ifndef AP_COMPASS_AK09940A_ENABLED
#define AP_COMPASS_AK09940A_ENABLED (AP_COMPASS_I2C_BACKEND_DEFAULT_ENABLED && (HAL_PROGRAM_SIZE_LIMIT_KB > 2048))
#endif
...
#define AP_COMPASS_QMC5883P_ENABLED AP_COMPASS_I2C_BACKEND_DEFAULT_ENABLED
#endif
...
#ifndef AP_COMPASS_IIS2MDC_EXTERNAL_BUS_PROBING_ENABLED
#define AP_COMPASS_IIS2MDC_EXTERNAL_BUS_PROBING_ENABLED (AP_COMPASS_IIS2MDC_ENABLED && AP_COMPASS_PROBING_ENABLED)
...
#ifndef AP_COMPASS_AK09940A_EXTERNAL_BUS_PROBING_ENABLED
#define AP_COMPASS_AK09940A_EXTERNAL_BUS_PROBING_ENABLED (AP_COMPASS_AK09940A_ENABLED && AP_COMPASS_PROBING_ENABLED)
#endif  // AP_COMPASS_AK09940A_EXTERNAL_BUS_PROBING_ENABLED
...
// boards with explicit internal RM3100 COMPASS lines in hwdef.dat may want
// to disable the generic hardcoded internal RM3100 probing (which uses
// ROTATION_NONE) so the explicit hwdef rotation is honoured.
#ifndef AP_COMPASS_RM3100_INTERNAL_BUS_PROBING_ENABLED
#define AP_COMPASS_RM3100_INTERNAL_BUS_PROBING_ENABLED (AP_COMPASS_RM3100_ENABLED && AP_COMPASS_INTERNAL_BUS_PROBING_ENABLED)
