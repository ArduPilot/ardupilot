...
void CompassCalibrator::AttitudeSample::set_from_ahrs(void)
{
    ...
    roll = constrain_float(127 * (roll_rad / M_PI), -INT8_MAX, INT8_MAX);
    pitch = constrain_float(127 * (pitch_rad / M_PI_2), -INT8_MAX, INT8_MAX);
    yaw = constrain_float(127 * (yaw_rad / M_PI), -INT8_MAX, INT8_MAX);
}
