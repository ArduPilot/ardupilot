...
{
public:
    /* Probe for AK8975 standalone on I2C bus */
    static AP_Compass_Backend *probe(AP_HAL::OwnPtr<AP_HAL::I2CDevice> dev,
                                     enum Rotation rotation);

    /* Probe for AK8975 on auxiliary bus of MPU9150, connected through I2C */
    static AP_Compass_Backend *probe_mpu9150(AP_HAL::OwnPtr<AP_HAL::I2CDevice> dev,
                                             enum Rotation rotation);

    /* Probe for AK8975 on auxiliary bus of MPU9150, connected through SPI */
    static AP_Compass_Backend *probe_mpu9150(uint8_t mpu9150_instance,
                                             enum Rotation rotation);
...
{
public:
    AP_AK8975_BusDriver_HALDevice(AP_HAL::OwnPtr<AP_HAL::I2CDevice> dev);
...
class AP_AK8975_BusDriver_Auxiliary : public AP_AK8975_BusDriver
{
public:
    AP_AK8975_BusDriver_Auxiliary(AP_InertialSensor &ins, uint8_t backend_id,
                                  uint8_t backend_instance, uint8_t addr);
    ~AP_AK8975_BusDriver_Auxiliary();
