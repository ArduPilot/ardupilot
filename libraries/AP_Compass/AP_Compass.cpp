...
void Compass::_detect_backends(void)
{
    ...
    case AP_BoardConfig::PX4_BOARD_PIXHAWK2:
        ...
        ADD_BACKEND(DRIVER_AK8963, AP_Compass_AK8963::probe_mpu9250(uint8_t(1), ROTATION_YAW_270));
    ...
    case AP_BoardConfig::PX4_BOARD_SP01:
        ADD_BACKEND(DRIVER_AK8963, AP_Compass_AK8963::probe_mpu9250(uint8_t(1), ROTATION_NONE));
        break;

    case AP_BoardConfig::PX4_BOARD_PIXHAWK_PRO:
        ADD_BACKEND(DRIVER_AK8963, AP_Compass_AK8963::probe_mpu9250(uint8_t(0), ROTATION_ROLL_180_YAW_90));
        ADD_BACKEND(DRIVER_LIS3MDL, AP_Compass_LIS3MDL::probe(hal.spi->get_device(HAL_COMPASS_LIS3MDL_NAME),
                    false, ROTATION_NONE));
        break;

    case AP_BoardConfig::PX4_BOARD_PHMINI:
        ADD_BACKEND(DRIVER_AK8963, AP_Compass_AK8963::probe_mpu9250(uint8_t(0), ROTATION_ROLL_180));
        break;
    ...
    case AP_BoardConfig::PX4_BOARD_PH2SLIM:
        ADD_BACKEND(DRIVER_AK8963, AP_Compass_AK8963::probe_mpu9250(uint8_t(0), ROTATION_YAW_270));
        break;
