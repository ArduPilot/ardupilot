...
void Compass::_detect_backends(void)
{
    ...
    ADD_BACKEND(DRIVER_HMC5883, AP_Compass_HMC5843::probe(GET_I2C_DEVICE(2, 0x1E), false, ROTATION_YAW_270));
    ADD_BACKEND(DRIVER_HMC5883, AP_Compass_HMC5843::probe(GET_I2C_DEVICE(1, 0x1E), true, ROTATION_ROLL_180));
