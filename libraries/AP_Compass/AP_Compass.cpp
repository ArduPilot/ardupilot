...
const AP_Param::GroupInfo Compass::var_info[] = {
    ...
    AP_GROUPINFO_FLAGS("_ENABLE", 39, Compass, _enabled, AP_COMPASS_ENABLE_DEFAULT, AP_PARAM_FLAG_ENABLE),
...
void Compass::init()
{
    ...
    for (StateIndex i(0); i<COMPASS_MAX_INSTANCES; i++) {
        ...
        _state[i].params.orientation.set_and_save(ROTATION_CUSTOM_2);
