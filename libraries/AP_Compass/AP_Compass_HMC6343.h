...
class AP_HMC6343_BusDriver;

class AP_Compass_HMC6343 : public AP_Compass_Backend
{
public:
    ...
    static constexpr const char *name = "HMC6343";

    virtual ~AP_Compass_HMC6343();

    void read() override;

private:
    AP_Compass_HMC6343(Compass &compass, AP_HMC6343_BusDriver *bus,
...
class AP_HMC6343_BusDriver_HALDevice : public AP_HMC6343_BusDriver
{
public:
    AP_HMC6343_BusDriver_HALDevice(AP_HAL::OwnPtr<AP_HAL::Device> dev);
...
class AP_HMC6343_BusDriver_Auxiliary : public AP_HMC6343_BusDriver
{
public:
    AP_HMC6343_BusDriver_Auxiliary(AP_InertialSensor &ins, uint8_t backend_id,
                                   uint8_t addr);
    virtual ~AP_HMC6343_BusDriver_Auxiliary();
