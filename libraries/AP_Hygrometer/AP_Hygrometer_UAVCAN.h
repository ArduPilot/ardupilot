...
public:
    // constructor
    AP_Hygrometer_UAVCAN(AP_Hygrometer &_frontend, uint8_t _instance, AP_Hygrometer::Hygrometer_State &_state, AP_Hygrometer::Hygrometer_Param &_params);
    ...
    static AP_Hygrometer_Backend* probe(AP_Hygrometer &_frontend, uint8_t _instance, AP_Hygrometer::Hygrometer_State &_state, AP_Hygrometer::Hygrometer_Param &_params);
