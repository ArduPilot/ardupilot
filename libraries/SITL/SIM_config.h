...
// simulate an IMU which warms up from SIM_IMUT_START to SIM_IMUT_END,
// as a board with an IMU heater does
#ifndef AP_SIM_IMU_HEATER_ENABLED
#define AP_SIM_IMU_HEATER_ENABLED (CONFIG_HAL_BOARD == HAL_BOARD_SITL)
#endif  // AP_SIM_IMU_HEATER_ENABLED
