#Author:Shreya Kulsh
#This program tests a formation between two planes
#!/bin/bash

# two plane swarm (x offset formation)
...
(cd swarm/plane2 && $PLANE --model plane --home -35.3632627,149.164973795414,584.926584510997,0 --uartA $UARTA --instance 1 --defaults $PLANE_DEFAULTS,follow.parm) &
wait
