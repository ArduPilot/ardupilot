...
void getCompass (const WbDeviceTag compass, char *buf)
{
    ...
    sprintf(buf,"[%f, %f, %f]",north3D[DIM_FIRST], north3D[DIM_SECOND], north3D[DIM_THIRD]);
...
void getGPS (const WbDeviceTag gps, char *buf)
{
    ...
    sprintf(buf,"\"x\": %f,\"y\": %f,\"z\": %f", north3D[DIM_FIRST], north3D[DIM_SECOND], north3D[DIM_THIRD]);
...
void getAcc (const WbDeviceTag accelerometer, char *buf)
{
    ...
    sprintf(buf,"[%f, %f, %f]",a[DIM_FIRST], a[DIM_SECOND], a[DIM_THIRD]);
...
void getGyro (const WbDeviceTag gyro, char *buf)
{
    ...
    sprintf(buf,"[%f, %f, %f]",g[DIM_FIRST], g[DIM_SECOND], g[DIM_THIRD]);
