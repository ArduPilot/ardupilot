...
private:
    ...
    struct keytable {
        ...
        { "", "t", &state.timestamp_s, DATA_DOUBLE, true },
        { "i", "g",    &state.imu.gyro, DATA_VECTOR3F, true },
        { "i", "a", &state.imu.accel_body, DATA_VECTOR3F, true },
        { "", "p", &state.position, DATA_VECTOR3D, true },
        { "", "a", &state.attitude, DATA_VECTOR3F, false },
        { "", "q", &state.quaternion, QUATERNION, false },
        { "", "v", &state.velocity, DATA_VECTOR3F, true },
        { "", "r1", &state.rng[0], DATA_FLOAT, false },
        { "", "r2", &state.rng[1], DATA_FLOAT, false },
        { "", "r3", &state.rng[2], DATA_FLOAT, false },
        { "", "r4", &state.rng[3], DATA_FLOAT, false },
        { "", "r5", &state.rng[4], DATA_FLOAT, false },
        { "", "r6", &state.rng[5], DATA_FLOAT, false },
        {"w","d", &state.wind_vane_apparent.direction, DATA_FLOAT, false},
        {"w","s", &state.wind_vane_apparent.speed, DATA_FLOAT, false},
        {"", "as", &state.airspeed, DATA_FLOAT, false},
        {"", "n", &state.no_time_sync, BOOLEAN, false},
    };
