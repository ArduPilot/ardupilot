...
#define AN_PACKET_ID_GEOID_HEIGHT 54
...
#define AN_SIM_GEOID_HEIGHT 42.0f // meters above WGS84 ellipsoid
...
private:
    ...
    an_packet_t* encode_geoid_height_packet(geoid_height_packet_t* geoid_height_packet);
