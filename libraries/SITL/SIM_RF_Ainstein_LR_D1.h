...
./Tools/autotest/sim_vehicle.py --gdb --debug -v ArduCopter -A --uartF=sim:ainsteinlrd1 --speedup=1

param set SERIAL5_PROTOCOL 9
param set RNGFND1_TYPE 37
...
/Tools/autotest/sim_vehicle.py --gdb --debug -v ArduCopter -A --uartF=file:libraries/AP_RangeFinder/examples/captures/ainstein_lr-d1.bin --speedup=1
