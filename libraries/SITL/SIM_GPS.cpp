...
void GPS::update()
{
    ...
    d.latitude += glitch_offsets.x +  params.accuracy * 0.3 * sinf(now_ms * 0.0005f) * 1.113195e-5;
    d.longitude += glitch_offsets.y + params.accuracy * 0.3 * cosf(now_ms * 0.0005f) * 1.113195e-5;
