...
const AP_Param::GroupInfo IBus2ESC::var_info[] = {
    ...
    // @Param: DEV
    // @DisplayName: IBUS2 ESC device index
    // @Description: Suffix N of the SITL device string "ibus2escN" this instance responds to
    // @Range: 0 3
    // @User: Advanced
    AP_GROUPINFO_FLAGS_DEFAULT_POINTER("DEV", 2, IBus2ESC, _dev_idx, _dev_idx_default),
