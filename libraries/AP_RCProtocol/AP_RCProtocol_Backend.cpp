 ...
 */
void AP_RCProtocol_Backend::add_input(uint8_t num_values, uint16_t *values, bool in_failsafe, int16_t _rssi, int16_t _rx_link_quality, int8_t _rfmode, int16_t txpower, int8_t rxsnr, int8_t activantenna)
{
