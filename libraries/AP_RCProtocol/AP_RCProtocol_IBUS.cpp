...
AP_RCProtocol_IBUS::AP_RCProtocol_IBUS(AP_RCProtocol &_frontend) :
    AP_RCProtocol_Backend(_frontend, AP_RCProtocol::IBUS)
{}
...
// support byte input
void AP_RCProtocol_IBUS::process_byte(uint32_t timestamp_us, uint8_t b, const AP_RCProtocol::SerialConfig& config)
{
