...
void rc_input_to_roll_pitch_rad(float roll_in_unit, float pitch_in_unit, float angle_max_rad, float angle_limit_rad, float &roll_out_rad, float &pitch_out_rad);
