...
{
  float wrap_1 = wrap_180(45.f);
  float wrap_2 = wrap_180(90.f);
  float wrap_3 = wrap_180(180.f);
  float wrap_4 = wrap_180(180.1f);
  float wrap_5 = wrap_180(270.f);
  float wrap_6 = wrap_180(360.f);
  float wrap_7 = wrap_180(720.f);
  float wrap_8 = wrap_180(3600.f);
  float wrap_9 = wrap_180(7200.f);
  float wrap_10 = wrap_180(-36000000); // there is a loss in precision still
  
  EXPECT_EQ(wrap_1, 45.f);
  EXPECT_EQ(wrap_2, 90.f);
  EXPECT_EQ(wrap_3, -180.f);
  EXPECT_EQ(wrap_4, -179.9f);
  EXPECT_EQ(wrap_5, -90.f);
  EXPECT_EQ(wrap_6, 0.f);
  EXPECT_EQ(wrap_7, 0.f);
  EXPECT_EQ(wrap_8, 0.f);
  EXPECT_EQ(wrap_9, 0.f);
  EXPECT_EQ(wrap_10, 180.f);
}

TEST(Wrap360Test, angle360)
{
  float wrap_1 = wrap_360(45.f);
  float wrap_2 = wrap_360(90.f);
  float wrap_3 = wrap_360(180.f);
  float wrap_4 = wrap_360(270.f);
  float wrap_5 = wrap_360(360.f);
  float wrap_6 = wrap_360(720.f);
  float wrap_7 = wrap_360(3600.f);
  float wrap_8 = wrap_360(7200.f);
  float wrap_9 = wrap_360(-36000000.f); // there is a loss in precision still
  
  EXPECT_EQ(wrap_1, 45.f);
  EXPECT_EQ(wrap_2, 90.f);
  EXPECT_EQ(wrap_3, 180.f);
  EXPECT_EQ(wrap_4, 270.f);
  EXPECT_EQ(wrap_5, 0.f);
  EXPECT_EQ(wrap_6, 0.f);
  EXPECT_EQ(wrap_7, 0.f);
  EXPECT_EQ(wrap_8, 0.f);
  EXPECT_EQ(wrap_9, 0.f);
...
TEST(Wrap2PiTest, pipi_factor)
{
  ...
  EXPECT_NEAR(wrap_2, 0.f, accuracy);
  EXPECT_NEAR(wrap_3, M_PI_2, accuracy);  
  EXPECT_NEAR(wrap_4, 0.f, accuracy);
}
