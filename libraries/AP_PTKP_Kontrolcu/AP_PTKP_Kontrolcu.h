...
/// @file    AP_PTKP_Kontrolcu.h
/// @brief   Pist Takip Algoritması header dosyası. This is a instance of an
/// AP_Navigation class
...
class AP_PTKP_Kontrolcu : public AP_Navigation {
public:
    AP_PTKP_Kontrolcu(AP_AHRS &ahrs, const AP_TECS *tecs)
        : _ahrs(ahrs)
        , _tecs(tecs)
    {
    ...
    /* Do not allow copies */
    CLASS_NO_COPY(AP_PTKP_Kontrolcu);
