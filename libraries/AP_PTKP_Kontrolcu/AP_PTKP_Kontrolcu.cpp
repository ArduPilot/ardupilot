...
#include "AP_PTKP_Kontrolcu.h"

extern const AP_HAL::HAL& hal;

// table of user settable parameters
const AP_Param::GroupInfo AP_PTKP_Kontrolcu::var_info[] = {
    // @Param: PERIOD
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("PERIOD",    0, AP_PTKP_Kontrolcu, _L1_period, 17),
    ...
    // @Increment: 0.05
    // @User: Advanced
    AP_GROUPINFO("DAMPING",   1, AP_PTKP_Kontrolcu, _L1_damping, 0.75f),
    ...
    // @Increment: 0.01
    // @User: Advanced
    AP_GROUPINFO("XTRACK_I",   2, AP_PTKP_Kontrolcu, _L1_xtrack_i_gain, 0.02),
    ...
    // @Range: 0 89
    // @User: Advanced
    AP_GROUPINFO("LIM_BANK",   3, AP_PTKP_Kontrolcu, _loiter_bank_limit, 0.0f),
 ...
 */
float AP_PTKP_Kontrolcu::get_yaw() const
{
    if (_reverse) {
 ...
 */
int32_t AP_PTKP_Kontrolcu::get_yaw_sensor() const
{
    if (_reverse) {
...
/*
  ...
  update_*() operation
 */
int32_t AP_PTKP_Kontrolcu::nav_roll_cd(void) const
{
    float ret;
	/*
...
/*
  ...
  update_*() operation
 */
float AP_PTKP_Kontrolcu::lateral_acceleration(void) const
{
    return _latAccDem;
}

int32_t AP_PTKP_Kontrolcu::nav_bearing_cd(void) const
{
    return wrap_180_cd(RadiansToCentiDegrees(_nav_bearing));
}

int32_t AP_PTKP_Kontrolcu::bearing_error_cd(void) const
{
    return RadiansToCentiDegrees(_bearing_error);
}

int32_t AP_PTKP_Kontrolcu::target_bearing_cd(void) const
{
 ...
 */
float AP_PTKP_Kontrolcu::turn_distance(float wp_radius) const
{
 ...
 */
float AP_PTKP_Kontrolcu::turn_distance(float wp_radius, float turn_angle) const
{
...
float AP_PTKP_Kontrolcu::loiter_radius(const float radius) const
{
...
bool AP_PTKP_Kontrolcu::reached_loiter_target(void)
{
    return _WPcircle;
}
 ...
 */
void AP_PTKP_Kontrolcu::_prevent_indecision(float &Nu)
{
...
void AP_PTKP_Kontrolcu::update_waypoint(const Location &prev_WP, const Location &next_WP, float dist_min)
{
...
void AP_PTKP_Kontrolcu::update_loiter(const Location &center_WP, float radius, int8_t loiter_direction)
{
    Location _current_loc;
...
void AP_PTKP_Kontrolcu::update_heading_hold(int32_t navigation_heading_cd)
{
...
void AP_PTKP_Kontrolcu::update_level_flight(void)
{
    // copy to _target_bearing_cd and _nav_bearing
