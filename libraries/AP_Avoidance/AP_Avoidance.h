...
protected:
    ...
    // Note: v1 is NED
    static Vector3f perpendicular_xyz(const AbsAltLocation &p1, const Vector3f &v1, const AbsAltLocation &p2);
    static Vector2f perpendicular_xy(const AbsAltLocation &p1, const Vector3f &v1, const AbsAltLocation &p2);
