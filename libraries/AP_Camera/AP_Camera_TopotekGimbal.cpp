...
bool AP_Camera_TopotekGimbal::trigger_pic()
{
...
bool AP_Camera_TopotekGimbal::record_video(bool start_recording)
{
    AP_Mount* mount = AP::mount();
    if (mount != nullptr) {
...
bool AP_Camera_TopotekGimbal::set_zoom(ZoomType zoom_type, float zoom_value)
{
    AP_Mount* mount = AP::mount();
    if (mount != nullptr) {
...
SetFocusResult AP_Camera_TopotekGimbal::set_focus(FocusType focus_type, float focus_value)
{
    AP_Mount* mount = AP::mount();
    if (mount != nullptr) {
...
bool AP_Camera_TopotekGimbal::set_tracking(TrackingType tracking_type, const Vector2f& p1, const Vector2f& p2)
{
    AP_Mount* mount = AP::mount();
    if (mount != nullptr) {
...
bool AP_Camera_TopotekGimbal::set_lens(uint8_t lens)
{
    AP_Mount* mount = AP::mount();
    if (mount != nullptr) {
...
void AP_Camera_TopotekGimbal::send_camera_information(mavlink_channel_t chan) const
{
    AP_Mount* mount = AP::mount();
    if (mount != nullptr) {
...
void AP_Camera_TopotekGimbal::send_camera_settings(mavlink_channel_t chan) const
{
    AP_Mount* mount = AP::mount();
    if (mount != nullptr) {
...
void AP_Camera_TopotekGimbal::send_camera_capture_status(mavlink_channel_t chan) const
{
    AP_Mount* mount = AP::mount();
    if (mount != nullptr) {
