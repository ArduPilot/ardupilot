...
// This will enable the CAMERA_FEEDBACK message. This message has been deprecated by the CAMERA_IMAGE_CAPTURED message.
#ifndef AP_CAMERA_MAVLINK_FEEDBACK_MESSAGE_ENABLED
#define AP_CAMERA_MAVLINK_FEEDBACK_MESSAGE_ENABLED AP_CAMERA_BACKEND_DEFAULT_ENABLED
#endif
