...
// USB CDC-ECM L2 netif (requires HAL_WITH_USB_CDC_ECM + MatekH743-ECM style board)
#ifndef AP_NETWORKING_BACKEND_USB_ECM
#define AP_NETWORKING_BACKEND_USB_ECM 0
#endif
...
#define AP_NETWORKING_CONTROLS_HOST_IP_SETTINGS_ENABLED (AP_NETWORKING_BACKEND_CHIBIOS || AP_NETWORKING_BACKEND_USB_ECM || (AP_NETWORKING_BACKEND_PPP && CONFIG_HAL_BOARD == HAL_BOARD_SITL))
#endif

#define AP_NETWORKING_NEED_LWIP (AP_NETWORKING_BACKEND_CHIBIOS || AP_NETWORKING_BACKEND_PPP || AP_NETWORKING_BACKEND_SITL_TUN || AP_NETWORKING_BACKEND_USB_ECM)
...
// Default NET_ENABLE (0 unless lab board overrides)
#ifndef AP_NETWORKING_DEFAULT_NET_ENABLE
#define AP_NETWORKING_DEFAULT_NET_ENABLE 0
#endif
