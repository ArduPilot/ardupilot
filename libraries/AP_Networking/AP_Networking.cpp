...
const AP_Param::GroupInfo AP_Networking::var_info[] = {
    ...
    // @Bitmask: 0:EnablePPP Ethernet gateway, 1:Enable CAN1 multicast endpoint, 2:Enable CAN2 multicast endpoint, 3:Enable CAN1 multicast bridged, 4:Enable CAN2 multicast bridged, 5:Enable CAN1 multicast MAVCAN bridging, 6:Enable CAN2 multicast MAVCAN bridging
    // @RebootRequired: True
    // @User: Advanced
