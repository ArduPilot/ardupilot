...
const AP_Param::GroupInfo RC_Channel_aux::var_info[] PROGMEM = {
    ...
    // @Param: FUNCTION
    // @DisplayName: 伺服输出功能
    // @Description: 将此设为禁用(0) will setup this output for control by auto missions or MAVLink servo set commands. any other value will enable the corresponding function
