...
void RC_Channel::do_aux_function_retract_mount(const AuxSwitchPos ch_flag, const uint8_t instance)
{
    ...
    auto default_mode = mount->get_default_mode(instance);
    auto mode_high = (default_mode != MAV_MOUNT_MODE_RETRACT)? MAV_MOUNT_MODE_RETRACT : MAV_MOUNT_MODE_RC_TARGETING;
