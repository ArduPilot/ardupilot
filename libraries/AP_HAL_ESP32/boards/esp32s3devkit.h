...
#define HAL_ESP32_RCOUT { GPIO_NUM_9, GPIO_NUM_10, GPIO_NUM_11, GPIO_NUM_12, GPIO_NUM_13, GPIO_NUM_14 }
...
//#define HAL_ESP32_I2C_BUSES {} // using this empty block appears to cause crashes?
...
#define HAL_ESP32_UART_DEVICES \
  ...
  //{.port=UART_NUM_2, .rx=GPIO_NUM_19, .tx=GPIO_NUM_20 }


#define HAL_LOGGING_ENABLED 0

#undef AP_FILESYSTEM_ESP32_ENABLED
#undef HAL_ESP32_SDCARD
#undef HAL_ESP32_SDMMC
#undef LOGGER_MAVLINK_SUPPORT
