...
const AP_Param::GroupInfo Tailsitter::var_info[] = {
    ...
    // @Description: Enable RPM based pitch control effort scaling, when enabled tilt servo movement is scaled based on motor RPM or the thrust generated by the motor in real word.
    // @User: Standard
    AP_GROUPINFO("RPM_EN", 29, Tailsitter, rpm_based_tilt_scaling, 0),
...
void Tailsitter_Transition::update()
{
    ...
    case TRANSITION_ANGLE_WAIT_FW: {
        ...
        quadplane.attitude_control->set_throttle_out(MAX(motors->get_throttle_hover(),quadplane.attitude_control->get_throttle_in()), false, 0);
