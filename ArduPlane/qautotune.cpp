...
void QAutoTune::init_z_limits()
{
    ...
    plane.quadplane.pos_control->set_max_speed_accel_U_m(-plane.quadplane.get_pilot_velocity_z_max_dn(),
                                                       plane.quadplane.pilot_speed_z_max_up,
                                                       plane.quadplane.pilot_accel_z);
    plane.quadplane.pos_control->set_correction_speed_accel_U_mss(-plane.quadplane.get_pilot_velocity_z_max_dn(),
                                                              plane.quadplane.pilot_speed_z_max_up,
                                                              plane.quadplane.pilot_accel_z);
}
