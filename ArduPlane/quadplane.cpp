...
void QuadPlane::check_dynamic_flight(void)
{
    if (motors->get_spool_state() != AP_Motors::SpoolState::THROTTLE_UNLIMITED ||
...
void QuadPlane::update_heli_control_dynamics(void)
{
...
bool QuadPlane::should_use_landing_swash() const
{
...
void QuadPlane::heli_update_landing_swash()
{
...
float QuadPlane::get_pilot_desired_rotor_speed() const
{
...
void QuadPlane::heli_update_rotor_speed_targets()
{
...
void QuadPlane::heli_update_autorotation()
{
...
void QuadPlane::heli_set_autorotation(bool autorotation)
{
...
void QuadPlane::update_collective_low_flag(int16_t throttle_control)
{
