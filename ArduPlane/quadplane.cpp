...
bool QuadPlane::is_flying_vtol(void)
{
    ...
    if (plane.control_mode == &plane.mode_qstabilize || plane.control_mode == &plane.mode_qhover || plane.control_mode == &plane.mode_qloiter) {
...
bool QuadPlane::in_vtol_mode(void) const
{
    ...
    return (plane.control_mode->is_vtol_flightmode() ||
