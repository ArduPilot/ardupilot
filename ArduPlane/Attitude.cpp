...
float Plane::calc_speed_scaler(void)
{
    ...
    if (ahrs.airspeed_estimate(aspeed)) {
        ...
        if (quadplane.is_flying_vtol()) {
            // vtol aircraft can generate excessive large aero contro durface deflections
            // during VTOL operation because the low airspeed can create large speed scaler
            // values at a flight conditoin where aero control surfaces have little influence.
