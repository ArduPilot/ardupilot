...
bool ModeQHover::_enter()
{
    ...
    pos_control->set_max_speed_accel_U_m(-quadplane.get_pilot_velocity_z_max_dn(), quadplane.pilot_speed_z_max_up, quadplane.pilot_accel_z);
    pos_control->set_correction_speed_accel_U_mss(-quadplane.get_pilot_velocity_z_max_dn(), quadplane.pilot_speed_z_max_up, quadplane.pilot_accel_z);
