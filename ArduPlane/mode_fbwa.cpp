...
void ModeFBWA::update()
{
    ...
    RC_Channel *chan = rc().find_channel_for_option(AP_AuxFunc::Function::FBWA_TAILDRAGGER);
    if (chan != nullptr) {
        // check for the user enabling FBWA taildrag takeoff mode
        const bool tdrag_mode = chan->get_aux_switch_pos() == AP_AuxFunc::SwitchPos::HIGH;
