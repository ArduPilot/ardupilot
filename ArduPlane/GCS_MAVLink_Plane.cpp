...
void GCS_MAVLINK_Plane::send_nav_controller_output() const
{
    ...
    if (quadplane.show_vtol_view() && quadplane.using_wp_nav()) {
        ...
        mavlink_msg_nav_controller_output_send(
            ...
            (plane.control_mode != &plane.mode_qstabilize) ? quadplane.pos_control->get_pos_error_U_m() * 100 : 0,
...
int16_t GCS_MAVLINK_Plane::high_latency_target_altitude() const
{
    ...
    if (quadplane.show_vtol_view()) {
        return (plane.control_mode != &plane.mode_qstabilize) ? (global_position_current.alt * 100 + quadplane.pos_control->get_pos_error_U_m()) : 0;
    }
#endif
