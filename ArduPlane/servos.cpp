...
{
    SRV_Channels::set_output_scaled(SRV_Channel::k_aileron, roll_in_expo());
    SRV_Channels::set_output_scaled(SRV_Channel::k_elevator, pitch_in_expo());
    SRV_Channels::set_output_scaled(SRV_Channel::k_rudder, rudder_in_expo());
...
void Plane::set_servos(void)
{
    ...
    if (control_mode == &mode_training) {
        steering_control.rudder = rudder_in_expo();
    }
