...
void AP_AdvancedFailsafe_Plane::terminate_vehicle(void)
{
    ...
    if (_terminate_action == TERMINATE_ACTION_LAND) {
        ...
        SRV_Channels::set_output_scaled(SRV_Channel::k_aileron, SERVO_MAX * _term_pos_ail/100);
        SRV_Channels::set_output_scaled(SRV_Channel::k_rudder, SERVO_MAX * _term_pos_rud/100);
        SRV_Channels::set_output_scaled(SRV_Channel::k_elevator, SERVO_MAX * _term_pos_ele/100);
