...
const AP_Task<Plane> Plane::scheduler_tasks[] = {
    ...
    AP_Task<Plane>::create(&Plane::update_speed_height,    50,    200),
    AP_Task<Plane>::create(&Plane::update_flight_mode,    400,    100),
    AP_Task<Plane>::create(&Plane::stabilize,             400,    100),
    AP_Task<Plane>::create(&Plane::set_servos,            400,    100),
    AP_Task<Plane>::create(&Plane::read_control_switch,     7,    100),
    AP_Task<Plane>::create(&Plane::gcs_retry_deferred,     50,    500),
    AP_Task<Plane>::create(&Plane::update_GPS_50Hz,        50,    300),
    AP_Task<Plane>::create(&Plane::update_GPS_10Hz,        10,    400),
    AP_Task<Plane>::create(&Plane::navigate,               10,    150),
    AP_Task<Plane>::create(&Plane::update_compass,         10,    200),
    AP_Task<Plane>::create(&Plane::read_airspeed,          10,    100),
    AP_Task<Plane>::create(&Plane::update_alt,             10,    200),
    AP_Task<Plane>::create(&Plane::adjust_altitude_target, 10,    200),
    AP_Task<Plane>::create(&Plane::afs_fs_check,           10,    100),
    AP_Task<Plane>::create(&Plane::gcs_update,             50,    500),
    AP_Task<Plane>::create(&Plane::gcs_data_stream_send,   50,    500),
    AP_Task<Plane>::create(&Plane::update_events,          50,    150),
    AP_Task<Plane>::create(&Plane::read_battery,           10,    300),
    AP_Task<Plane>::create(&Plane::compass_accumulate,     50,    200),
    AP_Task<Plane>::create(&Plane::barometer_accumulate,   50,    150),
    AP_Task<Plane>::create(&Plane::update_notify,          50,    300),
    AP_Task<Plane>::create(&Plane::read_rangefinder,       50,    100),
    AP_Task<Plane>::create(&Plane::ice_update,             10,    100),
    AP_Task<Plane>::create(&Plane::compass_cal_update,     50,    50),
    AP_Task<Plane>::create(&Plane::accel_cal_update,       10,    50),
#if OPTFLOW == ENABLED
    AP_Task<Plane>::create(&Plane::update_optical_flow,    50,    50),
#endif
    AP_Task<Plane>::create(&Plane::one_second_loop,         1,    400),
    AP_Task<Plane>::create(&Plane::check_long_failsafe,     3,    400),
    AP_Task<Plane>::create(&Plane::read_receiver_rssi,     10,    100),
    AP_Task<Plane>::create(&Plane::rpm_update,             10,    100),
    AP_Task<Plane>::create(&Plane::airspeed_ratio_update,   1,    100),
    AP_Task<Plane>::create(&Plane::update_mount,           50,    100),
    AP_Task<Plane>::create(&Plane::update_trigger,         50,    100),
    AP_Task<Plane>::create(&Plane::log_perf_info,         0.2,    100),
    AP_Task<Plane>::create(&Plane::compass_save,          0.1,    200),
    AP_Task<Plane>::create(&Plane::Log_Write_Fast,         25,    300),
    AP_Task<Plane>::create(&Plane::update_logging1,        25,    300),
    AP_Task<Plane>::create(&Plane::update_logging2,        25,    300),
    AP_Task<Plane>::create(&Plane::update_soaring,         50,    400),
    AP_Task<Plane>::create(&Plane::parachute_check,        10,    200),
    AP_Task<Plane>::create(&Plane::terrain_update,         10,    200),
    AP_Task<Plane>::create(&Plane::update_is_flying_5Hz,    5,    100),
    AP_Task<Plane>::create(&Plane::dataflash_periodic,     50,    400),
    AP_Task<Plane>::create(&Plane::avoidance_adsb_update,  10,    100),
    AP_Task<Plane>::create(&Plane::button_update,           5,    100),
    AP_Task<Plane>::create(&Plane::stats_update,            1,    100),
};
