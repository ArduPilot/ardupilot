...
const AP_Task<Plane> Plane::scheduler_tasks[] = {
                                               // Units:   Hz      us
    AP_Task<Plane>::create(&Plane::ahrs_update,           400,    400, "ahrs_update"),
    AP_Task<Plane>::create(&Plane::read_radio,             50,    100, "read_radio"),
    AP_Task<Plane>::create(&Plane::check_short_failsafe,   50,    100, "check_short_failsafe"),
    AP_Task<Plane>::create(&Plane::update_speed_height,    50,    200, "update_speed_height"),
    AP_Task<Plane>::create(&Plane::update_flight_mode,    400,    100, "update_flight_mode"),
    AP_Task<Plane>::create(&Plane::stabilize,             400,    100, "stabilize"),
    AP_Task<Plane>::create(&Plane::set_servos,            400,    100, "set_servos"),
    AP_Task<Plane>::create(&Plane::read_control_switch,     7,    100, "read_control_switch"),
    AP_Task<Plane>::create(&Plane::gcs_retry_deferred,     50,    500, "gcs_retry_deferred"),
    AP_Task<Plane>::create(&Plane::update_GPS_50Hz,        50,    300, "update_GPS_50Hz"),
    AP_Task<Plane>::create(&Plane::update_GPS_10Hz,        10,    400, "update_GPS_10Hz"),
    AP_Task<Plane>::create(&Plane::navigate,               10,    150, "navigate"),
    AP_Task<Plane>::create(&Plane::update_compass,         10,    200, "update_compass"),
    AP_Task<Plane>::create(&Plane::read_airspeed,          10,    100, "read_airspeed"),
    AP_Task<Plane>::create(&Plane::update_alt,             10,    200, "update_alt"),
    AP_Task<Plane>::create(&Plane::adjust_altitude_target, 10,    200, "adjust_altitude_target"),
    AP_Task<Plane>::create(&Plane::afs_fs_check,           10,    100, "afs_fs_check"),
    AP_Task<Plane>::create(&Plane::gcs_update,             50,    500, "gcs_update"),
    AP_Task<Plane>::create(&Plane::gcs_data_stream_send,   50,    500, "gcs_data_stream_send"),
    AP_Task<Plane>::create(&Plane::update_events,          50,    150, "update_events"),
    AP_Task<Plane>::create(&Plane::read_battery,           10,    300, "read_battery"),
    AP_Task<Plane>::create(&Plane::compass_accumulate,     50,    200, "compass_accumulate"),
    AP_Task<Plane>::create(&Plane::barometer_accumulate,   50,    150, "barometer_accumulate"),
    AP_Task<Plane>::create(&Plane::update_notify,          50,    300, "update_notify"),
    AP_Task<Plane>::create(&Plane::read_rangefinder,       50,    100, "read_rangefinder"),
    AP_Task<Plane>::create(&Plane::ice_update,             10,    100, "ice_update"),
    AP_Task<Plane>::create(&Plane::compass_cal_update,     50,    50, "compass_cal_update"),
    AP_Task<Plane>::create(&Plane::accel_cal_update,       10,    50, "accel_cal_update"),
#if OPTFLOW == ENABLED
    AP_Task<Plane>::create(&Plane::update_optical_flow,    50,    50, "update_optical_flow"),
#endif
    AP_Task<Plane>::create(&Plane::one_second_loop,         1,    400, "one_second_loop"),
    AP_Task<Plane>::create(&Plane::check_long_failsafe,     3,    400, "check_long_failsafe"),
    AP_Task<Plane>::create(&Plane::read_receiver_rssi,     10,    100, "read_receiver_rssi"),
    AP_Task<Plane>::create(&Plane::rpm_update,             10,    100, "rpm_update"),
    AP_Task<Plane>::create(&Plane::airspeed_ratio_update,   1,    100, "airspeed_ratio_update"),
    AP_Task<Plane>::create(&Plane::update_mount,           50,    100, "update_mount"),
    AP_Task<Plane>::create(&Plane::update_trigger,         50,    100, "update_trigger"),
    AP_Task<Plane>::create(&Plane::log_perf_info,         0.2,    100, "log_perf_info"),
    AP_Task<Plane>::create(&Plane::compass_save,          0.1,    200, "compass_save"),
    AP_Task<Plane>::create(&Plane::Log_Write_Fast,         25,    300, "Log_Write_Fast"),
    AP_Task<Plane>::create(&Plane::update_logging1,        25,    300, "update_logging1"),
    AP_Task<Plane>::create(&Plane::update_logging2,        25,    300, "update_logging2"),
    AP_Task<Plane>::create(&Plane::update_soaring,         50,    400, "update_soaring"),
    AP_Task<Plane>::create(&Plane::parachute_check,        10,    200, "parachute_check"),
    AP_Task<Plane>::create(&Plane::terrain_update,         10,    200, "terrain_update"),
    AP_Task<Plane>::create(&Plane::update_is_flying_5Hz,    5,    100, "update_is_flying_5Hz"),
    AP_Task<Plane>::create(&Plane::dataflash_periodic,     50,    400, "dataflash_periodic"),
    AP_Task<Plane>::create(&Plane::avoidance_adsb_update,  10,    100, "avoidance_adsb_update"),
    AP_Task<Plane>::create(&Plane::button_update,           5,    100, "button_update"),
    AP_Task<Plane>::create(&Plane::stats_update,            1,    100, "stats_update"),
};
