 ...
 */
AP_Task Plane::scheduler_tasks[] = {
                           // Units:   Hz      us
    make_task("ahrs_update",            &plane, &Plane::ahrs_update,           400,    400),
    make_task("read_radio",             &plane, &Plane::read_radio,             50,    100),
    make_task("check_short_failsafe",   &plane, &Plane::check_short_failsafe,   50,    100),
    make_task("update_speed_height",    &plane, &Plane::update_speed_height,    50,    200),
    make_task("update_flight_mode",     &plane, &Plane::update_flight_mode,    400,    100),
    make_task("stabilize",              &plane, &Plane::stabilize,             400,    100),
    make_task("set_servos",             &plane, &Plane::set_servos,            400,    100),
    make_task("read_control_switch",    &plane, &Plane::read_control_switch,     7,    100),
    make_task("gcs_retry_deferred",     &plane, &Plane::gcs_retry_deferred,     50,    500),
    make_task("update_GPS_50Hz",        &plane, &Plane::update_GPS_50Hz,        50,    300),
    make_task("update_GPS_10Hz",        &plane, &Plane::update_GPS_10Hz,        10,    400),
    make_task("navigate",               &plane, &Plane::navigate,               10,    150),
    make_task("update_compass",         &plane, &Plane::update_compass,         10,    200),
    make_task("read_airspeed",          &plane, &Plane::read_airspeed,          10,    100),
    make_task("update_alt",             &plane, &Plane::update_alt,             10,    200),
    make_task("adjust_altitude_target", &plane, &Plane::adjust_altitude_target, 10,    200),
    make_task("afs_fs_check",           &plane, &Plane::afs_fs_check,           10,    100),
    make_task("gcs_update",             &plane, &Plane::gcs_update,             50,    500),
    make_task("gcs_data_stream_send",   &plane, &Plane::gcs_data_stream_send,   50,    500),
    make_task("update_events",          &plane, &Plane::update_events,          50,    150),
    make_task("read_battery",           &plane, &Plane::read_battery,           10,    300),
    make_task("compass_accumulate",     &plane, &Plane::compass_accumulate,     50,    200),
    make_task("barometer_accumulate",   &plane, &Plane::barometer_accumulate,   50,    150),
    make_task("update_notify",          &plane, &Plane::update_notify,          50,    300),
    make_task("read_rangefinder",       &plane, &Plane::read_rangefinder,       50,    100),
    make_task("ice_update",             &plane, &Plane::ice_update,             10,    100),
    make_task("compass_cal_update",     &plane, &Plane::compass_cal_update,     50,    50),
    make_task("accel_cal_update",       &plane, &Plane::accel_cal_update,       10,    50),
#if OPTFLOW == ENABLED
    make_task("update_optical_flow",    &plane, &Plane::update_optical_flow,    50,    50),
#endif
    make_task("one_second_loop",        &plane, &Plane::one_second_loop,         1,    400),
    make_task("check_long_failsafe",    &plane, &Plane::check_long_failsafe,     3,    400),
    make_task("read_receiver_rssi",     &plane, &Plane::read_receiver_rssi,     10,    100),
    make_task("rpm_update",             &plane, &Plane::rpm_update,             10,    100),
    make_task("airspeed_ratio_update",  &plane, &Plane::airspeed_ratio_update,   1,    100),
    make_task("update_mount",           &plane, &Plane::update_mount,           50,    100),
    make_task("update_trigger",         &plane, &Plane::update_trigger,         50,    100),
    make_task("log_perf_info",          &plane, &Plane::log_perf_info,         0.2,    100),
    make_task("compass_save",           &plane, &Plane::compass_save,          0.1,    200),
    make_task("Log_Write_Fast",         &plane, &Plane::Log_Write_Fast,         25,    300),
    make_task("update_logging1",        &plane, &Plane::update_logging1,        25,    300),
    make_task("update_logging2",        &plane, &Plane::update_logging2,        25,    300),
    make_task("update_soaring",         &plane, &Plane::update_soaring,         50,    400),
    make_task("parachute_check",        &plane, &Plane::parachute_check,        10,    200),
    make_task("terrain_update",         &plane, &Plane::terrain_update,         10,    200),
    make_task("update_is_flying_5Hz",   &plane, &Plane::update_is_flying_5Hz,    5,    100),
    make_task("dataflash_periodic",     &plane, &Plane::dataflash_periodic,     50,    400),
    make_task("ins_periodic",           &plane, &Plane::ins_periodic,           50,     50),
    make_task("avoidance_adsb_update",  &plane, &Plane::avoidance_adsb_update,  10,    100),
    make_task("button_update",          &plane, &Plane::button_update,           5,    100),
    make_task("stats_update",           &plane, &Plane::stats_update,            1,    100),
};
