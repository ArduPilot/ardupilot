...
private:
    ...
    // @yu array for save zeus servo info
    float save_voltage[16] = {0};
    float save_current[16] = {0};
    float save_temperature[16] = {0};
    float save_servo_error[16] = {0};
    ...
    //@yu zeus's servo use this info as servo's power info
    Canard::ObjCallback<AP_DroneCAN, uavcan_equipment_power_CircuitStatus> power_circuitStatus_cb{this, &AP_DroneCAN::handle_power_circuitStatus};
    Canard::Subscriber<uavcan_equipment_power_CircuitStatus> power_circuitStatus_listener{power_circuitStatus_cb, _driver_index};

    //@yu zeus's servo use this info as servo's temperature
    ...
    */
    ...
    void handle_power_circuitStatus(const CanardRxTransfer& transfer, const uavcan_equipment_power_CircuitStatus& msg);    //@yu call for zeus's servo
