 ...
 * PA1  - ZIO_D72 COMP1_IMP         (input pullup).
 * PA2  - PIN2                      (input pullup).
 * PA3  - ARD_A0 ADC1_IN4           (input pullup).
 ...
 * PA8  - ZIO_D70 I2C2_SMBAL        (input pullup).
 * PA9  - ZIO_D69 I2C2_SCL          (input pullup).
 * PA10 - ZIO_D68 I2C2_SDA          (input pullup).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_ZIO_D32) |        \
                                     ...
                                     PIN_MODE_INPUT(GPIOA_ZIO_D70) |        \
                                     PIN_MODE_INPUT(GPIOA_ZIO_D69) |        \
                                     PIN_MODE_INPUT(GPIOA_ZIO_D68) |        \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_ZIO_D32) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_ZIO_D72) |      \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOA_ZIO_D70) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_ZIO_D69) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_ZIO_D68) |      \
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_ZIO_D70, 0U) |       \
                                     PIN_AFIO_AF(GPIOA_ZIO_D69, 0U) |       \
                                     PIN_AFIO_AF(GPIOA_ZIO_D68, 0U) |       \
 ...
 * PB1  - ZIO_A6 ADC3_IN1           (input pullup).
 ...
 * GPIOC setup:
 *
 * PC0  - ARD_A1 ADC12_IN6          (input pullup).
 * PC1  - PIN1                      (input pullup).
 * PC2  - ZIO_A7 ADC12_IN8          (input pullup).
 * PC3  - ARD_A2 ADC12_IN9          (input pullup).
 * PC4  - ARD_D1 USART1_TX          (input pullup).
 * PC5  - ARD_D0 USART1_RX          (input pullup).
 * PC6  - ZIO_D16 I2S2_MCK          (input pullup).
 * PC7  - ZIO_D21 I2S3_MCK          (input pullup).
 * PC8  - ZIO_D43                   (input pullup).
 * PC9  - ZIO_D44 I2S_CKIN          (input pullup).
 * PC10 - ZIO_D45                   (input pullup).
 * PC11 - ZIO_D46                   (input pullup).
 * PC12 - ZIO_D47                   (input pullup).
 ...
 * PD11 - ARD_A3 ADC34_IN8          (input pullup).
 * PD12 - ARD_A4 ADC34_IN9          (input pullup).
 * PD13 - ARD_A5 ADC3_IN8           (input pullup).
...
#define VAL_GPIOD_MODER             (PIN_MODE_INPUT(GPIOD_ZIO_D67) |        \
                                     ...
                                     PIN_MODE_INPUT(GPIOD_ARD_A3) |         \
                                     PIN_MODE_INPUT(GPIOD_ARD_A4) |         \
                                     PIN_MODE_INPUT(GPIOD_ARD_A5) |         \
...
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_PULLUP(GPIOD_ZIO_D67) |      \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOD_ARD_A3) |       \
                                     PIN_PUPDR_PULLUP(GPIOD_ARD_A4) |       \
                                     PIN_PUPDR_PULLUP(GPIOD_ARD_A5) |       \
...
#define VAL_GPIOD_AFRH              (PIN_AFIO_AF(GPIOD_USART3_RX, 7U) |     \
                                     ...
                                     PIN_AFIO_AF(GPIOD_ARD_A3, 0U) |        \
                                     PIN_AFIO_AF(GPIOD_ARD_A4, 0U) |        \
                                     PIN_AFIO_AF(GPIOD_ARD_A5, 0U) |        \
 ...
 * PE2  - ZIO_D31 ZIO_D56           (input pullup).
 * PE3  - ZIO_D60                   (input pullup).
 * PE4  - ZIO_D57                   (input pullup).
 * PE5  - ZIO_D58                   (input pullup).
 * PE6  - ZIO_D59                   (input pullup).
 ...
 * PF3  - ZIO_D30                   (input pullup).
 * PF4  - ZIO_A8 ADC3_IN14          (input pullup).
 * PF5  - ZIO_D29                   (input pullup).
 * PF6  - PIN6                      (input pullup).
 * PF7  - ZIO_D62                   (input pullup).
 * PF8  - ZIO_D61                   (input pullup).
 * PF9  - ZIO_D63                   (input pullup).
 * PF10 - ZIO_D28                   (input pullup).
