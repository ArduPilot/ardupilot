...
/*
 * Setup for STMicroelectronics STM32 Nucleo64-U385RG-Q board.
 */
...
#define GPIOG_OSC_IN                0U
#define GPIOG_OSC_OUT               1U
...
#define LINE_VC_TX                  PAL_LINE(GPIOA, 9U)
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOC_PIN0) |       \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOC_VBUS_SENSE) |    \
 ...
 * GPIOG setup:
 *
 * PG0  - OSC_IN                    (input floating).
 * PG1  - OSC_OUT                   (input floating).
 ...
 */
#define VAL_GPIOG_MODER             (PIN_MODE_INPUT(GPIOG_OSC_IN) |         \
                                     PIN_MODE_INPUT(GPIOG_OSC_OUT) |        \
...
#define VAL_GPIOG_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOG_OSC_IN) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOG_OSC_OUT) |    \
...
#define VAL_GPIOG_OSPEEDR           (PIN_OSPEED_HIGH(GPIOG_OSC_IN) |        \
                                     PIN_OSPEED_HIGH(GPIOG_OSC_OUT) |       \
...
#define VAL_GPIOG_PUPDR             (PIN_PUPDR_FLOATING(GPIOG_OSC_IN) |     \
                                     PIN_PUPDR_FLOATING(GPIOG_OSC_OUT) |    \
...
#define VAL_GPIOG_ODR               (PIN_ODR_HIGH(GPIOG_OSC_IN) |           \
                                     PIN_ODR_HIGH(GPIOG_OSC_OUT) |          \
...
#define VAL_GPIOG_AFRL              (PIN_AFIO_AF(GPIOG_OSC_IN, 0U) |        \
                                     PIN_AFIO_AF(GPIOG_OSC_OUT, 0U) |       \
