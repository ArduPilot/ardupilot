...
/**
 * @file    STM32U0xx/stm32_isr.c
 * @brief   STM32U0xx ISR handler code.
 *
...
#include "stm32_usart3_lp1.inc"
#include "stm32_usart4_lp3.inc"
...
void irqInit(void) {
  ...
  usart3_lpuart1_irq_init();
  usart4_lpuart3_irq_init();
...
void irqDeinit(void) {
  ...
  usart3_lpuart1_irq_deinit();
  usart4_lpuart3_irq_deinit();
