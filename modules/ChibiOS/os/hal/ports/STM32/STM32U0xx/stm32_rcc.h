...
/**
 * @file    STM32U0xx/stm32_rcc.h
 * @brief   RCC helper driver header.
 * @note    This file requires definitions from the ST header file
 *          @p stm32u0xx.h.
 *
 * @addtogroup STM32U0xx_RCC
 * @{
 */
#ifndef STM32_RCC_H
#define STM32_RCC_H
 ...
 * @api
 */
#define rccEnableI2C4(lp) rccEnableAPBR1(RCC_APBENR1_I2C4EN, lp)
 ...
 * @api
 */
#define rccDisableI2C4() rccDisableAPBR1(RCC_APBENR1_I2C4EN)
 ...
 * @api
 */
#define rccResetI2C4() rccResetAPBR1(RCC_APBRSTR1_I2C4RST)
/** @} */
 ...
 * @api
 */
#define rccEnableLPTIM1(lp) rccEnableAPBR1(RCC_APBENR1_LPTIM1EN, lp)
 ...
 * @api
 */
#define rccDisableLPTIM1() rccDisableAPBR1(RCC_APBENR1_LPTIM1EN)
 ...
 * @api
 */
#define rccResetLPTIM1() rccResetAPBR1(RCC_APBRSTR1_LPTIM1RST)
 ...
 * @api
 */
#define rccEnableLPTIM2(lp) rccEnableAPBR1(RCC_APBENR1_LPTIM2EN, lp)
 ...
 * @api
 */
#define rccDisableLPTIM2() rccDisableAPBR1(RCC_APBENR1_LPTIM2EN)
 ...
 * @api
 */
#define rccResetLPTIM2() rccResetAPBR1(RCC_APBRSTR1_LPTIM2RST)

/**
 * @brief   Enables the LPTIM3 peripheral clock.
 *
 * @param[in] lp        low power enable flag
 *
 * @api
 */
#define rccEnableLPTIM3(lp) rccEnableAPBR1(RCC_APBENR1_LPTIM3EN, lp)

/**
 * @brief   Disables the LPTIM3 peripheral clock.
 *
 * @api
 */
#define rccDisableLPTIM3() rccDisableAPBR1(RCC_APBENR1_LPTIM3EN)

/**
 * @brief   Resets the LPTIM3 peripheral.
 *
 * @api
 */
#define rccResetLPTIM3() rccResetAPBR1(RCC_APBRSTR1_LPTIM3RST)
/** @} */
...
/**
 * @brief   Enables the LPUART3 peripheral clock.
 *
 * @param[in] lp        low power enable flag
 *
 * @api
 */
#define rccEnableLPUART3(lp) rccEnableAPBR1(RCC_APBENR1_LPUART3EN, lp)

/**
 * @brief   Disables the LPUART3 peripheral clock.
 *
 * @api
 */
#define rccDisableLPUART3() rccDisableAPBR1(RCC_APBENR1_LPUART3EN)

/**
 * @brief   Resets the LPUART3 peripheral.
 *
 * @api
 */
#define rccResetLPUART3() rccResetAPBR1(RCC_APBRSTR1_LPUART3RST)
/** @} */
