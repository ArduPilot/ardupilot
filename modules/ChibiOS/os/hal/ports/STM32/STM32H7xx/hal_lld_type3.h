...
/**
 * @file    STM32H7xx/hal_lld_type3.h
 ...
 *          - STM32H7A3xx, STM32H7B3xx very high-performance MCUs.
 *          - STM32H7A3xxQ, STM32H7B3xxQ very high-performance MCUs with SMPS.
 *          .
 *
 * @addtogroup HAL
 * @{
...
#ifndef HAL_LLD_TYPE3_H
#define HAL_LLD_TYPE3_H
...
#define PLATFORM_NAME           "STM32H7A3: M7@280MHz +DSP +FPU +OctoSPI +JPEG +TFTLCD +GRC -Crypto -SMPS"

#elif defined(STM32H7A3xxQ)
#define PLATFORM_NAME           "STM32H7A3: M7@280MHz +DSP +FPU +OctoSPI +JPEG +TFTLCD +GRC -Crypto +SMPS"

#elif defined(STM32H7B3xx)
#define PLATFORM_NAME           "STM32H7B3: M7@280MHz +DSP +FPU +OctoSPI +JPEG +TFTLCD +GRC +Crypto -SMPS"

#elif defined(STM32H7B3xxQ) || defined(__DOXYGEN__)
#define PLATFORM_NAME           "STM32H7B3: M7@280MHz +DSP +FPU +OctoSPI +JPEG +TFTLCD +GRC +Crypto +SMPS"
 ...
 */
#define STM32_SYSCLK_MAX                280000000

/**
 * @brief   Absolute maximum HCLK clock.
 */
#define STM32_HCLK_MAX                  (STM32_SYSCLK_MAX)
 ...
 *
 * @note Medium range VCO must be chosen, in case STM32_PLLx_VCO_CK < 2000000; wide range otherwise.
 * @note Medium range VCO is recommended to save power consumption.
 * @note Wide range VCO is chosen after reset.
 */
 ...
 */
#define STM32_CDPCLK_MAX                (STM32_HCLK_MAX)

/**
 * @brief   Maximum APB2 clock frequency.
 */
#define STM32_PCLK1_MAX                 (STM32_HCLK_MAX)

/**
 * @brief   Maximum APB3 clock frequency.
 */
#define STM32_PCLK2_MAX                 (STM32_HCLK_MAX)

/**
 * @brief   Maximum APB4 clock frequency.
 */
#define STM32_SRDPCLK_MAX               (STM32_HCLK_MAX)

/**
 * @brief   Maximum SPI1, SPI2 and SPI3 clock frequency.
 */
#define STM32_SPI123_MAX                (STM32_HCLK_MAX)

/**
 * @brief   Maximum SPI4, SPI5 and SPI6 clock frequency.
 */
#define STM32_SPI456_MAX                (STM32_HCLK_MAX)
 ...
 * @{
 */
#define RCC_CR_HSIDIV_VALUE(n)          ((n) << RCC_CR_HSIDIV_Pos)

#define RCC_CFGR_SW_VALUE(n)            ((n) << RCC_CFGR_SW_Pos)
#define RCC_CFGR_SWS_VALUE(n)           ((n) << RCC_CFGR_SWS_Pos)
#define RCC_CFGR_RTCPRE_VALUE(n)        ((n) << RCC_CFGR_RTCPRE_Pos)
#define RCC_CFGR_MCO1PRE_VALUE(n)       ((n) << RCC_CFGR_MCO1PRE_Pos)
#define RCC_CFGR_MCO1_VALUE(n)          ((n) << RCC_CFGR_MCO1_Pos)
#define RCC_CFGR_MCO2PRE_VALUE(n)       ((n) << RCC_CFGR_MCO2PRE_Pos)
#define RCC_CFGR_MCO2_VALUE(n)          ((n) << RCC_CFGR_MCO2_Pos)

#define RCC_CDCFGR1_CDHPRE_VALUE(n)     ((n) << RCC_CDCFGR1_CDHPRE_Pos)
#define RCC_CDCFGR1_CDCPRE_VALUE(n)     ((n) << RCC_CDCFGR1_CDCPRE_Pos)
#define RCC_CDCFGR1_CDPPRE_VALUE(n)     ((n) << RCC_CDCFGR1_CDPPRE_Pos)

#define RCC_CDCFGR2_CDPPRE1_VALUE(n)    ((n) << RCC_CDCFGR2_CDPPRE1_Pos)
#define RCC_CDCFGR2_CDPPRE2_VALUE(n)    ((n) << RCC_CDCFGR2_CDPPRE2_Pos)

#define RCC_SRDCFGR_SRDPPRE_VALUE(n)    ((n) << RCC_SRDCFGR_SRDPPRE_Pos)
...
#define RCC_PLL1DIVR_DIVN1_VALUE(n)     ((n) << RCC_PLL1DIVR_N1_Pos)
#define RCC_PLL1DIVR_DIVP1_VALUE(n)     ((n) << RCC_PLL1DIVR_P1_Pos)
#define RCC_PLL1DIVR_DIVQ1_VALUE(n)     ((n) << RCC_PLL1DIVR_Q1_Pos)
#define RCC_PLL1DIVR_DIVR1_VALUE(n)     ((n) << RCC_PLL1DIVR_R1_Pos)

#define RCC_PLL1FRACR_FRACN1_VALUE(n)   ((n) << RCC_PLL1FRACR_FRACN1_Pos)

#define RCC_PLL2DIVR_DIVN2_VALUE(n)     ((n) << RCC_PLL2DIVR_N2_Pos)
#define RCC_PLL2DIVR_DIVP2_VALUE(n)     ((n) << RCC_PLL2DIVR_P2_Pos)
#define RCC_PLL2DIVR_DIVQ2_VALUE(n)     ((n) << RCC_PLL2DIVR_Q2_Pos)
#define RCC_PLL2DIVR_DIVR2_VALUE(n)     ((n) << RCC_PLL2DIVR_R2_Pos)

#define RCC_PLL2FRACR_FRACN2_VALUE(n)   ((n) << RCC_PLL2FRACR_FRACN2_Pos)

#define RCC_PLL3DIVR_DIVN3_VALUE(n)     ((n) << RCC_PLL3DIVR_N3_Pos)
#define RCC_PLL3DIVR_DIVP3_VALUE(n)     ((n) << RCC_PLL3DIVR_P3_Pos)
#define RCC_PLL3DIVR_DIVQ3_VALUE(n)     ((n) << RCC_PLL3DIVR_Q3_Pos)
#define RCC_PLL3DIVR_DIVR3_VALUE(n)     ((n) << RCC_PLL3DIVR_R3_Pos)

#define RCC_PLL3FRACR_FRACN3_VALUE(n)   ((n) << RCC_PLL3FRACR_FRACN3_Pos)

#define RCC_CDCCIPR_CKPERSEL_VALUE(n)   ((n) << RCC_CDCCIPR_CKPERSEL_Pos)
#define RCC_CDCCIPR_SDMMCSEL_VALUE(n)   ((n) << RCC_CDCCIPR_SDMMCSEL_Pos)
#define RCC_CDCCIPR_OCTOSPISEL_VALUE(n) ((n) << RCC_CDCCIPR_OCTOSPISEL_Pos)
#define RCC_CDCCIPR_FMCSEL_VALUE(n)     ((n) << RCC_CDCCIPR_FMCSEL_Pos)

#define RCC_CDCCIP1R_SWPSEL_VALUE(n)    ((n) << RCC_CDCCIP1R_SWPSEL_Pos)
#define RCC_CDCCIP1R_FDCANSEL_VALUE(n)  ((n) << RCC_CDCCIP1R_FDCANSEL_Pos)
#define RCC_CDCCIP1R_DFSDM1SEL_VALUE(n) ((n) << RCC_CDCCIP1R_DFSDM1SEL_Pos)
#define RCC_CDCCIP1R_DFSDM2SEL_VALUE(n) ((n) << RCC_SRDCCIPR_DFSDM2SEL_Pos)
...
#define RCC_CDCCIP2R_CECSEL_VALUE(n)    ((n) << RCC_CDCCIP2R_CECSEL_Pos)
#define RCC_CDCCIP2R_USBSEL_VALUE(n)    ((n) << RCC_CDCCIP2R_USBSEL_Pos)
#define RCC_CDCCIP2R_I2C123SEL_VALUE(n) ((n) << RCC_CDCCIP2R_I2C123SEL_Pos)
#define RCC_CDCCIP2R_RNGSEL_VALUE(n)    ((n) << RCC_CDCCIP2R_RNGSEL_Pos)
#define RCC_CDCCIP2R_USART16910SEL_VALUE(n) ((n) << RCC_CDCCIP2R_USART16910SEL_Pos)
...
#define RCC_SRDCCIPR_LPTIM1SEL_VALUE(n) ((n) << RCC_SRDCCIPR_LPTIM1SEL_Pos)
#define RCC_SRDCCIPR_I2C4SEL_VALUE(n)   ((n) << RCC_SRDCCIPR_I2C4SEL_Pos)
#define RCC_SRDCCIPR_LPUART1SEL_VALUE(n) ((n) << RCC_SRDCCIPR_LPUART1SEL_Pos)
 ...
 * @{
 */
#define STM32_VOS_SCALE3                (0U)   /* default */
#define STM32_VOS_SCALE2                (PWR_D3CR_VOS_0)
#define STM32_VOS_SCALE1                (PWR_D3CR_VOS_1)
#define STM32_VOS_SCALE0                (PWR_D3CR_VOS_1 | PWR_D3CR_VOS_0)

#define STM32_SW_HSI_CK                 RCC_CFGR_SW_HSI
#define STM32_SW_CSI_CK                 RCC_CFGR_SW_CSI
#define STM32_SW_HSE_CK                 RCC_CFGR_SW_HSE
#define STM32_SW_PLL1_P_CK              RCC_CFGR_SW_PLL1

#define STM32_CDCPRE_DIV1               (0U)
#define STM32_CDCPRE_DIV2               RCC_CDCFGR1_CDCPRE_DIV2
...
#define STM32_CDHPRE_DIV4               RCC_CDCFGR1_HPRE_DIV4
#define STM32_CDHPRE_DIV8               RCC_CDCFGR1_HPRE_DIV8
#define STM32_CDHPRE_DIV16              RCC_CDCFGR1_HPRE_DIV16
#define STM32_CDHPRE_DIV64              RCC_CDCFGR1_HPRE_DIV64
#define STM32_CDHPRE_DIV128             RCC_CDCFGR1_HPRE_DIV128
#define STM32_CDHPRE_DIV256             RCC_CDCFGR1_HPRE_DIV256
#define STM32_CDHPRE_DIV512             RCC_CDCFGR1_HPRE_DIV512

#define STM32_CDPPRE_DIV1               (0U)
#define STM32_CDPPRE_DIV2               RCC_CDCFGR1_CDPPRE_DIV2
#define STM32_CDPPRE_DIV4               RCC_CDCFGR1_CDPPRE_DIV4
#define STM32_CDPPRE_DIV8               RCC_CDCFGR1_CDPPRE_DIV8
#define STM32_CDPPRE_DIV16              RCC_CDCFGR1_CDPPRE_DIV16

#define STM32_CDPPRE1_DIV1              (0U)
#define STM32_CDPPRE1_DIV2              RCC_CDCFGR2_CDPPRE1_DIV2
#define STM32_CDPPRE1_DIV4              RCC_CDCFGR2_CDPPRE1_DIV4
#define STM32_CDPPRE1_DIV8              RCC_CDCFGR2_CDPPRE1_DIV8
#define STM32_CDPPRE1_DIV16             RCC_CDCFGR2_CDPPRE1_DIV16

#define STM32_CDPPRE2_DIV1              (0U)
#define STM32_CDPPRE2_DIV2              RCC_CDCFGR2_CDPPRE2_DIV2
#define STM32_CDPPRE2_DIV4              RCC_CDCFGR2_CDPPRE2_DIV4
#define STM32_CDPPRE2_DIV8              RCC_CDCFGR2_CDPPRE2_DIV8
#define STM32_CDPPRE2_DIV16             RCC_CDCFGR2_CDPPRE2_DIV16
...
#define STM32_HSIDIV_DIV1               RCC_CR_HSIDIV_1
#define STM32_HSIDIV_DIV2               RCC_CR_HSIDIV_2
#define STM32_HSIDIV_DIV4               RCC_CR_HSIDIV_4
#define STM32_HSIDIV_DIV8               RCC_CR_HSIDIV_8
...
#define STM32_STOPWUCK_ENABLED          RCC_CFGR_STOPWUCK
...
#define STM32_CKPERSEL_HSI_CK           RCC_CDCCIPR_CKPERSEL_VALUE(0U)
#define STM32_CKPERSEL_CSI_CK           RCC_CDCCIPR_CKPERSEL_VALUE(1U)
#define STM32_CKPERSEL_HSE_CK           RCC_CDCCIPR_CKPERSEL_VALUE(2U)

#define STM32_SDMMCSEL_PLL1_Q_CK        RCC_CDCCIPR_SDMMCSEL_VALUE(0U)
#define STM32_SDMMCSEL_PLL2_R_CK        RCC_CDCCIPR_SDMMCSEL_VALUE(1U)

#define STM32_OCTOSPISEL_HCLK           RCC_CDCCIPR_OCTOSPISEL_VALUE(0U)
#define STM32_OCTOSPISEL_PLL1_Q_CK      RCC_CDCCIPR_OCTOSPISEL_VALUE(1U)
#define STM32_OCTOSPISEL_PLL2_R_CK      RCC_CDCCIPR_OCTOSPISEL_VALUE(2U)
#define STM32_OCTOSPISEL_PER_CK         RCC_CDCCIPR_OCTOSPISEL_VALUE(3U)

#define STM32_FMCSEL_HCLK               RCC_CDCCIPR_FMCSEL_VALUE(0U)
#define STM32_FMCSEL_PLL1_Q_CK          RCC_CDCCIPR_FMCSEL_VALUE(1U)
#define STM32_FMCSEL_PLL2_R_CK          RCC_CDCCIPR_FMCSEL_VALUE(2U)
#define STM32_FMCSEL_PER_CK             RCC_CDCCIPR_FMCSEL_VALUE(3U)

#define STM32_SWPSEL_PCLK1              RCC_CDCCIP1R_SWPSEL_VALUE(0U)
#define STM32_SWPSEL_HSI_KER_CK         RCC_CDCCIP1R_SWPSEL_VALUE(1U)

#define STM32_FDCANSEL_HSE_CK           RCC_CDCCIP1R_FDCANSEL_VALUE(0U)
#define STM32_FDCANSEL_PLL1_Q_CK        RCC_CDCCIP1R_FDCANSEL_VALUE(1U)
#define STM32_FDCANSEL_PLL2_Q_CK        RCC_CDCCIP1R_FDCANSEL_VALUE(2U)

#define STM32_DFSDM1SEL_PCLK2           RCC_CDCCIP1R_DFSDM1SEL_VALUE(0U)
#define STM32_DFSDM1SEL_SYS_CK          RCC_CDCCIP1R_DFSDM1SEL_VALUE(1U)

#define STM32_DFSDM2SEL_PCLK4           RCC_CDCCIP1R_DFSDM2SEL_VALUE(0U)
#define STM32_DFSDM2SEL_SYS_CK          RCC_CDCCIP1R_DFSDM2SEL_VALUE(1U)

#define STM32_SPDIFSEL_PLL1_Q_CK        RCC_CDCCIP1R_SPDIFSEL_VALUE(0U)
#define STM32_SPDIFSEL_PLL2_R_CK        RCC_CDCCIP1R_SPDIFSEL_VALUE(1U)
#define STM32_SPDIFSEL_PLL3_R_CK        RCC_CDCCIP1R_SPDIFSEL_VALUE(2U)
#define STM32_SPDIFSEL_HSI_KET_CLK      RCC_CDCCIP1R_SPDIFSEL_VALUE(3U)

#define STM32_SPI45SEL_PCLK2            RCC_CDCCIP1R_SPI45SEL_VALUE(0U)
#define STM32_SPI45SEL_PLL2_Q_CK        RCC_CDCCIP1R_SPI45SEL_VALUE(1U)
#define STM32_SPI45SEL_PLL3_Q_CK        RCC_CDCCIP1R_SPI45SEL_VALUE(2U)
#define STM32_SPI45SEL_HSI_KER_CK       RCC_CDCCIP1R_SPI45SEL_VALUE(3U)
#define STM32_SPI45SEL_CSI_KER_CK       RCC_CDCCIP1R_SPI45SEL_VALUE(4U)
#define STM32_SPI45SEL_HSE_CK           RCC_CDCCIP1R_SPI45SEL_VALUE(5U)

#define STM32_SPI123SEL_PLL1_Q_CK       RCC_CDCCIP1R_SPI123SEL_VALUE(0U)
#define STM32_SPI123SEL_PLL2_P_CK       RCC_CDCCIP1R_SPI123SEL_VALUE(1U)
#define STM32_SPI123SEL_PLL3_P_CK       RCC_CDCCIP1R_SPI123SEL_VALUE(2U)
#define STM32_SPI123SEL_I2S_CKIN        RCC_CDCCIP1R_SPI123SEL_VALUE(3U)
#define STM32_SPI123SEL_PER_CK          RCC_CDCCIP1R_SPI123SEL_VALUE(4U)

#define STM32_SAI1SEL_PLL1_Q_CK         RCC_CDCCIP1R_SAI1SEL_VALUE(0U)
#define STM32_SAI1SEL_PLL2_P_CK         RCC_CDCCIP1R_SAI1SEL_VALUE(1U)
#define STM32_SAI1SEL_PLL3_P_CK         RCC_CDCCIP1R_SAI1SEL_VALUE(2U)
#define STM32_SAI1SEL_I2S_CKIN          RCC_CDCCIP1R_SAI1SEL_VALUE(3U)
#define STM32_SAI1SEL_PER_CK            RCC_CDCCIP1R_SAI1SEL_VALUE(4U)

#define STM32_LPTIM1SEL_PCLK1           RCC_CDCCIP2R_LPTIM1SEL_VALUE(0U)
#define STM32_LPTIM1SEL_PLL2_P_CK       RCC_CDCCIP2R_LPTIM1SEL_VALUE(1U)
#define STM32_LPTIM1SEL_PLL3_R_CK       RCC_CDCCIP2R_LPTIM1SEL_VALUE(2U)
#define STM32_LPTIM1SEL_LSE_CK          RCC_CDCCIP2R_LPTIM1SEL_VALUE(3U)
#define STM32_LPTIM1SEL_LSI_CK          RCC_CDCCIP2R_LPTIM1SEL_VALUE(4U)
#define STM32_LPTIM1SEL_PER_CK          RCC_CDCCIP2R_LPTIM1SEL_VALUE(5U)

#define STM32_CECSEL_LSE_CK             RCC_CDCCIP2R_CECSEL_VALUE(0U)
#define STM32_CECSEL_LSI_CK             RCC_CDCCIP2R_CECSEL_VALUE(1U)
#define STM32_CECSEL_CSI_KER_CK         RCC_CDCCIP2R_CECSEL_VALUE(2U)
#define STM32_CECSEL_DISABLE            RCC_CDCCIP2R_CECSEL_VALUE(3U)

#define STM32_USBSEL_DISABLE            RCC_CDCCIP2R_USBSEL_VALUE(0U)
#define STM32_USBSEL_PLL1_Q_CK          RCC_CDCCIP2R_USBSEL_VALUE(1U)
#define STM32_USBSEL_PLL3_Q_CK          RCC_CDCCIP2R_USBSEL_VALUE(2U)
#define STM32_USBSEL_HSI48_CK           RCC_CDCCIP2R_USBSEL_VALUE(3U)

#define STM32_I2C123SEL_PCLK1           RCC_CDCCIP2R_I2C123SEL_VALUE(0U)
#define STM32_I2C123SEL_PLL3_R_CK       RCC_CDCCIP2R_I2C123SEL_VALUE(1U)
#define STM32_I2C123SEL_HSI_KER_CK      RCC_CDCCIP2R_I2C123SEL_VALUE(2U)
#define STM32_I2C123SEL_CSI_KER_CK      RCC_CDCCIP2R_I2C123SEL_VALUE(3U)

#define STM32_RNGSEL_HSI48_CK           RCC_CDCCIP2R_RNGSEL_VALUE(0U)
#define STM32_RNGSEL_PLL1_Q_CK          RCC_CDCCIP2R_RNGSEL_VALUE(1U)
#define STM32_RNGSEL_LSE_CK             RCC_CDCCIP2R_RNGSEL_VALUE(2U)
#define STM32_RNGSEL_LSI_CK             RCC_CDCCIP2R_RNGSEL_VALUE(3U)

#define STM32_USART16910SEL_PCLK2       RCC_CDCCIP2R_USART16910SEL_VALUE(0U)
#define STM32_USART16910SEL_PLL2_Q_CK   RCC_CDCCIP2R_USART16910SEL_VALUE(1U)
#define STM32_USART16910SEL_PLL3_Q_CK   RCC_CDCCIP2R_USART16910SEL_VALUE(2U)
#define STM32_USART16910SEL_HSI_KER_CK  RCC_CDCCIP2R_USART16910SEL_VALUE(3U)
#define STM32_USART16910SEL_CSI_KER_CK  RCC_CDCCIP2R_USART16910SEL_VALUE(4U)
#define STM32_USART16910SEL_LSE_CK      RCC_CDCCIP2R_USART16910SEL_VALUE(5U)

#define STM32_USART234578SEL_PCLK1      RCC_CDCCIP2R_USART234578SEL_VALUE(0U)
#define STM32_USART234578SEL_PLL2_Q_CK  RCC_CDCCIP2R_USART234578SEL_VALUE(1U)
#define STM32_USART234578SEL_PLL3_Q_CK  RCC_CDCCIP2R_USART234578SEL_VALUE(2U)
#define STM32_USART234578SEL_HSI_KER_CK RCC_CDCCIP2R_USART234578SEL_VALUE(3U)
#define STM32_USART234578SEL_CSI_KER_CK RCC_CDCCIP2R_USART234578SEL_VALUE(4U)
#define STM32_USART234578SEL_LSE_CK     RCC_CDCCIP2R_USART234578SEL_VALUE(5U)

#define STM32_SPI6SEL_PCLK4             RCC_SRDCCIPR_SPI6SEL_VALUE(0U)
#define STM32_SPI6SEL_PLL2_Q_CK         RCC_SRDCCIPR_SPI6SEL_VALUE(1U)
#define STM32_SPI6SEL_PLL3_Q_CK         RCC_SRDCCIPR_SPI6SEL_VALUE(2U)
#define STM32_SPI6SEL_HSI_KER_CK        RCC_SRDCCIPR_SPI6SEL_VALUE(3U)
#define STM32_SPI6SEL_CSI_KER_CK        RCC_SRDCCIPR_SPI6SEL_VALUE(4U)
#define STM32_SPI6SEL_HSE_CK            RCC_SRDCCIPR_SPI6SEL_VALUE(5U)

#define STM32_SAI2BSEL_PLL1_Q_CK        RCC_CDCCIP1R_SAI2BSEL_VALUE(0U)
#define STM32_SAI2BSEL_PLL2_P_CK        RCC_CDCCIP1R_SAI2BSEL_VALUE(1U)
#define STM32_SAI2BSEL_PLL3_P_CK        RCC_CDCCIP1R_SAI2BSEL_VALUE(2U)
#define STM32_SAI2BSEL_I2S_CKIN         RCC_CDCCIP1R_SAI2BSEL_VALUE(3U)
#define STM32_SAI2BSEL_PER_CK           RCC_CDCCIP1R_SAI2BSEL_VALUE(4U)

#define STM32_SAI2ASEL_PLL1_Q_CK        RCC_CDCCIP1R_SAI2ASEL_VALUE(0U)
#define STM32_SAI2ASEL_PLL2_P_CK        RCC_CDCCIP1R_SAI2ASEL_VALUE(1U)
#define STM32_SAI2ASEL_PLL3_P_CK        RCC_CDCCIP1R_SAI2ASEL_VALUE(2U)
#define STM32_SAI2ASEL_I2S_CKIN         RCC_CDCCIP1R_SAI2ASEL_VALUE(3U)
#define STM32_SAI2ASEL_PER_CK           RCC_CDCCIP1R_SAI2ASEL_VALUE(4U)

#define STM32_ADCSEL_PLL2_P_CK          RCC_SRDCCIPR_ADCSEL_VALUE(0U)
#define STM32_ADCSEL_PLL3_R_CK          RCC_SRDCCIPR_ADCSEL_VALUE(1U)
#define STM32_ADCSEL_PER_CK             RCC_SRDCCIPR_ADCSEL_VALUE(2U)
#define STM32_ADCSEL_DISABLE            RCC_SRDCCIPR_ADCSEL_VALUE(3U)

#define STM32_LPTIM3SEL_PCLK4           RCC_SRDCCIPR_LPTIM3SEL_VALUE(0U)
#define STM32_LPTIM3SEL_PLL2_P_CK       RCC_SRDCCIPR_LPTIM3SEL_VALUE(1U)
#define STM32_LPTIM3SEL_PLL3_P_CK       RCC_SRDCCIPR_LPTIM3SEL_VALUE(2U)
#define STM32_LPTIM3SEL_LSE_CK          RCC_SRDCCIPR_LPTIM3SEL_VALUE(3U)
#define STM32_LPTIM3SEL_LSI_CK          RCC_SRDCCIPR_LPTIM3SEL_VALUE(4U)
#define STM32_LPTIM3SEL_PER_CK          RCC_SRDCCIPR_LPTIM3SEL_VALUE(5U)

#define STM32_LPTIM2SEL_PCLK4           RCC_SRDCCIPR_LPTIM2SEL_VALUE(0U)
#define STM32_LPTIM2SEL_PLL2_P_CK       RCC_SRDCCIPR_LPTIM2SEL_VALUE(1U)
#define STM32_LPTIM2SEL_PLL3_P_CK       RCC_SRDCCIPR_LPTIM2SEL_VALUE(2U)
#define STM32_LPTIM2SEL_LSE_CK          RCC_SRDCCIPR_LPTIM2SEL_VALUE(3U)
#define STM32_LPTIM2SEL_LSI_CK          RCC_SRDCCIPR_LPTIM2SEL_VALUE(4U)
#define STM32_LPTIM2SEL_PER_CK          RCC_SRDCCIPR_LPTIM2SEL_VALUE(5U)

#define STM32_I2C4SEL_PCLK4             RCC_SRDCCIPR_I2C4SEL_VALUE(0U)
#define STM32_I2C4SEL_PLL3_R_CK         RCC_SRDCCIPR_I2C4SEL_VALUE(1U)
#define STM32_I2C4SEL_HSI_KER_CK        RCC_SRDCCIPR_I2C4SEL_VALUE(2U)
#define STM32_I2C4SEL_CSI_KER_CK        RCC_SRDCCIPR_I2C4SEL_VALUE(3U)

#define STM32_LPUART1SEL_PCLK4          RCC_SRDCCIPR_LPUART1SEL_VALUE(0U)
#define STM32_LPUART1SEL_PLL2_Q_CK      RCC_SRDCCIPR_LPUART1SEL_VALUE(1U)
#define STM32_LPUART1SEL_PLL3_Q_CK      RCC_SRDCCIPR_LPUART1SEL_VALUE(2U)
#define STM32_LPUART1SEL_HSI_KER_CK     RCC_SRDCCIPR_LPUART1SEL_VALUE(3U)
#define STM32_LPUART1SEL_CSI_KER_CK     RCC_SRDCCIPR_LPUART1SEL_VALUE(4U)
#define STM32_LPUART1SEL_LSE_CK         RCC_SRDCCIPR_LPUART1SEL_VALUE(5U)
/** @} */
...
/**
 * @brief   VOS setting.
 * @note    STM32_VOS_SCALE3 after reset.
 */
 ...
 * @note    The allowed values are 1..63. 32 after reset.
 */
 ...
 * @note    The allowed values are 8..420. 129 after reset.
 */
#if !defined(STM32_PLL1_DIVN_VALUE) || defined(__DOXYGEN__)
#define STM32_PLL1_DIVN_VALUE               129
#endif

/**
 * @brief   PLL1 FRACN multiplier.
 * @note    The allowed values are 0..8191. 0 after reset.
 */
 ...
 * @note    The allowed values are 8..420. 128 after reset.
 */
...
/**
 * @brief   Clock domain core bus prescaler.
 * @note    This setting can be modified at runtime.
 */
#if !defined(STM32_CDCPRE) || defined(__DOXYGEN__)
#define STM32_CDCPRE                        STM32_CDCPRE_DIV1
#endif
 ...
 * @note    This setting can be modified at runtime.
 */
#if !defined(STM32_CDHPRE) || defined(__DOXYGEN__)
#define STM32_CDHPRE                        STM32_CDHPRE_DIV1
#endif
 ...
 * @note    This setting can be modified at runtime.
 */
#if !defined(STM32_CDPPRE1) || defined(__DOXYGEN__)
#define STM32_CDPPRE1                       STM32_CDPPRE1_DIV1
#endif
 ...
 * @note    This setting can be modified at runtime.
 */
#if !defined(STM32_CDPPRE2) || defined(__DOXYGEN__)
#define STM32_CDPPRE2                       STM32_CDPPRE2_DIV1
#endif
...
#define STM32_LPTIM3SEL                     STM32_LPTIM3SEL_PCLK4
#endif
...
#if defined(STM32H7A3xx) && !defined(STM32H7A3_MCUCONF)
#error "Using a wrong mcuconf.h file, STM32H7A3_MCUCONF not defined"
#endif

#if defined(STM32H7B3xx) && !defined(STM32H7B3_MCUCONF)
...
#define STM32_SDMMC_MAXCLK          280000000U
#define STM32_0WS_THRESHOLD         42000000U
#define STM32_1WS_THRESHOLD         84000000U
#define STM32_2WS_THRESHOLD         126000000U
#define STM32_3WS_THRESHOLD         168000000U
#define STM32_4WS_THRESHOLD         210000000U
#define STM32_5WS_THRESHOLD         256000000U
#define STM32_6WS_THRESHOLD         280000000U
...
#define STM32_0WS_THRESHOLD         38000000U
#define STM32_1WS_THRESHOLD         76000000U
#define STM32_2WS_THRESHOLD         114000000U
#define STM32_3WS_THRESHOLD         152000000U
#define STM32_4WS_THRESHOLD         190000000U
#define STM32_5WS_THRESHOLD         225000000U
#define STM32_6WS_THRESHOLD         225000000U
#define STM32_PLLOUT_MAX            400000000U
#define STM32_PLLOUT_MIN            1500000U

#elif STM32_VOS == STM32_VOS_SCALE2
#define STM32_SDMMC_MAXCLK          160000000U
#define STM32_0WS_THRESHOLD         34000000U
#define STM32_1WS_THRESHOLD         68000000U
#define STM32_2WS_THRESHOLD         102000000U
#define STM32_3WS_THRESHOLD         136000000U
#define STM32_4WS_THRESHOLD         160000000U
#define STM32_5WS_THRESHOLD         160000000U
#define STM32_6WS_THRESHOLD         160000000U
#define STM32_PLLOUT_MAX            300000000U
#define STM32_PLLOUT_MIN            1500000U

#elif STM32_VOS == STM32_VOS_SCALE3
#define STM32_SDMMC_MAXCLK          88000000U
#define STM32_0WS_THRESHOLD         22000000U
#define STM32_1WS_THRESHOLD         44000000U
#define STM32_2WS_THRESHOLD         66000000U
#define STM32_3WS_THRESHOLD         88000000U
#define STM32_4WS_THRESHOLD         88000000U
#define STM32_5WS_THRESHOLD         88000000U
#define STM32_6WS_THRESHOLD         88000000U
 ...
 */
    ...
    defined(__DOXYGEN__)
#  define STM32_PLL1_DIVM           (STM32_PLL1_DIVM_VALUE << RCC_PLLCKSELR_DIVM1_Pos)
...
/*
 * @brief   PLL1 VCO mode.
 * @note    The wide range PLL is used by default after reset.
 * @note    The medium range PLL uses less power.
 * @note    A high PLL input clock forces the wide range PLL, a low clock forces the medium range PLL.
 */
#if (STM32_PLL1_REF_CK < STM32_PLLIN_THRESHOLD1)
#  define STM32_PLLCFGR_PLL1VCOSEL  RCC_PLLCFGR_PLL1VCOSEL   /* medium range */
#else
#  define STM32_PLLCFGR_PLL1VCOSEL  0U   /* wide range */
#endif

/*
 * @brief   PLL1 input frequency range check.
 */
#if ((STM32_PLLCFGR_PLL1VCOSEL == RCC_PLLCFGR_PLL1VCOSEL) && (STM32_PLL1_REF_CK < STM32_PLLIN_MIN))
#  error "STM32_PLL1_REF_CK lower then the medium range PLL allows (< STM32_PLLIN_MIN)"
#elif ((STM32_PLLCFGR_PLL1VCOSEL == 0U) && (STM32_PLL1_REF_CK > STM32_PLLIN_MAX))
#  error "STM32_PLL1_REF_CK higher then the wide range PLL allows (> STM32_PLLIN_MAX)"
#endif
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL2_DIVM             (STM32_PLL2_DIVM_VALUE << RCC_PLLCKSELR_DIVM2_Pos)
...
#  define STM32_PLLCFGR_PLL2VCOSEL  RCC_PLLCFGR_PLL2VCOSEL   /* medium range */
#else
#  define STM32_PLLCFGR_PLL2VCOSEL  0U   /* wide range */
#endif

/*
 * @brief   PLL2 input frequency range check.
 */
#if ((STM32_PLLCFGR_PLL2VCOSEL == RCC_PLLCFGR_PLL2VCOSEL) && (STM32_PLL2_REF_CK < STM32_PLLIN_MIN))
#  error "STM32_PLL2_REF_CK lower then the medium range PLL allows (< STM32_PLLIN_MIN)"
#elif ((STM32_PLLCFGR_PLL2VCOSEL == 0U) && (STM32_PLL2_REF_CK > STM32_PLLIN_MAX))
#  error "STM32_PLL2_REF_CK higher then the wide range PLL allows (> STM32_PLLIN_MAX)"
#endif
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL3_DIVM             (STM32_PLL3_DIVM_VALUE << RCC_PLLCKSELR_DIVM3_Pos)
...
#  define STM32_PLLCFGR_PLL3VCOSEL  RCC_PLLCFGR_PLL3VCOSEL   /* medium range */
#else
#  define STM32_PLLCFGR_PLL3VCOSEL  0U   /* wide range */
#endif

/*
 * @brief   PLL3 input frequency range check.
 */
#if ((STM32_PLLCFGR_PLL3VCOSEL == RCC_PLLCFGR_PLL3VCOSEL) && (STM32_PLL3_REF_CK < STM32_PLLIN_MIN))
#  error "STM32_PLL3_REF_CK lower then the medium range PLL allows (< STM32_PLLIN_MIN)"
#elif ((STM32_PLLCFGR_PLL3VCOSEL == 0U) && (STM32_PLL3_REF_CK > STM32_PLLIN_MAX))
#  error "STM32_PLL3_REF_CK higher then the wide range PLL allows (> STM32_PLLIN_MAX)"
#endif
 ...
 */
#if ((STM32_PLL1_DIVN_VALUE >= 8) && (STM32_PLL1_DIVN_VALUE <= 420)) ||    \
    defined(__DOXYGEN__)
#define STM32_PLL1_DIVN             ((STM32_PLL1_DIVN_VALUE - 1U) << RCC_PLL1DIVR_N1_Pos)
#else
 ...
 */
#if ((STM32_PLL2_DIVN_VALUE >= 8) && (STM32_PLL2_DIVN_VALUE <= 420)) ||    \
    defined(__DOXYGEN__)
#define STM32_PLL2_DIVN             ((STM32_PLL2_DIVN_VALUE - 1U) << RCC_PLL2DIVR_N2_Pos)
#else
 ...
 */
#if ((STM32_PLL3_DIVN_VALUE >= 8) && (STM32_PLL3_DIVN_VALUE <= 420)) ||    \
    defined(__DOXYGEN__)
#define STM32_PLL3_DIVN             ((STM32_PLL3_DIVN_VALUE - 1U) << RCC_PLL3DIVR_N3_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL1_FRACN             (STM32_PLL1_FRACN_VALUE << RCC_PLL1FRACR_FRACN1_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL2_FRACN             (STM32_PLL2_FRACN_VALUE << RCC_PLL2FRACR_FRACN2_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL3_FRACN             (STM32_PLL3_FRACN_VALUE << RCC_PLL3FRACR_FRACN3_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL1_DIVQ             ((STM32_PLL1_DIVQ_VALUE - 1U) << RCC_PLL1DIVR_Q1_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL2_DIVQ             ((STM32_PLL2_DIVQ_VALUE - 1U) << RCC_PLL2DIVR_Q2_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL3_DIVQ             ((STM32_PLL3_DIVQ_VALUE - 1U) << RCC_PLL3DIVR_Q3_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL1_DIVR             ((STM32_PLL1_DIVR_VALUE - 1U) << RCC_PLL1DIVR_R1_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL2_DIVR             ((STM32_PLL2_DIVR_VALUE - 1U) << RCC_PLL2DIVR_R2_Pos)
#else
 ...
 */
    ...
    defined(__DOXYGEN__)
#define STM32_PLL3_DIVR             ((STM32_PLL3_DIVR_VALUE - 1U) << RCC_PLL3DIVR_R3_Pos)
#else
...
/*
 * @brief   PLL1 VCO frequency range check.
 * @note    The P output can be selected as sys_ck.
 */
#if STM32_PLLCFGR_PLL1VCOSEL == 0U   /* wide range PLL */
...
/*
 * @brief   PLL2 VCO frequency range check.
 */
#if STM32_PLLCFGR_PLL2VCOSEL == 0U   /* wide range PLL */
...
/*
 * @brief   PLL3 VCO frequency range check.
 */
#if STM32_PLLCFGR_PLL3VCOSEL == 0U   /* wide range PLL */
 ...
 * @brief   CDCPRE clock.
 */
#if (STM32_CDCPRE == STM32_CDCPRE_DIV1) || defined(__DOXYGEN__)
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 1U)
#elif STM32_CDCPRE == STM32_CDCPRE_DIV2
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 2U)
#elif STM32_CDCPRE == STM32_CDCPRE_DIV4
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 4U)
#elif STM32_CDCPRE == STM32_CDCPRE_DIV8
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 8U)
#elif STM32_CDCPRE == STM32_CDCPRE_DIV16
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 16U)
#elif STM32_CDCPRE == STM32_CDCPRE_DIV64
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 64U)
#elif STM32_CDCPRE == STM32_CDCPRE_DIV128
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 128U)
#elif STM32_CDCPRE == STM32_CDCPRE_DIV256
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 256U)
#elif STM32_CDCPRE == STM32_CDCPRE_DIV512
#define STM32_SYS_CDCPRE_CK         (STM32_SYS_CK / 512U)
#else
#error "invalid STM32_CDCPRE value specified"
#endif

/**
 * @brief   HCLK clock.
 */
#if (STM32_CDHPRE == STM32_CDHPRE_DIV1) || defined(__DOXYGEN__)
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 1U)
#elif STM32_CDHPRE == STM32_CDHPRE_DIV2
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 2U)
#elif STM32_CDHPRE == STM32_CDHPRE_DIV4
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 4U)
#elif STM32_CDHPRE == STM32_CDHPRE_DIV8
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 8U)
#elif STM32_CDHPRE == STM32_CDHPRE_DIV16
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 16U)
#elif STM32_CDHPRE == STM32_CDHPRE_DIV64
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 64U)
#elif STM32_CDHPRE == STM32_CDHPRE_DIV128
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 128U)
#elif STM32_CDHPRE == STM32_CDHPRE_DIV256
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 256U)
#elif STM32_CDHPRE == STM32_CDHPRE_DIV512
#define STM32_HCLK                  (STM32_SYS_CDCPRE_CK / 512U)
#else
#error "invalid STM32_CDHPRE value specified"
#endif
 ...
 * @brief   Core 1 clock.
 */
#define STM32_CORE1_CK              STM32_SYS_CDCPRE_CK
 ...
 * @brief   CD PCLK clock.
 */
#if (STM32_CDPPRE == STM32_CDPPRE_DIV1) || defined(__DOXYGEN__)
#define STM32_CDPCLK                (STM32_HCLK / 1U)
#elif STM32_CDPPRE == STM32_CDPPRE_DIV2
#define STM32_CDPCLK                (STM32_HCLK / 2U)
#elif STM32_CDPPRE == STM32_CDPPRE_DIV4
#define STM32_CDPCLK                (STM32_HCLK / 4U)
#elif STM32_CDPPRE == STM32_CDPPRE_DIV8
#define STM32_CDPCLK                (STM32_HCLK / 8U)
#elif STM32_CDPPRE == STM32_CDPPRE_DIV16
#define STM32_CDPCLK                (STM32_HCLK / 16U)
#else
#error "invalid STM32_CDPPRE value specified"
#endif
 ...
 * @brief   CD PCLK clock.
 */
#if (STM32_CDPPRE1 == STM32_CDPPRE1_DIV1) || defined(__DOXYGEN__)
#define STM32_PCLK1                 (STM32_HCLK / 1U)
#elif STM32_CDPPRE1 == STM32_CDPPRE1_DIV2
#define STM32_PCLK1                 (STM32_HCLK / 2U)
#elif STM32_CDPPRE1 == STM32_CDPPRE1_DIV4
#define STM32_PCLK1                 (STM32_HCLK / 4U)
#elif STM32_CDPPRE1 == STM32_CDPPRE1_DIV8
#define STM32_PCLK1                 (STM32_HCLK / 8U)
#elif STM32_CDPPRE1 == STM32_CDPPRE1_DIV16
#define STM32_PCLK1                 (STM32_HCLK / 16U)
#else
#error "invalid STM32_CDPPRE1 value specified"
#endif

/*
 * @brief   CD PCLK1 frequency check.
 */
...
/**
 * @brief   CD PCLK2 clock.
 */
#if (STM32_CDPPRE2 == STM32_CDPPRE2_DIV1) || defined(__DOXYGEN__)
#define STM32_PCLK2                 (STM32_HCLK / 1U)
#elif STM32_CDPPRE2 == STM32_CDPPRE2_DIV2
#define STM32_PCLK2                 (STM32_HCLK / 2U)
#elif STM32_CDPPRE2 == STM32_CDPPRE2_DIV4
#define STM32_PCLK2                 (STM32_HCLK / 4U)
#elif STM32_CDPPRE2 == STM32_CDPPRE2_DIV8
#define STM32_PCLK2                 (STM32_HCLK / 8U)
#elif STM32_CDPPRE2 == STM32_CDPPRE2_DIV16
#define STM32_PCLK2                 (STM32_HCLK / 16U)
#else
#error "invalid STM32_CDPPRE2 value specified"
#endif

/*
 * @brief   CD PCLK2 frequency check.
 */
...
/**
 * @brief   SRD PCLK clock.
 */
#if (STM32_SRDPPRE == STM32_SRDPPRE_DIV1) || defined(__DOXYGEN__)
#define STM32_SRDPCLK               (STM32_HCLK / 1U)
#elif STM32_SRDPPRE == STM32_SRDPPRE_DIV2
#define STM32_SRDPCLK               (STM32_HCLK / 2U)
#elif STM32_SRDPPRE == STM32_SRDPPRE_DIV4
#define STM32_SRDPCLK               (STM32_HCLK / 4U)
#elif STM32_SRDPPRE == STM32_SRDPPRE_DIV8
#define STM32_SRDPCLK               (STM32_HCLK / 8U)
#elif STM32_SRDPPRE == STM32_SRDPPRE_DIV16
#define STM32_SRDPCLK               (STM32_HCLK / 16U)
#else
#error "invalid STM32_SRDPPRE value specified"
#endif

/*
 * SRD PCLK frequency check.
 */
#if STM32_SRDPCLK > STM32_SRDPCLK_MAX
#error "STM32_SRDPCLK exceeding maximum frequency (STM32_SRDPCLK_MAX)"
#endif
...
#else
#if (STM32_TIMPRE_ENABLE == FALSE) || (STM32_CDPPRE1 == STM32_CDPPRE1_DIV2)
...
#else
#if (STM32_TIMPRE_ENABLE == FALSE) || (STM32_CDPPRE2 == STM32_CDPPRE2_DIV2)
...
#if (STM32_LPTIM3SEL == STM32_LPTIM3SEL_PCLK4) || defined(__DOXYGEN__)
/**
 * @brief   LPTIM3 clock.
 */
...
#if (STM32_SAI2ASEL == STM32_SAI2ASEL_PLL1_Q_CK) || defined(__DOXYGEN__)
/**
 * @brief   SAI2A clock.
 */
#define STM32_SAI2ACLK              STM32_PLL1_Q_CK

#elif STM32_SAI2ASEL == STM32_SAI2ASEL_PLL2_P_CK
#define STM32_SAI2ACLK              STM32_PLL2_P_CK
#elif STM32_SAI2ASEL == STM32_SAI2ASEL_PLL3_P_CK
#define STM32_SAI2ACLK              STM32_PLL3_P_CK
#elif STM32_SAI2ASEL == STM32_SAI2ASEL_I2S_CKIN
#define STM32_SAI2ACLK              0 /* Unknown, would require a board value */
#elif STM32_SAI2ASEL == STM32_SAI2ASEL_PER_CK
#define STM32_SAI2ACLK              STM32_PER_CK
#else
#error "invalid source selected for STM32_SAI2ASEL clock"
#endif

#if (STM32_SAI2BSEL == STM32_SAI2BSEL_PLL1_Q_CK) || defined(__DOXYGEN__)
/**
 * @brief   SAI2B clock.
 */
#define STM32_SAI2BCLK              STM32_PLL1_Q_CK

#elif STM32_SAI2BSEL == STM32_SAI2BSEL_PLL2_P_CK
#define STM32_SAI2BCLK              STM32_PLL2_P_CK
#elif STM32_SAI2BSEL == STM32_SAI2BSEL_PLL3_P_CK
#define STM32_SAI2BCLK              STM32_PLL3_P_CK
#elif STM32_SAI2BSEL == STM32_SAI2BSEL_I2S_CKIN
#define STM32_SAI2BCLK              0 /* Unknown, would require a board value */
#elif STM32_SAI2BSEL == STM32_SAI2BSEL_PER_CK
#define STM32_SAI2BCLK              STM32_PER_CK
#else
#error "invalid source selected for STM32_SAI2BSEL clock"
#endif
...
#else
#error "invalid source selected for STM32_SDMMCxSEL clock. set STM32_SDMMCSEL to either STM32_SDMMCSEL_PLL1_Q_CK or STM32_SDMMCSEL_PLL2_R_CK"
#endif
...
#if (STM32_DFSDM2SEL == STM32_DFSDM2SEL_PCLK4) || defined(__DOXYGEN__)
/**
 * @brief   SDMMC frequency.
 */
#define STM32_DFSDM2CLK             STM32_PCLK4

#elif STM32_DFSDM2SEL == STM32_DFSDM2SEL_SYS_CK
#define STM32_DFSDM2CLK             STM32_SYS_CK
#else
#error "invalid source selected for STM32_DFSDM2SEL clock"
#endif
