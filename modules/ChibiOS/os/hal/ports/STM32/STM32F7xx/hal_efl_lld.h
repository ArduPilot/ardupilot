...
/**
 * @name    STM32F76x/77x EFL driver configuration options
 * @{
 */
/**
...
#define STM32_FLASH2_SIZE                   2048U
#define STM32_FLASH1_SECTORS_TOTAL          8
#define STM32_FLASH1D_SECTORS_TOTAL         16
#define STM32_FLASH2_SECTORS_TOTAL          12
#define STM32_FLASH2D_SECTORS_TOTAL         24
#else
